...
#   timestamp: 2024-12-06T21:57:55+00:00
...
class CookingFireSuppressionPresentResponse(BaseModel):
    ...
    type_present_notpresent: Literal['PRESENT'] = Field(
        'PRESENT', title='Type Present Notpresent'
    )
    type: str = Field(..., title='Type')
...
class ExternalExposureResponse(BaseModel):
    type_external_internal: Literal['EXTERNAL'] = Field(
        'EXTERNAL', title='Type External Internal'
    )
    type: str = Field(..., title='Type')
...
class FireSuppressionFailedResponse(BaseModel):
    ...
    type_operation_effective: Literal['FAILED'] = Field(
        'FAILED', title='Type Operation Effective'
    )
    type: str = Field(..., title='Type')
...
class InjuryResponse(BaseModel):
    type_injury_noinjury: Literal['INJURY'] = Field(
        'INJURY', title='Type Injury Noinjury'
    )
...
class InternalExposurePayload(BaseModel):
    ...
    type_external_internal: Literal['INTERNAL'] = Field(
        'INTERNAL', title='Type External Internal'
    )
...
class NoinjuryPayload(BaseModel):
    ...
    type_injury_noinjury: Literal['NOINJURY'] = Field(
        'NOINJURY', title='Type Injury Noinjury'
    )
...
class RemovalResponse(BaseModel):
    ...
    type_removal_nonremoval: Literal['REMOVAL'] = Field(
        'REMOVAL', title='Type Removal Nonremoval'
    )
...
class SmokeAlarmAlertedResponse(BaseModel):
    type_operation_alerted: Literal['ALERTED'] = Field(
        'ALERTED', title='Type Operation Alerted'
    )
    neris_uid: Optional[int] = Field(
        None, description='The NERIS unique identifier for the item.', title='Neris Uid'
    )
...
class SmokeAlarmFailedResponse(BaseModel):
    type_operation_alerted: Literal['FAILED'] = Field(
        'FAILED', title='Type Operation Alerted'
    )
    neris_uid: Optional[int] = Field(
        None, description='The NERIS unique identifier for the item.', title='Neris Uid'
    )
...
class SmokeAlarmOtherPayload(BaseModel):
    ...
    type_operation_alerted: Literal['OTHER'] = Field(
        'OTHER', title='Type Operation Alerted'
    )
    type: Literal[
        'INSUFFICENT_SOURCE',
        'INSUFFICIENT_SOURCE',
