...
#   filename:  https://api.neris.fsri.org/v1/openapi.json
#   timestamp: 2026-03-04T19:24:23+00:00
...
class IncidentAnalysisCreatedResponse(BaseModel):
    nuid: int = Field(..., description="NERIS ID of the incident analysis.", title="Nuid")
...
class StationSummaryInfoResponse(BaseModel):
    ...
    location: Optional[Optional[Union[str, Dict[str, Any]]]] = Field(None, title="Location")
...
class TypeIndoorCauseValue(Enum):
    ...
    EQUIPMENT_APPLIANCE__ELECTRICAL_EQUIPMENT = "EQUIPMENT_APPLIANCE||ELECTRICAL_EQUIPMENT"
    EQUIPMENT_APPLIANCE__ELECTRIC_FENCE = "EQUIPMENT_APPLIANCE||ELECTRIC_FENCE"
    EQUIPMENT_APPLIANCE__HEATING_COOLING_EQUIPMENT = (
        "EQUIPMENT_APPLIANCE||HEATING_COOLING_EQUIPMENT"
    )
    EQUIPMENT_APPLIANCE__HOT_WORK = "EQUIPMENT_APPLIANCE||HOT_WORK"
    EQUIPMENT_APPLIANCE__OTHER = "EQUIPMENT_APPLIANCE||OTHER"
    EQUIPMENT_APPLIANCE__OTHER_SMALL_ENGINE_EQUIPMENT = (
        "EQUIPMENT_APPLIANCE||OTHER_SMALL_ENGINE_EQUIPMENT"
    )
    EQUIPMENT_APPLIANCE__UNKNOWN = "EQUIPMENT_APPLIANCE||UNKNOWN"
    EXPOSURE__SPREAD_FROM_OUTSIDE_STRUCTURE = "EXPOSURE||SPREAD_FROM_OUTSIDE_STRUCTURE"
    ...
    FIREARMS_EXPLOSIVES__DETONATING_CORD = "FIREARMS_EXPLOSIVES||DETONATING_CORD"
    ...
    FIREWORKS__CONSUMER_NON_AERIAL__COMBINAITON_ITEMS = (
    ...
    MISUSE_FIRE__FLINT_FRICTION = "MISUSE_FIRE||FLINT_FRICTION"
    MISUSE_FIRE__GLASS_REFRACTION_MAGNIFYING_GLASS = (
        "MISUSE_FIRE||GLASS_REFRACTION_MAGNIFYING_GLASS"
    )
    MISUSE_FIRE__INCENDIARY_DEVICE = "MISUSE_FIRE||INCENDIARY_DEVICE"
    MISUSE_FIRE__LIGHTER_MATCHES = "MISUSE_FIRE||LIGHTER_MATCHES"
    MISUSE_FIRE__OTHER = "MISUSE_FIRE||OTHER"
    MISUSE_FIRE__UNKNOWN = "MISUSE_FIRE||UNKNOWN"
    ...
    POWER_GEN_TRANS_DIST__BATTERY_CONSUMER_PRODUCT = (
        "POWER_GEN_TRANS_DIST||BATTERY_CONSUMER_PRODUCT"
    )
    ...
    RECREATION_CEREMONY__BARBEQUE_SMOKER = "RECREATION_CEREMONY||BARBEQUE_SMOKER"
    RECREATION_CEREMONY__EXPOSURE_FIRE_PIT_OPEN_FLAME = (
        "RECREATION_CEREMONY||EXPOSURE_FIRE_PIT_OPEN_FLAME"
    )
    RECREATION_CEREMONY__LUMINARY_CANDLES_INCENSE = "RECREATION_CEREMONY||LUMINARY_CANDLES_INCENSE"
    ...
    UNDETERMINED__NOT_INVESTIGATED = "UNDETERMINED||NOT_INVESTIGATED"
    UNDETERMINED__ORIGIN_AND_OR_CAUSE_NOT_IDENTIFIED = (
        "UNDETERMINED||ORIGIN_AND_OR_CAUSE_NOT_IDENTIFIED"
    )
    UNDETERMINED__ORIGIN_DESTROYED = "UNDETERMINED||ORIGIN_DESTROYED"
    UNDETERMINED__UNDER_INVESTIGATION = "UNDETERMINED||UNDER_INVESTIGATION"
...
class UnitResponseResponse(BaseModel):
    ...
    point: Optional[Union[GeoPoint, GeoMultipolygon, Optional[Union[str, Dict[str, Any]]]]] = Field(
        None, title="Point"
    )
...
class VehicleAutomobilePayload(BaseModel):
    ...
    identification_num: Optional[str] = Field(
        None,
        description="The identification number of the vehicle.",
...
class VehiclePayload(BaseModel):
    ...
    auto_or_other: Union[VehicleAutomobilePayload, VehicleOtherPayload] = Field(
        ..., discriminator="type", title="Auto Or Other"
    )
...
class BatteryPayload(BaseModel):
    ...
    product_type: TypeEmerghazElecValue = Field(
...
class DepartmentTimeZoneResponse(BaseModel):
...
class DistancePayload(BaseModel):
    ...
    distance_unit: TypeDistanceUnitValue = Field(
        ...,
...
class ExternalExposurePayload(BaseModel):
    ...
    item_type: TypeExposureItemValue = Field(
        ...,
        description="Type of property damaged or destroyed from the originating source of the hazard.",
    )
...
class FederalAgencyResponse(BaseModel):
    ...
    active: bool = Field(..., title="Active")
    website: Optional[str] = Field(None, title="Website")
    jurisdiction_type: Literal["FEDERAL"] = Field(..., title="Jurisdiction Type")
    location: Optional[Optional[Union[str, Dict[str, Any]]]] = Field(None, title="Location")
...
class GeocodedLocationResponse(BaseModel):
    ...
    point: Union[GeoPoint, GeoMultipolygon, Optional[Union[str, Dict[str, Any]]]] = Field(
...
class NoactionPayload(BaseModel):
    ...
    noaction_type: TypeNoactionValue = Field(
        ...,
        description="Reason no action taken by the fire department on the scene of the incident.",
    )
...
class OutsideFirePayload(BaseModel):
    ...
    general_cause: TypeGeneralFireCauseValue = Field(
        ..., description="The general cause of the outdoor fire."
    )
    cause: Optional[TypeOutdoorCauseValue] = Field(
        None, description="The cause of the outdoor fire."
    )
    ...
    polygon: Optional[HighPrecisionGeoMultipolygon] = Field(
...
class PresenceKnownPayload(BaseModel):
    ...
    presence_known_type: TypeRescuePresenceKnownValue = Field(
        ...,
        description=" At what point the presence of an occupant was discovered during the incident duration.",
    )
...
class ProductPayload(BaseModel):
    ...
    product_involved: TypeConsumerProductValue = Field(
...
class StructureAttachmentPayload(BaseModel):
    ...
    type: TypeAttachedValue = Field(..., description="The type of the addition to the structure.")
...
class MedResponses(
    RootModel[Union[AppendMedResponseAction, RemoveElementAction, PatchMedResponseAction]]
):
    root: Union[AppendMedResponseAction, RemoveElementAction, PatchMedResponseAction] = Field(
...
class ExposureResponse(BaseModel):
    ...
    polygon: Optional[Union[GeoPoint, GeoMultipolygon, Optional[Union[str, Dict[str, Any]]]]] = (
        Field(None, title="Polygon")
    )
...
class IncidentResponse(BaseModel):
    ...
    department: Optional[DepartmentTimeZoneResponse] = None
...
class StructureAnalysisPayload(BaseModel):
    ...
    damage_assessment: TypeFireBldgDamageValue = Field(
        ..., description="The damage assessment of the structure."
    )
    ignition_source: Optional[bool] = Field(
        False,
        description="Whether the structure was the ignition source of the fire.",
        title="Ignition Source",
    )
    location: LocationPayload
    ...
    type_eaves: Optional[TypeEavesValue] = Field(
        None, description="The type of eaves on the structure."
    )
...
class PropertyAnalysisPayload(BaseModel):
    ...
    parcel_id: Optional[str] = Field(
        None,
        description="The ID of the parcel affected by the incident.",
        title="Parcel Id",
    )
    location: Optional[LocationPayload] = Field(
        None, description="The location of the property affected by the incident."
    )
    structures: Optional[List[StructureAnalysisPayload]] = Field(
        None,
        description="The structures on the property that were affected by the incident.",
        title="Structures",
    )
...
class StructureFireOriginPayload(BaseModel):
    ...
    general_cause: TypeGeneralFireCauseValue = Field(
        ..., description="The general cause of the indoor fire."
    )
    cause: TypeIndoorCauseValue = Field(..., description="The cause of the indoor fire.")
...
class IncidentAnalysisPayload(BaseModel):
    ...
    neris_id_incident: constr(pattern=r"^FD\d{8}\|[\w\-\:]+\|\d{10}$") = Field(
        ...,
        description="The NERIS ID for the incident.",
    ...
    narrative: Optional[constr(min_length=1, max_length=100000)] = Field(
        None, description="The narrative of the incident.", title="Narrative"
    )
    ...
    vehicles: Optional[List[VehiclePayload]] = Field(
