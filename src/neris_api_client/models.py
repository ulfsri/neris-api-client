...
#   timestamp: 2026-06-25T22:57:56+00:00
...
class AidAgreementResponse(BaseModel):
    neris_id_dept: constr(pattern=r"^FD\d{8}$") = Field(
        ..., examples=["FD24027334", "FD24160543"], title="Neris Id Dept"
    )
    type: str = Field(..., title="Type")
    confirmed: bool = Field(..., title="Confirmed")
...
class AidPayload(BaseModel):
    ...
    department_neris_id: Union[constr(pattern=r"^FD\d{8}$"), constr(pattern=r"^FM\d{8}$")] = Field(
        ...,
        description="NERIS ID of the fire department or marshal to which aid was given/received.",
        examples=["FD24027000", "FM24000000"],
        title="Department Neris Id",
    )
    aid_type: AidType = Field(..., description="The type of aid provided")
    aid_direction: AidDirection1 = Field(..., description="The direction aid was provided")
...
class AssessmentPayload(BaseModel):
    ...
    iso_rating: Optional[conint(lt=11, gt=0)] = Field(None, title="Iso Rating")
...
class BatteryResponse(BaseModel):
    ...
    original_battery: Optional[bool] = Field(
        None,
        description="Whether the battery was the product's original battery.",
        title="Original Battery",
    )
    safety_listed: Optional[bool] = Field(
        None,
        description="Whether the product was listed by an independent safety testing company.",
        title="Safety Listed",
    )
    voltage: Optional[float] = Field(
        None, description="The voltage of the battery.", title="Voltage"
    )
    watt_hour: Optional[float] = Field(
        None, description="The watt hour of the battery.", title="Watt Hour"
    )
    amp_hour: Optional[float] = Field(
        None, description="The amp hour of the battery.", title="Amp Hour"
    )
    charging: Optional[bool] = Field(
        None,
        description="Whether the battery was plugged in/charging at the time of the incident.",
        title="Charging",
    )
    installed: Optional[bool] = Field(
        None,
        description="Whether the battery was permanently installed.",
        title="Installed",
    )
    direct_sunlight: Optional[bool] = Field(
        None,
        description="Whether the battery was exposed to direct sunlight at the time of the incident.",
        title="Direct Sunlight",
    )
    impacted_by_source: Optional[bool] = Field(
        None,
        description="Whether the battery was impacted by the ignition of another source.",
        title="Impacted By Source",
    )
    thermal_runaway: Optional[bool] = Field(
        None,
        description="Whether the battery displayed signs of thermal runaway.",
        title="Thermal Runaway",
    )
    product_type: str = Field(
        ...,
        description="The battery-powered product involved in the incident.",
        title="Product Type",
    )
    cell: Optional[str] = Field(None, description="The type of battery cell.", title="Cell")
    chemistry: Optional[str] = Field(
        None, description="The chemistry of the battery.", title="Chemistry"
    )
    storage: Optional[str] = Field(
        None,
        description="Whether the battery was primarily stored indoors or outdoors.",
        title="Storage",
    )
    indoor_or_outdoor: Optional[str] = Field(
        None,
        description="Whether the battery was located indoors or outdoors at the time of the incident.",
        title="Indoor Or Outdoor",
    )
    suppression_efforts: Optional[List[str]] = Field(
        None,
        description="The suppression/mitigation efforts used to suppress the fire.",
        title="Suppression Efforts",
    )
...
class CensusTractResponse(BaseModel):
    ...
    incident_neris_id: constr(pattern=r"^FD\d{8}\|[\w\-\:]+\|\d{10}$") = Field(
        ...,
    ...
    fips_code: str = Field(..., description="FIPS code", title="Fips Code")
    tract_id: Optional[str] = Field(None, description="Census tract ID", title="Tract Id")
    block_id: Optional[str] = Field(None, description="Census block ID", title="Block Id")
    area: float = Field(..., description="Area in square miles", title="Area")
    population_density: float = Field(
        ..., description="Population per square mile", title="Population Density"
    )
...
class Hazards(Enum):
    ...
    FIRE = "FIRE"
    LEAK = "LEAK"
    MATERIAL_ENTERED_WATERWAY = "MATERIAL_ENTERED_WATERWAY"
    SOLID_DISPERSION = "SOLID_DISPERSION"
    SPILL = "SPILL"
    VAPOR_GAS_DISPERSION = "VAPOR_GAS_DISPERSION"
...
class CommentPayload(BaseModel):
    ...
    comment: constr(min_length=1, max_length=100000) = Field(
        ...,
...
class CommentResponse(BaseModel):
    ...
    comment: constr(min_length=1, max_length=101000) = Field(
        ...,
        description="Free text or canned remark comments from dispatcher throughout duration of call.",
        examples=["Dispatch unit 35E to 123 Main Street for possible structure fire"],
        title="Comment",
...
class CreateIntegrationCredentialResponse(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    client_id: UUID = Field(..., description="The client id of the integration", title="Client Id")
...
class CreateUserPayload(BaseModel):
    ...
    email: EmailStr = Field(..., description="The new user's email address", title="Email")
...
class CsstHazardResponse(BaseModel):
    neris_uid: Optional[int] = Field(
        None, description="The NERIS unique identifier for the item.", title="Neris Uid"
    )
    last_modified: AwareDatetime = Field(
    ...
    lightning_suspected: Optional[str] = Field(
        None,
        description="Whether lightning was suspected as cause of ignition.",
        title="Lightning Suspected",
    )
    grounded: Optional[str] = Field(
        None,
        description="The determination of whether the corrugated stainless steel tubing (CSST) was grounded.",
        title="Grounded",
    )


class DecodeVinResultResponse(BaseModel):
    abs: Optional[str] = Field(None, title="Abs")
    active_safety_sys_note: Optional[str] = Field(None, title="Active Safety Sys Note")
    adaptive_cruise_control: Optional[str] = Field(None, title="Adaptive Cruise Control")
    adaptive_driving_beam: Optional[str] = Field(None, title="Adaptive Driving Beam")
    adaptive_headlights: Optional[str] = Field(None, title="Adaptive Headlights")
    additional_error_text: Optional[str] = Field(None, title="Additional Error Text")
    air_bag_loc_curtain: Optional[str] = Field(None, title="Air Bag Loc Curtain")
    air_bag_loc_front: Optional[str] = Field(None, title="Air Bag Loc Front")
    air_bag_loc_knee: Optional[str] = Field(None, title="Air Bag Loc Knee")
    air_bag_loc_seat_cushion: Optional[str] = Field(None, title="Air Bag Loc Seat Cushion")
    air_bag_loc_side: Optional[str] = Field(None, title="Air Bag Loc Side")
    auto_reverse_system: Optional[str] = Field(None, title="Auto Reverse System")
    automatic_pedestrian_alerting_sound: Optional[str] = Field(
        None, title="Automatic Pedestrian Alerting Sound"
    )
    axle_configuration: Optional[str] = Field(None, title="Axle Configuration")
    axles: Optional[int] = Field(None, title="Axles")
    base_price: Optional[float] = Field(None, title="Base Price")
    battery_amps_min: Optional[int] = Field(None, title="Battery Amps Min")
    battery_amps_max: Optional[int] = Field(None, title="Battery Amps Max")
    battery_cells: Optional[int] = Field(None, title="Battery Cells")
    battery_info: Optional[str] = Field(None, title="Battery Info")
    battery_kwh_min: Optional[float] = Field(None, title="Battery Kwh Min")
    battery_kwh_max: Optional[float] = Field(None, title="Battery Kwh Max")
    battery_modules: Optional[int] = Field(None, title="Battery Modules")
    battery_packs: Optional[int] = Field(None, title="Battery Packs")
    battery_type: Optional[str] = Field(None, title="Battery Type")
    battery_volts_min: Optional[float] = Field(None, title="Battery Volts Min")
    battery_volts_max: Optional[float] = Field(None, title="Battery Volts Max")
    bed_length_in: Optional[int] = Field(None, title="Bed Length In")
    bed_type: Optional[str] = Field(None, title="Bed Type")
    blind_spot_intervention: Optional[str] = Field(None, title="Blind Spot Intervention")
    blind_spot_mon: Optional[str] = Field(None, title="Blind Spot Mon")
    body_cab_type: Optional[str] = Field(None, title="Body Cab Type")
    body_class: Optional[str] = Field(None, title="Body Class")
    brake_system_desc: Optional[str] = Field(None, title="Brake System Desc")
    brake_system_type: Optional[str] = Field(None, title="Brake System Type")
    bus_floor_config_type: Optional[str] = Field(None, title="Bus Floor Config Type")
    bus_length: Optional[float] = Field(None, title="Bus Length")
    bus_type: Optional[str] = Field(None, title="Bus Type")
    can_aacn: Optional[str] = Field(None, title="Can Aacn")
    cib: Optional[str] = Field(None, title="Cib")
    cash_for_clunkers: Optional[str] = Field(None, title="Cash For Clunkers")
    charger_level: Optional[str] = Field(None, title="Charger Level")
    charger_power_kw: Optional[int] = Field(None, title="Charger Power Kw")
    combined_braking_system: Optional[str] = Field(None, title="Combined Braking System")
    cooling_type: Optional[str] = Field(None, title="Cooling Type")
    curb_weight_lb: Optional[int] = Field(None, title="Curb Weight Lb")
    custom_motorcycle_type: Optional[str] = Field(None, title="Custom Motorcycle Type")
    daytime_running_light: Optional[str] = Field(None, title="Daytime Running Light")
    destination_market: Optional[str] = Field(None, title="Destination Market")
    displacement_cc: Optional[float] = Field(None, title="Displacement Cc")
    displacement_ci: Optional[float] = Field(None, title="Displacement Ci")
    displacement_l: Optional[float] = Field(None, title="Displacement L")
    doors: Optional[int] = Field(None, title="Doors")
    drive_type: Optional[str] = Field(None, title="Drive Type")
    driver_assist: Optional[str] = Field(None, title="Driver Assist")
    dynamic_brake_support: Optional[str] = Field(None, title="Dynamic Brake Support")
    edr: Optional[str] = Field(None, title="Edr")
    esc: Optional[str] = Field(None, title="Esc")
    ev_drive_unit: Optional[str] = Field(None, title="Ev Drive Unit")
    electrification_level: Optional[str] = Field(None, title="Electrification Level")
    engine_configuration: Optional[str] = Field(None, title="Engine Configuration")
    engine_cycles: Optional[int] = Field(None, title="Engine Cycles")
    engine_cylinders: Optional[int] = Field(None, title="Engine Cylinders")
    engine_hp_min: Optional[float] = Field(None, title="Engine Hp Min")
    engine_hp_max: Optional[float] = Field(None, title="Engine Hp Max")
    engine_power_kw: Optional[float] = Field(None, title="Engine Power Kw")
    engine_manufacturer: Optional[str] = Field(None, title="Engine Manufacturer")
    engine_model: Optional[str] = Field(None, title="Engine Model")
    entertainment_system: Optional[str] = Field(None, title="Entertainment System")
    error_code: Optional[int] = Field(None, title="Error Code")
    error_text: Optional[str] = Field(None, title="Error Text")
    forward_collision_warning: Optional[str] = Field(None, title="Forward Collision Warning")
    fuel_injection_type: Optional[str] = Field(None, title="Fuel Injection Type")
    fuel_tank_material: Optional[str] = Field(None, title="Fuel Tank Material")
    fuel_tank_type: Optional[str] = Field(None, title="Fuel Tank Type")
    fuel_type_primary: Optional[str] = Field(None, title="Fuel Type Primary")
    fuel_type_secondary: Optional[str] = Field(None, title="Fuel Type Secondary")
    gcwr_min: Optional[str] = Field(None, title="Gcwr Min")
    gcwr_max: Optional[str] = Field(None, title="Gcwr Max")
    gvwr_min: Optional[str] = Field(None, title="Gvwr Min")
    gvwr_max: Optional[str] = Field(None, title="Gvwr Max")
    keyless_ignition: Optional[str] = Field(None, title="Keyless Ignition")
    lane_centering_assistance: Optional[str] = Field(None, title="Lane Centering Assistance")
    lane_departure_warning: Optional[str] = Field(None, title="Lane Departure Warning")
    lane_keep_system: Optional[str] = Field(None, title="Lane Keep System")
    lower_beam_headlamp_light_source: Optional[str] = Field(
        None, title="Lower Beam Headlamp Light Source"
    )
    make: Optional[str] = Field(None, title="Make")
    make_id: Optional[int] = Field(None, title="Make Id")
    manufacturer: Optional[str] = Field(None, title="Manufacturer")
    manufacturer_id: Optional[int] = Field(None, title="Manufacturer Id")
    model: Optional[str] = Field(None, title="Model")
    model_id: Optional[int] = Field(None, title="Model Id")
    model_year: Optional[int] = Field(None, title="Model Year")
    motorcycle_chassis_type: Optional[str] = Field(None, title="Motorcycle Chassis Type")
    motorcycle_suspension_type: Optional[str] = Field(None, title="Motorcycle Suspension Type")
    ncsa_body_type: Optional[str] = Field(None, title="Ncsa Body Type")
    ncsa_make: Optional[str] = Field(None, title="Ncsa Make")
    ncsa_map_exc_approved_by: Optional[str] = Field(None, title="Ncsa Map Exc Approved By")
    ncsa_map_exc_approved_on: Optional[str] = Field(None, title="Ncsa Map Exc Approved On")
    ncsa_mapping_exception: Optional[str] = Field(None, title="Ncsa Mapping Exception")
    ncsa_model: Optional[str] = Field(None, title="Ncsa Model")
    ncsa_note: Optional[str] = Field(None, title="Ncsa Note")
    non_land_use: Optional[str] = Field(None, title="Non Land Use")
    note: Optional[str] = Field(None, title="Note")
    other_bus_info: Optional[str] = Field(None, title="Other Bus Info")
    other_engine_info: Optional[str] = Field(None, title="Other Engine Info")
    other_motorcycle_info: Optional[str] = Field(None, title="Other Motorcycle Info")
    other_restraint_system_info: Optional[str] = Field(None, title="Other Restraint System Info")
    other_trailer_info: Optional[str] = Field(None, title="Other Trailer Info")
    park_assist: Optional[str] = Field(None, title="Park Assist")
    pedestrian_automatic_emergency_braking: Optional[str] = Field(
        None, title="Pedestrian Automatic Emergency Braking"
    )
    plant_city: Optional[str] = Field(None, title="Plant City")
    plant_company_name: Optional[str] = Field(None, title="Plant Company Name")
    plant_country: Optional[str] = Field(None, title="Plant Country")
    plant_state: Optional[str] = Field(None, title="Plant State")
    possible_values: Optional[str] = Field(None, title="Possible Values")
    pretensioner: Optional[str] = Field(None, title="Pretensioner")
    rear_automatic_emergency_braking: Optional[str] = Field(
        None, title="Rear Automatic Emergency Braking"
    )
    rear_cross_traffic_alert: Optional[str] = Field(None, title="Rear Cross Traffic Alert")
    rear_visibility_system: Optional[str] = Field(None, title="Rear Visibility System")
    sae_automation_level_min: Optional[int] = Field(None, title="Sae Automation Level Min")
    sae_automation_level_max: Optional[int] = Field(None, title="Sae Automation Level Max")
    seat_belts_all: Optional[str] = Field(None, title="Seat Belts All")
    seat_rows: Optional[int] = Field(None, title="Seat Rows")
    seats: Optional[int] = Field(None, title="Seats")
    semiautomatic_headlamp_beam_switching: Optional[str] = Field(
        None, title="Semiautomatic Headlamp Beam Switching"
    )
    series: Optional[str] = Field(None, title="Series")
    series_2: Optional[str] = Field(None, title="Series 2")
    steering_location: Optional[str] = Field(None, title="Steering Location")
    suggested_vin: Optional[str] = Field(None, title="Suggested Vin")
    tpms: Optional[str] = Field(None, title="Tpms")
    top_speed_mph: Optional[int] = Field(None, title="Top Speed Mph")
    track_width: Optional[float] = Field(None, title="Track Width")
    traction_control: Optional[str] = Field(None, title="Traction Control")
    trailer_body_type: Optional[str] = Field(None, title="Trailer Body Type")
    trailer_length: Optional[float] = Field(None, title="Trailer Length")
    trailer_type: Optional[str] = Field(None, title="Trailer Type")
    transmission_speeds: Optional[int] = Field(None, title="Transmission Speeds")
    transmission_style: Optional[str] = Field(None, title="Transmission Style")
    trim: Optional[str] = Field(None, title="Trim")
    trim_2: Optional[str] = Field(None, title="Trim 2")
    turbo: Optional[str] = Field(None, title="Turbo")
    vin: Optional[str] = Field(None, title="Vin")
    valve_train_design: Optional[str] = Field(None, title="Valve Train Design")
    vehicle_descriptor: Optional[str] = Field(None, title="Vehicle Descriptor")
    vehicle_type: Optional[str] = Field(None, title="Vehicle Type")
    wheel_base_long: Optional[float] = Field(None, title="Wheel Base Long")
    wheel_base_short: Optional[float] = Field(None, title="Wheel Base Short")
    wheel_base_type: Optional[str] = Field(None, title="Wheel Base Type")
    wheel_size_front: Optional[int] = Field(None, title="Wheel Size Front")
    wheel_size_rear: Optional[int] = Field(None, title="Wheel Size Rear")
    wheelie_mitigation: Optional[str] = Field(None, title="Wheelie Mitigation")
    wheels: Optional[int] = Field(None, title="Wheels")
    windows: Optional[int] = Field(None, title="Windows")


class DepartmentDispatchResponse(BaseModel):
...
class DistancePayload(BaseModel):
    ...
    distance_nearest_structure: float = Field(
        ...,
        description="The distance to the next nearest structure.",
        title="Distance Nearest Structure",
    )
    distance_unit: DistanceUnit = Field(
        ...,
        description="The units of distance from the structure to the next nearest structure.",
    )
...
class DistanceResponse(BaseModel):
    ...
    type_distance_unit: str = Field(
        ...,
        description="The units of distance from the structure to the next nearest structure.",
        title="Type Distance Unit",
    )
...
class EntityClassOptions(Enum):
    FIRE_DEPARTMENT = "FIRE_DEPARTMENT"
    FIRE_MARSHAL = "FIRE_MARSHAL"
    FEDERAL_AGENCY = "FEDERAL_AGENCY"


class EntityCreatedModifiedResponse(BaseModel):
    neris_id: str = Field(..., title="Neris Id")
    version: int = Field(..., title="Version")
    valid_start: AwareDatetime = Field(..., title="Valid Start")


class EntityFeatureFlagsPayload(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    allow_ui_incident_creation: Optional[bool] = Field(None, title="Allow Ui Incident Creation")
    allow_ui_no_activity_report_creation: Optional[bool] = Field(
        None, title="Allow Ui No Activity Report Creation"
    )
    allow_incident_analysis_creation: Optional[bool] = Field(
        None, title="Allow Incident Analysis Creation"
    )
    non_reporting: Optional[bool] = Field(None, title="Non Reporting")


class EntityFeatureFlagsResponse(BaseModel):
    allow_ui_incident_creation: Optional[bool] = Field(None, title="Allow Ui Incident Creation")
    allow_ui_no_activity_report_creation: Optional[bool] = Field(
        None, title="Allow Ui No Activity Report Creation"
    )
...
class EntityRoleEntitySetAttachmentResponse(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    neris_id_entity: constr(pattern=r"^(FD|FM|FA)\d{8}$") = Field(
        ...,
        examples=["FD24027334", "FM24001001", "FA24001001"],
        title="Neris Id Entity",
    )
    nuid_role: UUID = Field(..., title="Nuid Role")
    nuid_entity_set: UUID = Field(..., title="Nuid Entity Set")
...
class FfInjuryDetailsResponse(BaseModel):
    ...
    unit_neris_id: Optional[constr(pattern=r"^FD\d{8}S[A-Z\d]{3}U[A-Z\d]{3}$")] = Field(
        None,
    ...
    ppe_items: Optional[List[str]] = Field(
...
class FinalizeForgotPasswordPayload(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    code: str = Field(..., description="Authorization code for the request", title="Code")
    account_id: UUID = Field(..., description="User's account ID", title="Account Id")
    password: str = Field(..., description="The new password", title="Password")
...
class InvestigationNeeded(Enum):
    NO = "NO"
    NOT_APPLICABLE = "NOT_APPLICABLE"
...
class FireRemovalResponse(BaseModel):
    ...
    relative_suppression_time: Optional[str] = Field(
        None,
        description="The time, relative to suppression, when the person was rescued.",
...
class GeoJsonPoint(BaseModel):
    ...
    coordinates: List[float] = Field(..., max_length=2, min_length=2, title="Coordinates")


class GeoMultipolygon(BaseModel):
    crs: Optional[Union[int, str]] = Field(
        4326, description="EPSG code for the coordinate reference system", title="Crs"
    )
...
class HighPrecisionGeoJsonMultiPolygon(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    type: Literal["MultiPolygon"] = Field(
...
class HighPrecisionGeoMultipolygon(BaseModel):
    crs: Optional[Union[int, str]] = Field(
        4326, description="EPSG code for the coordinate reference system", title="Crs"
    )
    geometry: HighPrecisionGeoJsonMultiPolygon


class IncidentAnalysisBaseResponse(BaseModel):
    neris_uid: Optional[int] = Field(
        None, description="The NERIS unique identifier for the item.", title="Neris Uid"
    )
    last_modified: AwareDatetime = Field(
    ...
    neris_id_incident: constr(pattern=r"^FD\d{8}\|[\w\-\:]+\|\d{10}$") = Field(
        ...,
        description="The NERIS ID for the incident this incident analysis is associated with.",
        examples=["FD24027000|abc123xyz|1729023498"],
        title="Neris Id Incident",
    )
    incident_number: constr(pattern=r"[\w\-\:]+") = Field(
        ...,
        description="The incident's internal ID for the incident analysis.",
        examples=["INA20260703TV"],
        title="Incident Number",
    )
    narrative: Optional[constr(min_length=1, max_length=100000)] = Field(
        None, description="The narrative of the incident analysis.", title="Narrative"
    )
    medical_response: Optional[bool] = Field(
        None,
        description="Whether the incident required a medical response or intervention.",
        title="Medical Response",
    )
    transport_impacted: Optional[bool] = Field(
        None,
        description="Whether a major transportation artery or facility was closed in response to the incident.",
        title="Transport Impacted",
    )
    human_factors: Optional[List[str]] = Field(
        None,
        description="The human factors that contributed to the incident.",
        title="Human Factors",
    )


class IncidentAnalysisStatusResponse(BaseModel):
    last_modified: AwareDatetime = Field(
        ...,
        description="The date and time the top-level item was created or updated in the system.",
        examples=[
    ...
    created_by: UUID = Field(
        ...,
        description="That account that created or last modified the incident analysis record.",
        title="Created By",
    )
    status: str = Field(
        ...,
        description="Status of the incident analysis in the administrative approval process.",
        title="Status",
    )


class IncidentAnalysisUpdatedResponse(BaseModel):
    last_modified: AwareDatetime = Field(
        ...,
        description="The date and time the top-level item was created or updated in the system.",
        examples=[
...
class IncidentCountMetricsResponse(BaseModel):
    year_to_date: conint(ge=0) = Field(
        ..., description="Number of incidents year-to-date", title="Year To Date"
    )
    month_to_date: conint(ge=0) = Field(
        ..., description="Number of incidents month-to-date", title="Month To Date"
    )
    previous_24_hrs: conint(ge=0) = Field(
        ...,
        description="Number of incidents in the past 24 hours",
        title="Previous 24 Hrs",
    )
    total: conint(ge=0) = Field(
        ..., description="Total number of incidents in NERIS", title="Total"
    )


class IncidentFilterType(Enum):
    ...
    MEDICAL__ILLNESS = "MEDICAL||ILLNESS"
    ...
    MEDICAL__INJURY = "MEDICAL||INJURY"
    ...
    RESCUE__OUTSIDE__BACKCOUNTRY_RESCUE = "RESCUE||OUTSIDE||BACKCOUNTRY_RESCUE"
    ...
    FIRE = "FIRE"
    OUTSIDE_FIRE = "OUTSIDE_FIRE"
    CONSTRUCTION_WASTE = "CONSTRUCTION_WASTE"
    DUMPSTER_OUTDOOR_CONTAINER_FIRE = "DUMPSTER_OUTDOOR_CONTAINER_FIRE"
    OTHER_OUTSIDE_FIRE = "OTHER_OUTSIDE_FIRE"
    OUTSIDE_TANK_FIRE = "OUTSIDE_TANK_FIRE"
    TRASH_RUBBISH_FIRE = "TRASH_RUBBISH_FIRE"
    UTILITY_INFRASTRUCTURE_FIRE = "UTILITY_INFRASTRUCTURE_FIRE"
    VEGETATION_GRASS_FIRE = "VEGETATION_GRASS_FIRE"
    WILDFIRE_URBAN_INTERFACE = "WILDFIRE_URBAN_INTERFACE"
    WILDFIRE_WILDLAND = "WILDFIRE_WILDLAND"
    SPECIAL_FIRE = "SPECIAL_FIRE"
    ESS_FIRE = "ESS_FIRE"
    EXPLOSION = "EXPLOSION"
    INFRASTRUCTURE_FIRE = "INFRASTRUCTURE_FIRE"
    STRUCTURE_FIRE = "STRUCTURE_FIRE"
    CHIMNEY_FIRE = "CHIMNEY_FIRE"
    CONFINED_COOKING_APPLIANCE_FIRE = "CONFINED_COOKING_APPLIANCE_FIRE"
    ROOM_AND_CONTENTS_FIRE = "ROOM_AND_CONTENTS_FIRE"
    STRUCTURAL_INVOLVEMENT_FIRE = "STRUCTURAL_INVOLVEMENT_FIRE"
    TRANSPORTATION_FIRE = "TRANSPORTATION_FIRE"
    AIRCRAFT_FIRE = "AIRCRAFT_FIRE"
    BOAT_PERSONAL_WATERCRAFT_BARGE_FIRE = "BOAT_PERSONAL_WATERCRAFT_BARGE_FIRE"
    POWERED_MOBILITY_DEVICE_FIRE = "POWERED_MOBILITY_DEVICE_FIRE"
    TRAIN_RAIL_FIRE = "TRAIN_RAIL_FIRE"
    VEHICLE_FIRE_COMMERCIAL = "VEHICLE_FIRE_COMMERCIAL"
    VEHICLE_FIRE_FOOD_TRUCK = "VEHICLE_FIRE_FOOD_TRUCK"
    VEHICLE_FIRE_PASSENGER = "VEHICLE_FIRE_PASSENGER"
    VEHICLE_FIRE_RV = "VEHICLE_FIRE_RV"
    HAZSIT = "HAZSIT"
    HAZARDOUS_MATERIALS = "HAZARDOUS_MATERIALS"
    BIOLOGICAL_RELEASE_INCIDENT = "BIOLOGICAL_RELEASE_INCIDENT"
    CARBON_MONOXIDE_RELEASE = "CARBON_MONOXIDE_RELEASE"
    FUEL_SPILL_ODOR = "FUEL_SPILL_ODOR"
    GAS_LEAK_ODOR = "GAS_LEAK_ODOR"
    HAZMAT_RELEASE_FACILITY = "HAZMAT_RELEASE_FACILITY"
    HAZMAT_RELEASE_TRANSPORT = "HAZMAT_RELEASE_TRANSPORT"
    RADIOACTIVE_RELEASE_INCIDENT = "RADIOACTIVE_RELEASE_INCIDENT"
    HAZARD_NONCHEM = "HAZARD_NONCHEM"
    BOMB_THREAT_RESPONSE_SUSPICIOUS_PACKAGE = "BOMB_THREAT_RESPONSE_SUSPICIOUS_PACKAGE"
    ELEC_HAZARD_SHORT_CIRCUIT = "ELEC_HAZARD_SHORT_CIRCUIT"
    ELEC_POWER_LINE_DOWN_ARCHING_MALFUNC = "ELEC_POWER_LINE_DOWN_ARCHING_MALFUNC"
    MOTOR_VEHICLE_COLLISION = "MOTOR_VEHICLE_COLLISION"
    INVESTIGATION = "INVESTIGATION"
    ODOR = "ODOR"
    SMOKE_INVESTIGATION = "SMOKE_INVESTIGATION"
    OVERPRESSURE = "OVERPRESSURE"
    NO_RUPTURE = "NO_RUPTURE"
    RUPTURE_WITHOUT_FIRE = "RUPTURE_WITHOUT_FIRE"
    MEDICAL = "MEDICAL"
    ILLNESS = "ILLNESS"
    ABDOMINAL_PAIN = "ABDOMINAL_PAIN"
    ALLERGIC_REACTION_STINGS = "ALLERGIC_REACTION_STINGS"
    ALTERED_MENTAL_STATUS = "ALTERED_MENTAL_STATUS"
    BACK_PAIN_NON_TRAUMA = "BACK_PAIN_NON_TRAUMA"
    BREATHING_PROBLEMS = "BREATHING_PROBLEMS"
    CARDIAC_ARREST = "CARDIAC_ARREST"
    CHEST_PAIN_NON_TRAUMA = "CHEST_PAIN_NON_TRAUMA"
    CONVULSIONS_SEIZURES = "CONVULSIONS_SEIZURES"
    DIABETIC_PROBLEMS = "DIABETIC_PROBLEMS"
    HEADACHE = "HEADACHE"
    HEART_PROBLEMS = "HEART_PROBLEMS"
    NAUSEA_VOMITING = "NAUSEA_VOMITING"
    NO_APPROPRIATE_CHOICE = "NO_APPROPRIATE_CHOICE"
    OVERDOSE = "OVERDOSE"
    PANDEMIC_EPIDEMIC_OUTBREAK = "PANDEMIC_EPIDEMIC_OUTBREAK"
    PREGNANCY_CHILDBIRTH = "PREGNANCY_CHILDBIRTH"
    PSYCHOLOGICAL_BEHAVIOR_ISSUES = "PSYCHOLOGICAL_BEHAVIOR_ISSUES"
    SICK_CASE = "SICK_CASE"
    STROKE_CVA = "STROKE_CVA"
    UNCONSCIOUS_VICTIM = "UNCONSCIOUS_VICTIM"
    UNKNOWN_PROBLEM = "UNKNOWN_PROBLEM"
    WELL_PERSON_CHECK = "WELL_PERSON_CHECK"
    INJURY = "INJURY"
    ANIMAL_BITES = "ANIMAL_BITES"
    ASSAULT = "ASSAULT"
    BURNS_EXPLOSION = "BURNS_EXPLOSION"
    CARBON_MONOXIDE_OTHER_INHALATION_INJURY = "CARBON_MONOXIDE_OTHER_INHALATION_INJURY"
    CHOKING = "CHOKING"
    DROWNING_DIVING_SCUBA_ACCIDENT = "DROWNING_DIVING_SCUBA_ACCIDENT"
    ELECTROCUTION = "ELECTROCUTION"
    EYE_TRAUMA = "EYE_TRAUMA"
    FALL = "FALL"
    GUNSHOT_WOUND = "GUNSHOT_WOUND"
    HEAT_COLD_EXPOSURE = "HEAT_COLD_EXPOSURE"
    HEMORRHAGE_LACERATION = "HEMORRHAGE_LACERATION"
    INDUSTRIAL_INACCESSIBLE_ENTRAPMENT = "INDUSTRIAL_INACCESSIBLE_ENTRAPMENT"
    OTHER_TRAUMATIC_INJURY = "OTHER_TRAUMATIC_INJURY"
    POISONING = "POISONING"
    STAB_PENETRATING_TRAUMA = "STAB_PENETRATING_TRAUMA"
    OTHER = "OTHER"
    AIRMEDICAL_TRANSPORT = "AIRMEDICAL_TRANSPORT"
    COMMUNITY_PUBLIC_HEALTH = "COMMUNITY_PUBLIC_HEALTH"
    HEALTHCARE_PROFESSIONAL_ADMISSION = "HEALTHCARE_PROFESSIONAL_ADMISSION"
    INTERCEPT_OTHER_UNIT = "INTERCEPT_OTHER_UNIT"
    MEDICAL_ALARM = "MEDICAL_ALARM"
    STANDBY_REQUEST = "STANDBY_REQUEST"
    TRANSFER_INTERFACILITY = "TRANSFER_INTERFACILITY"
    NOEMERG = "NOEMERG"
    CANCELLED = "CANCELLED"
    FALSE_ALARM = "FALSE_ALARM"
    ACCIDENTAL_ALARM = "ACCIDENTAL_ALARM"
    BOMB_SCARE = "BOMB_SCARE"
    INTENTIONAL_FALSE_ALARM = "INTENTIONAL_FALSE_ALARM"
    MALFUNCTIONING_ALARM = "MALFUNCTIONING_ALARM"
    OTHER_FALSE_CALL = "OTHER_FALSE_CALL"
    GOOD_INTENT = "GOOD_INTENT"
    CONTROLLED_BURNING_AUTHORIZED = "CONTROLLED_BURNING_AUTHORIZED"
    INVESTIGATE_HAZARDOUS_RELEASE = "INVESTIGATE_HAZARDOUS_RELEASE"
    NO_INCIDENT_FOUND_LOCATION_ERROR = "NO_INCIDENT_FOUND_LOCATION_ERROR"
    SMOKE_FROM_NONHOSTILE_SOURCE = "SMOKE_FROM_NONHOSTILE_SOURCE"
    PUBSERV = "PUBSERV"
    ALARMS_NONMED = "ALARMS_NONMED"
    CO_ALARM = "CO_ALARM"
    FIRE_ALARM = "FIRE_ALARM"
    GAS_ALARM = "GAS_ALARM"
    OTHER_ALARM = "OTHER_ALARM"
    CITIZEN_ASSIST = "CITIZEN_ASSIST"
    CITIZEN_ASSIST_SERVICE_CALL = "CITIZEN_ASSIST_SERVICE_CALL"
    LIFT_ASSIST = "LIFT_ASSIST"
    LOST_PERSON = "LOST_PERSON"
    PERSON_IN_DISTRESS = "PERSON_IN_DISTRESS"
    DISASTER_WEATHER = "DISASTER_WEATHER"
    DAMAGE_ASSESSMENT = "DAMAGE_ASSESSMENT"
    WEATHER_RESPONSE = "WEATHER_RESPONSE"
    DAMAGED_HYDRANT = "DAMAGED_HYDRANT"
    MOVE_UP = "MOVE_UP"
    STANDBY = "STANDBY"
    RESCUE = "RESCUE"
    OUTSIDE = "OUTSIDE"
    BACKCOUNTRY_RESCUE = "BACKCOUNTRY_RESCUE"
    CONFINED_SPACE_RESCUE = "CONFINED_SPACE_RESCUE"
    EXTRICATION_ENTRAPPED = "EXTRICATION_ENTRAPPED"
    HIGH_ANGLE_RESCUE = "HIGH_ANGLE_RESCUE"
    LIMITED_NO_ACCESS = "LIMITED_NO_ACCESS"
    LOW_ANGLE_RESCUE = "LOW_ANGLE_RESCUE"
    STEEP_ANGLE_RESCUE = "STEEP_ANGLE_RESCUE"
    TRENCH = "TRENCH"
    STRUCTURE = "STRUCTURE"
    BUILDING_STRUCTURE_COLLAPSE = "BUILDING_STRUCTURE_COLLAPSE"
    ELEVATOR_ESCALATOR_RESCUE = "ELEVATOR_ESCALATOR_RESCUE"
    TRANSPORTATION = "TRANSPORTATION"
    AVIATION_COLLISION_CRASH = "AVIATION_COLLISION_CRASH"
    AVIATION_STANDBY = "AVIATION_STANDBY"
    MOTOR_VEHICLE_EXTRICATION_ENTRAPPED = "MOTOR_VEHICLE_EXTRICATION_ENTRAPPED"
    TRAIN_RAIL_COLLISION_DERAILMENT = "TRAIN_RAIL_COLLISION_DERAILMENT"
    WATER = "WATER"
    PERSON_IN_WATER_STANDING = "PERSON_IN_WATER_STANDING"
    PERSON_IN_WATER_SWIFTWATER = "PERSON_IN_WATER_SWIFTWATER"
    WATERCRAFT_IN_DISTRESS = "WATERCRAFT_IN_DISTRESS"
...
class Status(Enum):
    ...
    PENDING_INCIDENT_DATA = "PENDING_INCIDENT_DATA"
    REJECTED = "REJECTED"
    SUBMITTED = "SUBMITTED"
...
class IncidentHistoryItemResponse(BaseModel):
    ...
    current: bool = Field(
        ..., description="Whether the status is the current status", title="Current"
    )
    account_id: UUID = Field(
        ...,
        description="The account id of the principal responsible for the incident status",
        title="Account Id",
    )
    sub: Optional[UUID] = Field(
        None,
        description="The unique id of the user if the account was a user account",
        title="Sub",
    )
    client_id: Optional[UUID] = Field(
        None,
        description="The client id of the integration if the account was an integration account",
        title="Client Id",
    )
    status: Status = Field(
        ...,
...
class IncidentHistoryResponse(BaseModel):
    history: List[IncidentHistoryItemResponse] = Field(
        ...,
        description="Chronologically ordered list of statuses for the incident",
        title="History",
    )
...
class IncidentStatusResponse(BaseModel):
    ...
    created_by: UUID = Field(
        ...,
        description="That account that created or last modified the incident record.",
        title="Created By",
    )
    status: Status = Field(
        ...,
...
class IncidentTypeCadPayload(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    type: Literal["UNDETERMINED"] = Field(
        ...,
        description="Special value for CAD integrations where the incident type is not yet known.",
        title="Type",
    )
...
class InitiateForgotPasswordPayload(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class InjuryResponse(BaseModel):
    ...
    ff_injury_details: Optional[FfInjuryDetailsResponse] = Field(
        None,
...
class InspectionPayload(BaseModel):
    ...
    inspection_required: Optional[bool] = Field(
        False,
        description="Whether the structure requires an inspection.",
        title="Inspection Required",
    )
    date_of_last_inspection: Optional[AwareDatetime] = Field(
        None,
        description="The date of the last inspection.",
        title="Date Of Last Inspection",
    )
    unresolved_inspection_findings: Optional[bool] = Field(
        None,
        description="Whether a previous inspection found unresolved findings.",
        title="Unresolved Inspection Findings",
    )
...
class IntegrationEnrollmentListItem(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    id: UUID = Field(..., description="The unique identifier for the enrollment", title="Id")
    client_id: UUID = Field(
        ...,
        description="The client id (integration account id) for the integration",
        title="Client Id",
    )
    neris_id: str = Field(
        ...,
        description="The NERIS ID of the entity that is enrolled in the integration",
        title="Neris Id",
    )
    entity_name: Optional[str] = Field(
        None,
        description="The name of the entity enrolled in the integration",
        title="Entity Name",
    )
    created_by: UUID = Field(
        ...,
        description="User account ID of the account that created the enrollment",
        title="Created By",
    )
    approved_by: Optional[UUID] = Field(
        None,
        description="Optional user account ID of the account that approved the enrollment",
        title="Approved By",
    )
    integration_title: str = Field(
        ..., description="Title of the integration", title="Integration Title"
    )
...
class MedicalOxygenHazardNotPresentPayload(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    type: Literal["NOT_APPLICABLE", "NOT_PRESENT"] = Field(..., title="Type")
...
class MedicalOxygenHazardNotPresentResponse(BaseModel):
    neris_uid: Optional[int] = Field(
        None, description="The NERIS unique identifier for the item.", title="Neris Uid"
    )
    last_modified: AwareDatetime = Field(
...
class MedicalOxygenHazardPresentPayload(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    type: Literal["PRESENT"] = Field(..., title="Type")
    contributed_to_flame_spread: Optional[bool] = Field(
        None,
        description="Whether the medical oxygen hazard contributed to flame spread.",
        title="Contributed To Flame Spread",
    )


class MedicalOxygenHazardPresentResponse(BaseModel):
    neris_uid: Optional[int] = Field(
        None, description="The NERIS unique identifier for the item.", title="Neris Uid"
    )
    last_modified: AwareDatetime = Field(
...
class MedicalOxygenHazardResponse(BaseModel):
    neris_uid: Optional[int] = Field(
        None, description="The NERIS unique identifier for the item.", title="Neris Uid"
    )
    last_modified: AwareDatetime = Field(
    ...
    presence: Union[MedicalOxygenHazardPresentResponse, MedicalOxygenHazardNotPresentResponse] = (
        Field(..., title="Presence")
    )


class PatientCareEvaluation(Enum):
...
class MedicalResponse(BaseModel):
    ...
    patient_care_report_id: Optional[constr(min_length=1, max_length=280)] = Field(
        None,
...
class NoActivityReportPayload(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    month_year: constr(pattern=r"^[0-1][0-9]/20[2-9][0-9]$") = Field(
        ...,
        description="MM/YYYY formatted month and year of the period of no activity.",
        examples=["12/2025", "06/2026", "01/2025"],
        title="Month Year",
    )


class NoActivityReportResponse(BaseModel):
    month_year: constr(pattern=r"^[0-1][0-9]/20[2-9][0-9]$") = Field(
        ...,
        description="MM/YYYY formatted month and year of the period of no activity.",
        examples=["12/2025", "06/2026", "01/2025"],
    ...
    neris_uid: UUID = Field(..., description="Unique identifier of the report", title="Neris Uid")
    submitted_by: UUID = Field(
        ..., description="Account id of the report submitter", title="Submitted By"
    )
    neris_id_entity: constr(pattern=r"^FD\d{8}$") = Field(
        ...,
        description="Unique identifier of the entity the report was submitted on behalf of",
        examples=["FD24027334", "FD24160543"],
        title="Neris Id Entity",
    )
...
class NoactionPayload(BaseModel):
    ...
    noaction_type: NoactionType = Field(
        ...,
...
class Cause1(Enum):
    DEBRIS_OPEN_BURNING__BRANDING = "DEBRIS_OPEN_BURNING||BRANDING"
    DEBRIS_OPEN_BURNING__BURNING_PERSONAL_ITEMS = "DEBRIS_OPEN_BURNING||BURNING_PERSONAL_ITEMS"
    DEBRIS_OPEN_BURNING__BURN_BARREL = "DEBRIS_OPEN_BURNING||BURN_BARREL"
    DEBRIS_OPEN_BURNING__DISTRESS_SIGNAL_FIRE = "DEBRIS_OPEN_BURNING||DISTRESS_SIGNAL_FIRE"
    DEBRIS_OPEN_BURNING__DITCH_FENCE_LINE_BURNING = "DEBRIS_OPEN_BURNING||DITCH_FENCE_LINE_BURNING"
    DEBRIS_OPEN_BURNING__ESCAPED_PRESCRIBED_BURN = "DEBRIS_OPEN_BURNING||ESCAPED_PRESCRIBED_BURN"
    DEBRIS_OPEN_BURNING__FIELD_AGRICULTURAL_BURNING = (
        "DEBRIS_OPEN_BURNING||FIELD_AGRICULTURAL_BURNING"
    )
    DEBRIS_OPEN_BURNING__HAND_PILE_SLASH = "DEBRIS_OPEN_BURNING||HAND_PILE_SLASH"
    DEBRIS_OPEN_BURNING__MACHINE_PILE_SLASH = "DEBRIS_OPEN_BURNING||MACHINE_PILE_SLASH"
    DEBRIS_OPEN_BURNING__OPEN_TRASH_BURNING = "DEBRIS_OPEN_BURNING||OPEN_TRASH_BURNING"
    DEBRIS_OPEN_BURNING__OTHER = "DEBRIS_OPEN_BURNING||OTHER"
    DEBRIS_OPEN_BURNING__OTHER_LAND_CLEARING = "DEBRIS_OPEN_BURNING||OTHER_LAND_CLEARING"
    DEBRIS_OPEN_BURNING__PEST_CONTROL_DETERRENT_SMOKE_OUT = (
        "DEBRIS_OPEN_BURNING||PEST_CONTROL_DETERRENT_SMOKE_OUT"
    )
    DEBRIS_OPEN_BURNING__RIGHT_OF_WAY_CLEARING = "DEBRIS_OPEN_BURNING||RIGHT_OF_WAY_CLEARING"
    DEBRIS_OPEN_BURNING__UNKNOWN = "DEBRIS_OPEN_BURNING||UNKNOWN"
    DEBRIS_OPEN_BURNING__YARD_DEBRIS = "DEBRIS_OPEN_BURNING||YARD_DEBRIS"
    EQUIPMENT_VEHICLE_USE__AIRCRAFT = "EQUIPMENT_VEHICLE_USE||AIRCRAFT"
    EQUIPMENT_VEHICLE_USE__CHAINSAW_BRUSH_SAW_WEED_TRIMMER = (
    ...
    EQUIPMENT_VEHICLE_USE__ELECTRIC_MOTOR_POWER_TOOLS_BATTERY = (
        "EQUIPMENT_VEHICLE_USE||ELECTRIC_MOTOR_POWER_TOOLS_BATTERY"
    )
    EQUIPMENT_VEHICLE_USE__HEAVY_EQUIPMENT_IMPLEMENTS = (
        "EQUIPMENT_VEHICLE_USE||HEAVY_EQUIPMENT_IMPLEMENTS"
    )
    EQUIPMENT_VEHICLE_USE__HOT_WORK = "EQUIPMENT_VEHICLE_USE||HOT_WORK"
    EQUIPMENT_VEHICLE_USE__OHV_ATV_MOTORCYCLE = "EQUIPMENT_VEHICLE_USE||OHV_ATV_MOTORCYCLE"
    EQUIPMENT_VEHICLE_USE__OTHER = "EQUIPMENT_VEHICLE_USE||OTHER"
    EQUIPMENT_VEHICLE_USE__OTHER_SMALL_ENGINE_EQUIPMENT = (
        "EQUIPMENT_VEHICLE_USE||OTHER_SMALL_ENGINE_EQUIPMENT"
    )
    EQUIPMENT_VEHICLE_USE__PASSENGER_VEHICLE_MOTORIZED_RV = (
        "EQUIPMENT_VEHICLE_USE||PASSENGER_VEHICLE_MOTORIZED_RV"
    )
    EQUIPMENT_VEHICLE_USE__TRACTOR_MOWER_BRUSH_HOG = (
        "EQUIPMENT_VEHICLE_USE||TRACTOR_MOWER_BRUSH_HOG"
    )
    EQUIPMENT_VEHICLE_USE__TRAILER = "EQUIPMENT_VEHICLE_USE||TRAILER"
    EQUIPMENT_VEHICLE_USE__UAS_MODEL_ROCKETS_AIRPLANES = (
        "EQUIPMENT_VEHICLE_USE||UAS_MODEL_ROCKETS_AIRPLANES"
    )
    EQUIPMENT_VEHICLE_USE__UNKNOWN = "EQUIPMENT_VEHICLE_USE||UNKNOWN"
    EQUIPMENT_VEHICLE_USE__WATERCRAFT = "EQUIPMENT_VEHICLE_USE||WATERCRAFT"
    FIREARMS_EXPLOSIVES__AMMONIUM_NITRATE_FUEL_OIL = (
        "FIREARMS_EXPLOSIVES||AMMONIUM_NITRATE_FUEL_OIL"
    )
    FIREARMS_EXPLOSIVES__BLACK_POWDER_MUZZLE_LOADING = (
        "FIREARMS_EXPLOSIVES||BLACK_POWDER_MUZZLE_LOADING"
    )
    FIREARMS_EXPLOSIVES__BLASTING = "FIREARMS_EXPLOSIVES||BLASTING"
    FIREARMS_EXPLOSIVES__DETONATED_CORD = "FIREARMS_EXPLOSIVES||DETONATED_CORD"
    FIREARMS_EXPLOSIVES__EXPLODING_TARGET_SHOOTING = (
        "FIREARMS_EXPLOSIVES||EXPLODING_TARGET_SHOOTING"
    )
    FIREARMS_EXPLOSIVES__FLARES_FUSES = "FIREARMS_EXPLOSIVES||FLARES_FUSES"
    FIREARMS_EXPLOSIVES__IMPROVISED_EXPLOSIVE_DEVICE = (
        "FIREARMS_EXPLOSIVES||IMPROVISED_EXPLOSIVE_DEVICE"
    )
    FIREARMS_EXPLOSIVES__INERT_TARGET_SHOOTING = "FIREARMS_EXPLOSIVES||INERT_TARGET_SHOOTING"
    FIREARMS_EXPLOSIVES__MILITARY_ORDINANCE = "FIREARMS_EXPLOSIVES||MILITARY_ORDINANCE"
    FIREARMS_EXPLOSIVES__NON_MILITARY_TRACER = "FIREARMS_EXPLOSIVES||NON_MILITARY_TRACER"
    FIREARMS_EXPLOSIVES__OTHER = "FIREARMS_EXPLOSIVES||OTHER"
    FIREARMS_EXPLOSIVES__OTHER_EXPLOSIVES = "FIREARMS_EXPLOSIVES||OTHER_EXPLOSIVES"
    FIREARMS_EXPLOSIVES__PIPE_BOMB = "FIREARMS_EXPLOSIVES||PIPE_BOMB"
    FIREARMS_EXPLOSIVES__UNKNOWN = "FIREARMS_EXPLOSIVES||UNKNOWN"
    FIREWORKS__CONSUMER_AERIAL__COMETS_MINES_SHELLS = (
        "FIREWORKS||CONSUMER_AERIAL||COMETS_MINES_SHELLS"
    )
    FIREWORKS__CONSUMER_AERIAL__HELICOPTERS = "FIREWORKS||CONSUMER_AERIAL||HELICOPTERS"
    FIREWORKS__CONSUMER_AERIAL__MISSILES = "FIREWORKS||CONSUMER_AERIAL||MISSILES"
    FIREWORKS__CONSUMER_AERIAL__OTHER_SPECIALTY_ITEMS = (
        "FIREWORKS||CONSUMER_AERIAL||OTHER_SPECIALTY_ITEMS"
    )
    FIREWORKS__CONSUMER_AERIAL__RELOADABLE_TUBE_AERIAL = (
        "FIREWORKS||CONSUMER_AERIAL||RELOADABLE_TUBE_AERIAL"
    )
    FIREWORKS__CONSUMER_AERIAL__ROCKETS = "FIREWORKS||CONSUMER_AERIAL||ROCKETS"
    FIREWORKS__CONSUMER_AERIAL__ROMAN_CANDLES = "FIREWORKS||CONSUMER_AERIAL||ROMAN_CANDLES"
    FIREWORKS__CONSUMER_NON_AERIAL__CHASERS = "FIREWORKS||CONSUMER_NON_AERIAL||CHASERS"
    FIREWORKS__CONSUMER_NON_AERIAL__COMBINATION_ITEMS = (
        "FIREWORKS||CONSUMER_NON_AERIAL||COMBINATION_ITEMS"
    )
    FIREWORKS__CONSUMER_NON_AERIAL__FIRECRACKERS = "FIREWORKS||CONSUMER_NON_AERIAL||FIRECRACKERS"
    FIREWORKS__CONSUMER_NON_AERIAL__FOUNTAINS = "FIREWORKS||CONSUMER_NON_AERIAL||FOUNTAINS"
    FIREWORKS__CONSUMER_NON_AERIAL__GROUND_SPINNERS = (
        "FIREWORKS||CONSUMER_NON_AERIAL||GROUND_SPINNERS"
    )
    FIREWORKS__CONSUMER_NON_AERIAL__HANDHELD_SPARKLERS = (
        "FIREWORKS||CONSUMER_NON_AERIAL||HANDHELD_SPARKLERS"
    )
    FIREWORKS__CONSUMER_NON_AERIAL__OTHER_SPECIALTY_ITEMS = (
        "FIREWORKS||CONSUMER_NON_AERIAL||OTHER_SPECIALTY_ITEMS"
    )
    FIREWORKS__CONSUMER_NON_AERIAL__WHEELS = "FIREWORKS||CONSUMER_NON_AERIAL||WHEELS"
    FIREWORKS__DEREGULATED_NOVELTIES__PARTY_POPPERS = (
        "FIREWORKS||DEREGULATED_NOVELTIES||PARTY_POPPERS"
    )
    FIREWORKS__DEREGULATED_NOVELTIES__SMOKE_BALLS = "FIREWORKS||DEREGULATED_NOVELTIES||SMOKE_BALLS"
    FIREWORKS__DEREGULATED_NOVELTIES__SNAKES = "FIREWORKS||DEREGULATED_NOVELTIES||SNAKES"
    FIREWORKS__DEREGULATED_NOVELTIES__SNAP_CAPS = "FIREWORKS||DEREGULATED_NOVELTIES||SNAP_CAPS"
    FIREWORKS__DEREGULATED_NOVELTIES__WIRE_CORE_SPARKLERS = (
        "FIREWORKS||DEREGULATED_NOVELTIES||WIRE_CORE_SPARKLERS"
    )
    FIREWORKS__EXPLOSIVES__1_4_STICK = "FIREWORKS||EXPLOSIVES||1_4_STICK"
    FIREWORKS__EXPLOSIVES__ALTERED_CONSUMER_FIREWORKS = (
        "FIREWORKS||EXPLOSIVES||ALTERED_CONSUMER_FIREWORKS"
    )
    FIREWORKS__EXPLOSIVES__CHERRY_BOMB = "FIREWORKS||EXPLOSIVES||CHERRY_BOMB"
    FIREWORKS__EXPLOSIVES__HOMEMADE_EXPLOSIVE_DEVICE = (
        "FIREWORKS||EXPLOSIVES||HOMEMADE_EXPLOSIVE_DEVICE"
    )
    FIREWORKS__EXPLOSIVES__M_100 = "FIREWORKS||EXPLOSIVES||M_100"
    FIREWORKS__EXPLOSIVES__M_1000 = "FIREWORKS||EXPLOSIVES||M_1000"
    FIREWORKS__EXPLOSIVES__M_80 = "FIREWORKS||EXPLOSIVES||M_80"
    FIREWORKS__EXPLOSIVES__SILVER_SALUTE = "FIREWORKS||EXPLOSIVES||SILVER_SALUTE"
    FIREWORKS__EXPLOSIVES__SPARKLER_BOMB = "FIREWORKS||EXPLOSIVES||SPARKLER_BOMB"
    FIREWORKS__MODEL_AMATEUR_ROCKETS = "FIREWORKS||MODEL_AMATEUR_ROCKETS"
    FIREWORKS__OTHER = "FIREWORKS||OTHER"
    FIREWORKS__PROFESSIONAL_DISPLAY__INDOOR_PROXIMATE = (
        "FIREWORKS||PROFESSIONAL_DISPLAY||INDOOR_PROXIMATE"
    )
    FIREWORKS__PROFESSIONAL_DISPLAY__OUTDOOR_AERIAL_SHELL = (
        "FIREWORKS||PROFESSIONAL_DISPLAY||OUTDOOR_AERIAL_SHELL"
    )
    FIREWORKS__PROFESSIONAL_DISPLAY__OUTDOOR_GROUND_LEVEL = (
        "FIREWORKS||PROFESSIONAL_DISPLAY||OUTDOOR_GROUND_LEVEL"
    )
    FIREWORKS__PROFESSIONAL_DISPLAY__OUTDOOR_LOW_LEVEL = (
        "FIREWORKS||PROFESSIONAL_DISPLAY||OUTDOOR_LOW_LEVEL"
    )
    FIREWORKS__PROFESSIONAL_DISPLAY__OUTDOOR_PROXIMATE = (
        "FIREWORKS||PROFESSIONAL_DISPLAY||OUTDOOR_PROXIMATE"
    )
    FIREWORKS__UNKNOWN = "FIREWORKS||UNKNOWN"
    INCENDIARY__DEVICE = "INCENDIARY||DEVICE"
    INCENDIARY__FLINT_FRICTION = "INCENDIARY||FLINT_FRICTION"
    INCENDIARY__GLASS_REFRACTION_MAGNIFYING_GLASS = "INCENDIARY||GLASS_REFRACTION_MAGNIFYING_GLASS"
    INCENDIARY__HOT_SET = "INCENDIARY||HOT_SET"
    INCENDIARY__LIGHTER_MATCHES = "INCENDIARY||LIGHTER_MATCHES"
    INCENDIARY__OTHER = "INCENDIARY||OTHER"
    INCENDIARY__UNKNOWN = "INCENDIARY||UNKNOWN"
    NATURAL__ANIMAL = "NATURAL||ANIMAL"
    NATURAL__GLASS_REFRACTION_MAGNIFYING_GLASS = "NATURAL||GLASS_REFRACTION_MAGNIFYING_GLASS"
    NATURAL__LIGHTNING = "NATURAL||LIGHTNING"
    NATURAL__OTHER = "NATURAL||OTHER"
    NATURAL__SPONTANEOUS_COMBUSTION = "NATURAL||SPONTANEOUS_COMBUSTION"
    NATURAL__UNKNOWN = "NATURAL||UNKNOWN"
    NATURAL__VOLCANO = "NATURAL||VOLCANO"
    POWER_GEN_TRANS_DIST__ELECTRICAL_TRANSMISSION_DISTRIBUTION_SYSTEMS = (
        "POWER_GEN_TRANS_DIST||ELECTRICAL_TRANSMISSION_DISTRIBUTION_SYSTEMS"
    )
    POWER_GEN_TRANS_DIST__ENERGY_STORAGE_SYSTEM = "POWER_GEN_TRANS_DIST||ENERGY_STORAGE_SYSTEM"
    POWER_GEN_TRANS_DIST__OIL_GAS_PRODUCTION_TRANSPORTATION = (
        "POWER_GEN_TRANS_DIST||OIL_GAS_PRODUCTION_TRANSPORTATION"
    )
    POWER_GEN_TRANS_DIST__OTHER = "POWER_GEN_TRANS_DIST||OTHER"
    POWER_GEN_TRANS_DIST__SOLAR_UTILITY_SYSTEM = "POWER_GEN_TRANS_DIST||SOLAR_UTILITY_SYSTEM"
    POWER_GEN_TRANS_DIST__UNKNOWN = "POWER_GEN_TRANS_DIST||UNKNOWN"
    POWER_GEN_TRANS_DIST__WIND_TURBINE_WINDMILLS_UTILITY_SYSTEM = (
        "POWER_GEN_TRANS_DIST||WIND_TURBINE_WINDMILLS_UTILITY_SYSTEM"
    )
    RAILROAD_OPS_MAINTENANCE__BRAKES = "RAILROAD_OPS_MAINTENANCE||BRAKES"
    RAILROAD_OPS_MAINTENANCE__DERAILMENT = "RAILROAD_OPS_MAINTENANCE||DERAILMENT"
    RAILROAD_OPS_MAINTENANCE__DYNAMIC_GRID_FAILURE = (
        "RAILROAD_OPS_MAINTENANCE||DYNAMIC_GRID_FAILURE"
    )
    RAILROAD_OPS_MAINTENANCE__EXHAUST_PARTICLES = "RAILROAD_OPS_MAINTENANCE||EXHAUST_PARTICLES"
    RAILROAD_OPS_MAINTENANCE__HOT_WORK = "RAILROAD_OPS_MAINTENANCE||HOT_WORK"
    RAILROAD_OPS_MAINTENANCE__OTHER = "RAILROAD_OPS_MAINTENANCE||OTHER"
    RAILROAD_OPS_MAINTENANCE__OTHER_MECHANICAL_FAILURE = (
        "RAILROAD_OPS_MAINTENANCE||OTHER_MECHANICAL_FAILURE"
    )
    RAILROAD_OPS_MAINTENANCE__RAIL_GRINDING = "RAILROAD_OPS_MAINTENANCE||RAIL_GRINDING"
    RAILROAD_OPS_MAINTENANCE__RIGHT_OF_WAY_VEGETATION_MAINTENANCE = (
        "RAILROAD_OPS_MAINTENANCE||RIGHT_OF_WAY_VEGETATION_MAINTENANCE"
    )
    RAILROAD_OPS_MAINTENANCE__TRACK_REPLACEMENT = "RAILROAD_OPS_MAINTENANCE||TRACK_REPLACEMENT"
    RAILROAD_OPS_MAINTENANCE__UNKNOWN = "RAILROAD_OPS_MAINTENANCE||UNKNOWN"
    RECREATION_CEREMONY__BARBECUE_SMOKER = "RECREATION_CEREMONY||BARBECUE_SMOKER"
    RECREATION_CEREMONY__BONFIRE_PARTY_FIRE = "RECREATION_CEREMONY||BONFIRE_PARTY_FIRE"
    RECREATION_CEREMONY__CAMPFIRE = "RECREATION_CEREMONY||CAMPFIRE"
    RECREATION_CEREMONY__CEREMONIAL_FIRE = "RECREATION_CEREMONY||CEREMONIAL_FIRE"
    RECREATION_CEREMONY__GAS_COOKING_WARMING_LIGHTING_DEVICE = (
        "RECREATION_CEREMONY||GAS_COOKING_WARMING_LIGHTING_DEVICE"
    )
    RECREATION_CEREMONY__LUMINARY = "RECREATION_CEREMONY||LUMINARY"
    RECREATION_CEREMONY__OTHER = "RECREATION_CEREMONY||OTHER"
    RECREATION_CEREMONY__OUTDOOR_OVEN_FIREPLACE_METAL_FIRE_RING = (
        "RECREATION_CEREMONY||OUTDOOR_OVEN_FIREPLACE_METAL_FIRE_RING"
    )
    RECREATION_CEREMONY__UNKNOWN = "RECREATION_CEREMONY||UNKNOWN"
    SMOKING_MATERIALS_ILLICIT_DRUGS__CIGAR_CIGARETTE_PIPE = (
        "SMOKING_MATERIALS_ILLICIT_DRUGS||CIGAR_CIGARETTE_PIPE"
    )
    SMOKING_MATERIALS_ILLICIT_DRUGS__DRUG_PARAPHERNALIA = (
        "SMOKING_MATERIALS_ILLICIT_DRUGS||DRUG_PARAPHERNALIA"
    )
    SMOKING_MATERIALS_ILLICIT_DRUGS__ELECTRONIC_CIGARETTE = (
        "SMOKING_MATERIALS_ILLICIT_DRUGS||ELECTRONIC_CIGARETTE"
    )
    SMOKING_MATERIALS_ILLICIT_DRUGS__ILLEGAL_SUBSTANCE_MANUFACTURE = (
        "SMOKING_MATERIALS_ILLICIT_DRUGS||ILLEGAL_SUBSTANCE_MANUFACTURE"
    )
    SMOKING_MATERIALS_ILLICIT_DRUGS__OTHER = "SMOKING_MATERIALS_ILLICIT_DRUGS||OTHER"
    SMOKING_MATERIALS_ILLICIT_DRUGS__UNKNOWN = "SMOKING_MATERIALS_ILLICIT_DRUGS||UNKNOWN"
    SPREAD_FROM_CONTROLLED_BURN = "SPREAD_FROM_CONTROLLED_BURN"
    STRUCTURE__ELECTRIC_FENCE = "STRUCTURE||ELECTRIC_FENCE"
    STRUCTURE__SPREAD_FROM_STRUCTURE = "STRUCTURE||SPREAD_FROM_STRUCTURE"
    UNABLE_TO_BE_DETERMINED__NOT_INVESTIGATED = "UNABLE_TO_BE_DETERMINED||NOT_INVESTIGATED"
    UNABLE_TO_BE_DETERMINED__ORIGIN_AND_OR_CAUSE_NOT_IDENTIFIED = (
        "UNABLE_TO_BE_DETERMINED||ORIGIN_AND_OR_CAUSE_NOT_IDENTIFIED"
    )
    UNABLE_TO_BE_DETERMINED__ORIGIN_DESTROYED = "UNABLE_TO_BE_DETERMINED||ORIGIN_DESTROYED"
    UNABLE_TO_BE_DETERMINED__UNDER_INVESTIGATION = "UNABLE_TO_BE_DETERMINED||UNDER_INVESTIGATION"


class OutsideFireResponse(BaseModel):
    neris_uid: Optional[int] = Field(
        None, description="The NERIS unique identifier for the item.", title="Neris Uid"
    )
    last_modified: AwareDatetime = Field(
    ...
    incident_name: Optional[str] = Field(
        None, description="The name of the outdoor incident.", title="Incident Name"
    )
    incident_start: Optional[AwareDatetime] = Field(
        None, description="The time the outdoor incident began.", title="Incident Start"
    )
    incident_end: Optional[AwareDatetime] = Field(
        None, description="The time the outdoor incident ended.", title="Incident End"
    )
    acres_burned: Optional[float] = Field(
        None, description="The number of acres burned.", title="Acres Burned"
    )
    open_burning: Optional[bool] = Field(
        None,
        description="If the fire was caused by open burning, was a permit issued?",
        title="Open Burning",
    )
    minor_involved: Optional[bool] = Field(
        None,
        description="Whether the fire's ignition had a minor involved.",
        title="Minor Involved",
    )
    elevation: Optional[int] = Field(
        None,
        description="The elevation of the ignition point (in feet).",
        title="Elevation",
    )
    flame_length: Optional[int] = Field(
        None, description="The length of the flame (in feet).", title="Flame Length"
    )
    incident_complexity: Optional[str] = Field(
        None,
        description="The complexity of the outdoor incident.",
        title="Incident Complexity",
    )
    general_cause: str = Field(
        ..., description="The general cause of the outdoor fire.", title="General Cause"
    )
    heat_sources: Optional[List[str]] = Field(
        None,
        description="The heat sources involved in the outdoor fire.",
        title="Heat Sources",
    )
    cause: str = Field(..., description="The primary cause of the outdoor fire.", title="Cause")
    contributing_activities: Optional[List[str]] = Field(
        None,
        description="The activities contributing to the outdoor fire.",
        title="Contributing Activities",
    )
    fuel_arrangement: Optional[List[str]] = Field(
        None, description="The arrangement of fuels involved.", title="Fuel Arrangement"
    )
    fuel_size: Optional[List[str]] = Field(
        None,
        description="The diameter (in inches) of the fuels involved.",
        title="Fuel Size",
    )
    fuel_distribution: Optional[List[str]] = Field(
        None,
        description="The distribution of fuels involved.",
        title="Fuel Distribution",
    )
    relative_position: Optional[str] = Field(
        None,
        description="The relative position of the fire.",
        title="Relative Position",
    )
    fire_aspect: Optional[str] = Field(
        None, description="The aspect of the fire.", title="Fire Aspect"
    )
    rate_of_spread: Optional[str] = Field(
        None, description="The rate of spread of the fire.", title="Rate Of Spread"
    )
    polygons: Optional[Union[GeoPoint, GeoMultipolygon, str]] = Field(None, title="Polygons")
    ignition_point: Optional[Union[GeoPoint, GeoMultipolygon, str]] = Field(
        None, title="Ignition Point"
    )
...
class PresenceKnownPayload(BaseModel):
    ...
    presence_known_type: PresenceKnownType = Field(
        ...,
        description=" At what point the presence of an occupant was discovered during the incident duration.",
    )
...
class ProductInvolved(Enum):
    ALARM_ESCAPE_PROTECTION_DEVICES = "ALARM_ESCAPE_PROTECTION_DEVICES"
    CHILD_NURSERY_EQUIPMENT = "CHILD_NURSERY_EQUIPMENT"
    FARM_SUPPLIES_EQUIPMENT = "FARM_SUPPLIES_EQUIPMENT"
    FURNISHINGS_FIXTURES = "FURNISHINGS_FIXTURES"
    GENERAL_HOUSEHOLD_APPLIANCE = "GENERAL_HOUSEHOLD_APPLIANCE"
    HEATING_COOLING_VENT_APPLIANCE = "HEATING_COOLING_VENT_APPLIANCE"
    HOME_COMM_ENTERTAINMENT_HOBBY_EQUIPMENT = "HOME_COMM_ENTERTAINMENT_HOBBY_EQUIPMENT"
    HOME_FAMILY_MAINTENANCE_PRODUCT = "HOME_FAMILY_MAINTENANCE_PRODUCT"
    HOUSEHOLD_PACKAGING_CONTAINER = "HOUSEHOLD_PACKAGING_CONTAINER"
    HOUSEWARE_NON_POWERED = "HOUSEWARE_NON_POWERED"
    KITCHEN_APPLIANCE = "KITCHEN_APPLIANCE"
    MISC_PRODUCT = "MISC_PRODUCT"
    PERSONAL_USE_ITEM = "PERSONAL_USE_ITEM"
    REGULATED_PRODUCTS = "REGULATED_PRODUCTS"
    SPORTS_RECREATION = "SPORTS_RECREATION"
    STRUCTURES_CONSTRUCTION = "STRUCTURES_CONSTRUCTION"
    TOYS = "TOYS"
    TOYS_MOBILITY_OTHER = "TOYS_MOBILITY_OTHER"
    WORKSHOP_TOOL_APPARATUS = "WORKSHOP_TOOL_APPARATUS"
    YARD_GARDEN_EQUIPMENT = "YARD_GARDEN_EQUIPMENT"
...
class ProductResponse(BaseModel):
    ...
    description: str = Field(
        ..., description="The description of the product.", title="Description"
    )
    item_first_ignited: Optional[bool] = Field(
        None,
        description="Whether the item was the first to ignite.",
        title="Item First Ignited",
    )
    manufacturer: Optional[str] = Field(
        None, description="The manufacturer of the product.", title="Manufacturer"
    )
    model_number: Optional[str] = Field(
        None, description="The model number of the product.", title="Model Number"
    )
    product_involved: str = Field(
        ...,
        description="The type of product involved in the fire.",
        title="Product Involved",
    )
    contribution: Optional[str] = Field(
        None,
        description="The product's contribution to the fire.",
        title="Contribution",
    )
...
class ReleaseWithReleaseFactorsResponse(BaseModel):
    neris_uid: Optional[int] = Field(
        None, description="The NERIS unique identifier for the item.", title="Neris Uid"
    )
    last_modified: AwareDatetime = Field(
    ...
    cause: Optional[str] = Field(None, description="Cause of the hazmat release.", title="Cause")
    release_factors: Optional[List[str]] = Field(None, title="Release Factors")
...
class RemovalResponse(BaseModel):
    ...
    rescue_path_type: Optional[str] = Field(
        None,
        description="The type of route or pathway utilized to remove the person.",
        title="Rescue Path Type",
    )
    fire_removal: Optional[FireRemovalResponse] = None


class RemoveAidAction(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class RemoveCasualtyRescueAction(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    action: Literal["remove"] = Field(
...
class RemoveChemicalAction(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    action: Literal["remove"] = Field(
...
class RemoveCommentAction(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    action: Literal["remove"] = Field(
...
class RemoveCrossStreetAction(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    action: Literal["remove"] = Field(
...
class RemoveDispatchUnitResponseAction(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    action: Literal["remove"] = Field(
...
class RemoveExposureAction(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    action: Literal["remove"] = Field(
...
class RemoveIncidentTypeAction(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    action: Literal["remove"] = Field(
...
class RemoveIncidentUnitResponseAction(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    action: Literal["remove"] = Field(
...
class RemoveLocationAction(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    action: Literal["remove"] = Field(
...
class RemoveMedResponseAction(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    action: Literal["remove"] = Field(
...
class RemoveMedicalAction(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    action: Literal["remove"] = Field(
...
class RoleActionResourceResponse(BaseModel):
    action: str = Field(
        ..., description="The type of action allowed on the resource.", title="Action"
    )
    resource: str = Field(
        ...,
...
class RoleResponse(BaseModel):
    ...
    action_resources: Optional[List[RoleActionResourceResponse]] = Field(
...
class SetDateTimeAction(BaseModel):
    ...
    value: AwareDatetime = Field(
        ...,
        description="An ISO 8601 formatted datetime string or Unix time (seconds since 1 January 1970) as a float, integer, or string. Must be after Jan 1, 2025 EST and prior to the time of the request.",
        examples=[
            "2025-06-13T21:14:02.162497-07:00",
            "1749874442.162497",
            1749874442.162497,
            1749874442,
        ],
...
class SetNerisIdUnitStrAction(BaseModel):
    ...
    action: Literal["set"] = Field(..., description="Set the value of an attribute", title="Action")
    value: constr(pattern=r"^FD\d{8}S[A-Z\d]{3}U[A-Z\d]{3}$") = Field(
...
class Type16(Enum):
    CARPORT_LEANTO = "CARPORT_LEANTO"
    FENCE = "FENCE"
    GARAGE = "GARAGE"
    OTHER = "OTHER"
    PATIO_COVER_AWNING = "PATIO_COVER_AWNING"
    PORCH_DECK = "PORCH_DECK"


class StructureAttachmentResponse(BaseModel):
    neris_uid: Optional[int] = Field(
        None, description="The NERIS unique identifier for the item.", title="Neris Uid"
    )
    last_modified: AwareDatetime = Field(
    ...
    type: str = Field(..., description="The type of the addition to the structure.", title="Type")
    grade: Optional[str] = Field(
        None, description="The grade of the addition to the structure.", title="Grade"
    )
    impacted: Optional[bool] = Field(
        None,
        description="Whether the addition to the structure was impacted by the fire.",
        title="Impacted",
    )
    materials: Optional[List[str]] = Field(
        None, description="The materials the addition was made of.", title="Materials"
    )


class ArrivalCondition(Enum):
...
class StructureFireLocationDetailPayload(BaseModel):
    ...
    floor_of_origin: int = Field(
        ...,
        description="Story above or below ground of fire origin. Negative integer is below ground, positive is above ground. 1 is ground floor.",
        examples=[1, 2, 3],
        title="Floor Of Origin",
    )
    arrival_condition: ArrivalCondition = Field(
    ...
    room_of_origin_type: RoomOfOriginType = Field(
...
class Cause3(Enum):
    ACT_OF_NATURE__GLASS_REFRACTION_MAGNIFYING_GLASS = (
        "ACT_OF_NATURE||GLASS_REFRACTION_MAGNIFYING_GLASS"
    )
    ACT_OF_NATURE__LIGHTNING = "ACT_OF_NATURE||LIGHTNING"
    ACT_OF_NATURE__OTHER = "ACT_OF_NATURE||OTHER"
    ACT_OF_NATURE__SPONTANEOUS_COMBUSTION = "ACT_OF_NATURE||SPONTANEOUS_COMBUSTION"
    ACT_OF_NATURE__UNKNOWN = "ACT_OF_NATURE||UNKNOWN"
    ACT_OF_NATURE__VOLCANO = "ACT_OF_NATURE||VOLCANO"
    BATTERY_POWER_STORAGE__BATTERY_CONSUMER_PRODUCT = (
        "BATTERY_POWER_STORAGE||BATTERY_CONSUMER_PRODUCT"
    )
    BATTERY_POWER_STORAGE__ENERGY_STORAGE_SYSTEM = "BATTERY_POWER_STORAGE||ENERGY_STORAGE_SYSTEM"
    CHEMICAL__CHEMICAL_LABORATORY = "CHEMICAL||CHEMICAL_LABORATORY"
    COOKING__DRY_COOKING = "COOKING||DRY_COOKING"
    COOKING__KITCHEN_APPLIANCE_OVEN = "COOKING||KITCHEN_APPLIANCE_OVEN"
    COOKING__OIL_GREASE = "COOKING||OIL_GREASE"
    ELECTRICAL__ELECTRICAL_EQUIPMENT = "ELECTRICAL||ELECTRICAL_EQUIPMENT"
    ELECTRICAL__ELECTRICAL_TRANSMISSION_DISTRIBUTION_SYSTEMS = (
        "ELECTRICAL||ELECTRICAL_TRANSMISSION_DISTRIBUTION_SYSTEMS"
    )
    ELECTRICAL__ELECTRIC_FENCE = "ELECTRICAL||ELECTRIC_FENCE"
    ELECTRICAL__OTHER = "ELECTRICAL||OTHER"
    ELECTRICAL__SOLAR_UTILITY_SYSTEM = "ELECTRICAL||SOLAR_UTILITY_SYSTEM"
    ELECTRICAL__UNKNOWN = "ELECTRICAL||UNKNOWN"
    EXPLOSIVES_FIREWORKS__AMMONIUM_NITRATE_FUEL_OIL = (
        "EXPLOSIVES_FIREWORKS||AMMONIUM_NITRATE_FUEL_OIL"
    )
    EXPLOSIVES_FIREWORKS__BLACK_POWDER_MUZZLE_LOADING = (
        "EXPLOSIVES_FIREWORKS||BLACK_POWDER_MUZZLE_LOADING"
    )
    EXPLOSIVES_FIREWORKS__BLASTING = "EXPLOSIVES_FIREWORKS||BLASTING"
    EXPLOSIVES_FIREWORKS__CONSUMER_AERIAL__COMETS_MINES_SHELLS = (
        "EXPLOSIVES_FIREWORKS||CONSUMER_AERIAL||COMETS_MINES_SHELLS"
    )
    EXPLOSIVES_FIREWORKS__CONSUMER_AERIAL__HELICOPTERS = (
        "EXPLOSIVES_FIREWORKS||CONSUMER_AERIAL||HELICOPTERS"
    )
    EXPLOSIVES_FIREWORKS__CONSUMER_AERIAL__MISSILES = (
        "EXPLOSIVES_FIREWORKS||CONSUMER_AERIAL||MISSILES"
    )
    EXPLOSIVES_FIREWORKS__CONSUMER_AERIAL__OTHER_SPECIALTY_ITEMS = (
        "EXPLOSIVES_FIREWORKS||CONSUMER_AERIAL||OTHER_SPECIALTY_ITEMS"
    )
    EXPLOSIVES_FIREWORKS__CONSUMER_AERIAL__RELOADABLE_TUBE_AERIAL = (
        "EXPLOSIVES_FIREWORKS||CONSUMER_AERIAL||RELOADABLE_TUBE_AERIAL"
    )
    EXPLOSIVES_FIREWORKS__CONSUMER_AERIAL__ROCKETS = (
        "EXPLOSIVES_FIREWORKS||CONSUMER_AERIAL||ROCKETS"
    )
    EXPLOSIVES_FIREWORKS__CONSUMER_AERIAL__ROMAN_CANDLES = (
        "EXPLOSIVES_FIREWORKS||CONSUMER_AERIAL||ROMAN_CANDLES"
    )
    EXPLOSIVES_FIREWORKS__CONSUMER_NON_AERIAL__CHASERS = (
        "EXPLOSIVES_FIREWORKS||CONSUMER_NON_AERIAL||CHASERS"
    )
    EXPLOSIVES_FIREWORKS__CONSUMER_NON_AERIAL__COMBINATION_ITEMS = (
        "EXPLOSIVES_FIREWORKS||CONSUMER_NON_AERIAL||COMBINATION_ITEMS"
    )
    EXPLOSIVES_FIREWORKS__CONSUMER_NON_AERIAL__FIRECRACKERS = (
        "EXPLOSIVES_FIREWORKS||CONSUMER_NON_AERIAL||FIRECRACKERS"
    )
    EXPLOSIVES_FIREWORKS__CONSUMER_NON_AERIAL__FOUNTAINS = (
        "EXPLOSIVES_FIREWORKS||CONSUMER_NON_AERIAL||FOUNTAINS"
    )
    EXPLOSIVES_FIREWORKS__CONSUMER_NON_AERIAL__GROUND_SPINNERS = (
        "EXPLOSIVES_FIREWORKS||CONSUMER_NON_AERIAL||GROUND_SPINNERS"
    )
    EXPLOSIVES_FIREWORKS__CONSUMER_NON_AERIAL__HANDHELD_SPARKLERS = (
        "EXPLOSIVES_FIREWORKS||CONSUMER_NON_AERIAL||HANDHELD_SPARKLERS"
    )
    EXPLOSIVES_FIREWORKS__CONSUMER_NON_AERIAL__OTHER_SPECIALTY_ITEMS = (
        "EXPLOSIVES_FIREWORKS||CONSUMER_NON_AERIAL||OTHER_SPECIALTY_ITEMS"
    )
    EXPLOSIVES_FIREWORKS__CONSUMER_NON_AERIAL__WHEELS = (
        "EXPLOSIVES_FIREWORKS||CONSUMER_NON_AERIAL||WHEELS"
    )
    EXPLOSIVES_FIREWORKS__DEREGULATED_NOVELTIES__PARTY_POPPERS = (
        "EXPLOSIVES_FIREWORKS||DEREGULATED_NOVELTIES||PARTY_POPPERS"
    )
    EXPLOSIVES_FIREWORKS__DEREGULATED_NOVELTIES__SMOKE_BALLS = (
        "EXPLOSIVES_FIREWORKS||DEREGULATED_NOVELTIES||SMOKE_BALLS"
    )
    EXPLOSIVES_FIREWORKS__DEREGULATED_NOVELTIES__SNAKES = (
        "EXPLOSIVES_FIREWORKS||DEREGULATED_NOVELTIES||SNAKES"
    )
    EXPLOSIVES_FIREWORKS__DEREGULATED_NOVELTIES__SNAP_CAPS = (
        "EXPLOSIVES_FIREWORKS||DEREGULATED_NOVELTIES||SNAP_CAPS"
    )
    EXPLOSIVES_FIREWORKS__DEREGULATED_NOVELTIES__WIRE_CORE_SPARKLERS = (
        "EXPLOSIVES_FIREWORKS||DEREGULATED_NOVELTIES||WIRE_CORE_SPARKLERS"
    )
    EXPLOSIVES_FIREWORKS__DETONATING_CORD = "EXPLOSIVES_FIREWORKS||DETONATING_CORD"
    EXPLOSIVES_FIREWORKS__EXPLODING_TARGET_SHOOTING = (
        "EXPLOSIVES_FIREWORKS||EXPLODING_TARGET_SHOOTING"
    )
    EXPLOSIVES_FIREWORKS__EXPLOSIVES__1_4_STICK = "EXPLOSIVES_FIREWORKS||EXPLOSIVES||1_4_STICK"
    EXPLOSIVES_FIREWORKS__EXPLOSIVES__ALTERED_CONSUMER_FIREWORKS = (
        "EXPLOSIVES_FIREWORKS||EXPLOSIVES||ALTERED_CONSUMER_FIREWORKS"
    )
    EXPLOSIVES_FIREWORKS__EXPLOSIVES__CHERRY_BOMB = "EXPLOSIVES_FIREWORKS||EXPLOSIVES||CHERRY_BOMB"
    EXPLOSIVES_FIREWORKS__EXPLOSIVES__HOMEMADE_EXPLOSIVE_DEVICE = (
        "EXPLOSIVES_FIREWORKS||EXPLOSIVES||HOMEMADE_EXPLOSIVE_DEVICE"
    )
    EXPLOSIVES_FIREWORKS__EXPLOSIVES__M_100 = "EXPLOSIVES_FIREWORKS||EXPLOSIVES||M_100"
    EXPLOSIVES_FIREWORKS__EXPLOSIVES__M_1000 = "EXPLOSIVES_FIREWORKS||EXPLOSIVES||M_1000"
    EXPLOSIVES_FIREWORKS__EXPLOSIVES__M_80 = "EXPLOSIVES_FIREWORKS||EXPLOSIVES||M_80"
    EXPLOSIVES_FIREWORKS__EXPLOSIVES__SILVER_SALUTE = (
        "EXPLOSIVES_FIREWORKS||EXPLOSIVES||SILVER_SALUTE"
    )
    EXPLOSIVES_FIREWORKS__EXPLOSIVES__SPARKLER_BOMB = (
        "EXPLOSIVES_FIREWORKS||EXPLOSIVES||SPARKLER_BOMB"
    )
    EXPLOSIVES_FIREWORKS__FLARES_FUSES = "EXPLOSIVES_FIREWORKS||FLARES_FUSES"
    EXPLOSIVES_FIREWORKS__IMPROVISED_EXPLOSIVE_DEVICE = (
        "EXPLOSIVES_FIREWORKS||IMPROVISED_EXPLOSIVE_DEVICE"
    )
    EXPLOSIVES_FIREWORKS__INERT_TARGET_SHOOTING = "EXPLOSIVES_FIREWORKS||INERT_TARGET_SHOOTING"
    EXPLOSIVES_FIREWORKS__MILITARY_ORDINANCE = "EXPLOSIVES_FIREWORKS||MILITARY_ORDINANCE"
    EXPLOSIVES_FIREWORKS__MODEL_AMATEUR_ROCKETS = "EXPLOSIVES_FIREWORKS||MODEL_AMATEUR_ROCKETS"
    EXPLOSIVES_FIREWORKS__NON_MILITARY_TRACER = "EXPLOSIVES_FIREWORKS||NON_MILITARY_TRACER"
    EXPLOSIVES_FIREWORKS__OTHER = "EXPLOSIVES_FIREWORKS||OTHER"
    EXPLOSIVES_FIREWORKS__OTHER_EXPLOSIVES = "EXPLOSIVES_FIREWORKS||OTHER_EXPLOSIVES"
    EXPLOSIVES_FIREWORKS__PIPE_BOMB = "EXPLOSIVES_FIREWORKS||PIPE_BOMB"
    EXPLOSIVES_FIREWORKS__PROFESSIONAL_DISPLAY__INDOOR_PROXIMATE = (
        "EXPLOSIVES_FIREWORKS||PROFESSIONAL_DISPLAY||INDOOR_PROXIMATE"
    )
    EXPLOSIVES_FIREWORKS__PROFESSIONAL_DISPLAY__OUTDOOR_AERIAL_SHELL = (
        "EXPLOSIVES_FIREWORKS||PROFESSIONAL_DISPLAY||OUTDOOR_AERIAL_SHELL"
    )
    EXPLOSIVES_FIREWORKS__PROFESSIONAL_DISPLAY__OUTDOOR_GROUND_LEVEL = (
        "EXPLOSIVES_FIREWORKS||PROFESSIONAL_DISPLAY||OUTDOOR_GROUND_LEVEL"
    )
    EXPLOSIVES_FIREWORKS__PROFESSIONAL_DISPLAY__OUTDOOR_LOW_LEVEL = (
        "EXPLOSIVES_FIREWORKS||PROFESSIONAL_DISPLAY||OUTDOOR_LOW_LEVEL"
    )
    EXPLOSIVES_FIREWORKS__PROFESSIONAL_DISPLAY__OUTDOOR_PROXIMATE = (
        "EXPLOSIVES_FIREWORKS||PROFESSIONAL_DISPLAY||OUTDOOR_PROXIMATE"
    )
    EXPLOSIVES_FIREWORKS__UNKNOWN = "EXPLOSIVES_FIREWORKS||UNKNOWN"
    HEAT_FROM_ANOTHER_OBJECT__SPREAD_FROM_OUTSIDE_STRUCTURE = (
        "HEAT_FROM_ANOTHER_OBJECT||SPREAD_FROM_OUTSIDE_STRUCTURE"
    )
    INCENDIARY__DEVICE = "INCENDIARY||DEVICE"
    INCENDIARY__FLINT_FRICTION = "INCENDIARY||FLINT_FRICTION"
    INCENDIARY__GLASS_REFRACTION_MAGNIFYING_GLASS = "INCENDIARY||GLASS_REFRACTION_MAGNIFYING_GLASS"
    ...
    INCENDIARY__OTHER = "INCENDIARY||OTHER"
    INCENDIARY__UNKNOWN = "INCENDIARY||UNKNOWN"
    OPEN_FLAME__BARBEQUE_SMOKER = "OPEN_FLAME||BARBEQUE_SMOKER"
    OPEN_FLAME__EXPOSURE_FIRE_PIT_OPEN_FLAME = "OPEN_FLAME||EXPOSURE_FIRE_PIT_OPEN_FLAME"
    OPEN_FLAME__LUMINARY_CANDLES_INCENSE = "OPEN_FLAME||LUMINARY_CANDLES_INCENSE"
    OPEN_FLAME__OTHER = "OPEN_FLAME||OTHER"
    OPEN_FLAME__UNKNOWN = "OPEN_FLAME||UNKNOWN"
    OPERATING_EQUIPMENT__HEATING_COOLING_EQUIPMENT = (
        "OPERATING_EQUIPMENT||HEATING_COOLING_EQUIPMENT"
    )
    OPERATING_EQUIPMENT__HOT_WORK = "OPERATING_EQUIPMENT||HOT_WORK"
    OPERATING_EQUIPMENT__OTHER = "OPERATING_EQUIPMENT||OTHER"
    OPERATING_EQUIPMENT__OTHER_SMALL_ENGINE_EQUIPMENT = (
        "OPERATING_EQUIPMENT||OTHER_SMALL_ENGINE_EQUIPMENT"
    )
    OPERATING_EQUIPMENT__UNKNOWN = "OPERATING_EQUIPMENT||UNKNOWN"
    OTHER_HEAT_SOURCE__OTHER = "OTHER_HEAT_SOURCE||OTHER"
    SMOKING_MATERIALS_ILLICIT_DRUGS__CIGAR_CIGARETTE_PIPE = (
        "SMOKING_MATERIALS_ILLICIT_DRUGS||CIGAR_CIGARETTE_PIPE"
    )
    SMOKING_MATERIALS_ILLICIT_DRUGS__DRUG_PARAPHERNALIA = (
...
class TokenBody(BaseModel):
    username: Optional[str] = Field(
        None,
        description='The username if grant_type is "password", "email_otp", "software_token_mfa", or "new_password_required"',
        title="Username",
    )
    ...
    new_password: Optional[str] = Field(
        None,
        description='The new password if grant_type is "new_password_required"',
        title="New Password",
    )
    session: Optional[str] = Field(
        None,
        description='The session if the grant type is "email_otp", "software_token_mfa" or "new_password_required"',
        title="Session",
    )
    generate_refresh_token: Optional[bool] = Field(
        False,
        description="Whether to return a refresh token in the response",
        title="Generate Refresh Token",
    )
    grant_type: GrantType = Field(..., description="Requested grant type")


class TypeAccountValue(Enum):
    CAD = "CAD"
    RMS = "RMS"
    USER = "USER"
...
class TypeAidAgreementValue(Enum):
    AUTOMATIC = "AUTOMATIC"
...
class TypeAttachedMaterialValue(Enum):
    COMBUSTIBLE = "COMBUSTIBLE"
    NON_COMBUSTIBLE = "NON_COMBUSTIBLE"
    UNKNOWN = "UNKNOWN"


class TypeAttachedValue(Enum):
    CARPORT_LEANTO = "CARPORT_LEANTO"
    FENCE = "FENCE"
    GARAGE = "GARAGE"
    OTHER = "OTHER"
...
class TypeAutoBodyStyleValue(Enum):
    AMBULANCE = "AMBULANCE"
    BUS = "BUS"
...
class TypeAutoMakeValue(Enum):
    ACURA = "ACURA"
    AGCO = "AGCO"
    ALFA_ROMEO = "ALFA_ROMEO"
    ASTON_MARTIN = "ASTON_MARTIN"
    AUDI = "AUDI"
    BENTLEY_MOTORS = "BENTLEY_MOTORS"
    BMW = "BMW"
    BOLLINGER_MOTORS = "BOLLINGER_MOTORS"
    BUGATTI = "BUGATTI"
    BUICK = "BUICK"
    CADILLAC = "CADILLAC"
    CANOO = "CANOO"
    ...
    CHRYSLER = "CHRYSLER"
    CLAAS = "CLAAS"
    DELOREAN_MOTOR_COMPANY = "DELOREAN_MOTOR_COMPANY"
    DEUTZ_FAHR = "DEUTZ_FAHR"
    DODGE = "DODGE"
    FENDT = "FENDT"
    FERRARI = "FERRARI"
    FIAT = "FIAT"
    ...
    LEXUS = "LEXUS"
    LINCOLN = "LINCOLN"
    LORDSTOWN_MOTORS = "LORDSTOWN_MOTORS"
    LOTUS = "LOTUS"
    LUCID_MOTORS = "LUCID_MOTORS"
    MAHINDRA_AND_MAHINDRA = "MAHINDRA_AND_MAHINDRA"
    MASERATI = "MASERATI"
    MASSEY_FERGUSON = "MASSEY_FERGUSON"
    MAYBACH = "MAYBACH"
    MAZDA = "MAZDA"
    MCLAREN = "MCLAREN"
    MERCEDES_AMG = "MERCEDES_AMG"
...
class TypeBatteryCellValue(Enum):
    BUTTON_COIN = "BUTTON_COIN"
    CYLINDRICAL = "CYLINDRICAL"
    OTHER = "OTHER"
    POUCH_POLYMER = "POUCH_POLYMER"
    PRISMATIC = "PRISMATIC"
    UNKNOWN = "UNKNOWN"


class TypeBatteryChemistryValue(Enum):
    ALKALINE = "ALKALINE"
    LEAD_ACID = "LEAD_ACID"
...
class TypeConstructionValue(Enum):
    TYPE_IA = "TYPE_IA"
    TYPE_IB = "TYPE_IB"
    TYPE_IIA = "TYPE_IIA"
    TYPE_IIB = "TYPE_IIB"
...
class TypeConsumerProductValue(Enum):
    ALARM_ESCAPE_PROTECTION_DEVICES = "ALARM_ESCAPE_PROTECTION_DEVICES"
    CHILD_NURSERY_EQUIPMENT = "CHILD_NURSERY_EQUIPMENT"
    FARM_SUPPLIES_EQUIPMENT = "FARM_SUPPLIES_EQUIPMENT"
    FURNISHINGS_FIXTURES = "FURNISHINGS_FIXTURES"
...
class TypeContributingHazardsValue(Enum):
    CIRCUITS_TRIPPED = "CIRCUITS_TRIPPED"
    CO_DETECTED = "CO_DETECTED"
    GAS_FUEL_ON = "GAS_FUEL_ON"
    OTHER = "OTHER"


class TypeDeckPorchGradeValue(Enum):
    BELOW_GRADE_SUNKEN = "BELOW_GRADE_SUNKEN"
    ELEVATED = "ELEVATED"
    ON_GRADE = "ON_GRADE"
...
class TypeDinsOriginCauseValue(Enum):
    DIRECT_FLAME_IMPINGEMENT = "DIRECT_FLAME_IMPINGEMENT"
    EMBERS = "EMBERS"
    OTHER = "OTHER"
...
class TypeDinsOriginLocationValue(Enum):
    ATTACHED_FENCE = "ATTACHED_FENCE"
    ATTACHED_PATIO_COVER_CARPORT = "ATTACHED_PATIO_COVER_CARPORT"
    DECK_ELEVATED = "DECK_ELEVATED"
    DECK_ON_GRADE = "DECK_ON_GRADE"
    EAVES = "EAVES"
    OTHER = "OTHER"
    ROOF = "ROOF"
    SIDING = "SIDING"
...
class TypeDistanceUnitValue(Enum):
    FEET = "FEET"
    MILES = "MILES"
...
class TypeExteriorFinishValue(Enum):
    ASHPHALT = "ASHPHALT"
...
class TypeFaJurisdictionValue(Enum):
    FEDERAL = "FEDERAL"
...
class TypeFireSpreadValue(Enum):
...
class TypeFmJurisdictionValue(Enum):
    COUNTY = "COUNTY"
    LOCAL = "LOCAL"
    STATE = "STATE"


class TypeFoundationValue(Enum):
    CONCRETE_PANELS = "CONCRETE_PANELS"
    CRAWL_SPACE = "CRAWL_SPACE"
    FULL_BASEMENT = "FULL_BASEMENT"
    INSULATED_CONCRETE = "INSULATED_CONCRETE"
    PIER_AND_BEAM_PILE = "PIER_AND_BEAM_PILE"
    POURED_CONCRETE_SLAB = "POURED_CONCRETE_SLAB"
    SLAB_ON_GRADE = "SLAB_ON_GRADE"
    STONE = "STONE"
    WOOD = "WOOD"


class TypeFuelArrangementValue(Enum):
    CROWN_FUELS = "CROWN_FUELS"
    GROUND_FUELS = "GROUND_FUELS"
    SURFACE_FUELS = "SURFACE_FUELS"


class TypeFuelDistributionValue(Enum):
    CONTINUOUS_HORIZONTAL = "CONTINUOUS_HORIZONTAL"
    LADDER_VERTICAL = "LADDER_VERTICAL"


class TypeFuelSizeValue(Enum):
    field_025_TO_1 = "025_TO_1"
    field_1_TO_3 = "1_TO_3"
    field_3_TO_8 = "3_TO_8"
    GREATER_THAN_8 = "GREATER_THAN_8"
    LESS_THAN_025 = "LESS_THAN_025"
...
class TypeGeneralFireCauseValue(Enum):
    ACCIDENTAL = "ACCIDENTAL"
    INCENDIARY = "INCENDIARY"
    NATURAL = "NATURAL"
    UNDETERMINED = "UNDETERMINED"
...
class TypeHazsitReleaseFactorsValue(Enum):
    DESIGN_CONSTRUCTION_INSTALLATION_DEFICIENCY__CONSTRUCTION_DEFICIENCY = (
        "DESIGN_CONSTRUCTION_INSTALLATION_DEFICIENCY||CONSTRUCTION_DEFICIENCY"
    )
    DESIGN_CONSTRUCTION_INSTALLATION_DEFICIENCY__DESIGN_DEFICIENCY = (
        "DESIGN_CONSTRUCTION_INSTALLATION_DEFICIENCY||DESIGN_DEFICIENCY"
    )
    DESIGN_CONSTRUCTION_INSTALLATION_DEFICIENCY__INSTALLATION_DEFICIENCY = (
        "DESIGN_CONSTRUCTION_INSTALLATION_DEFICIENCY||INSTALLATION_DEFICIENCY"
    )
    FAILURE_TO_CONTROL_HAZARDOUS_MATERIAL__ABANDONED_OR_DISCARDED = (
        "FAILURE_TO_CONTROL_HAZARDOUS_MATERIAL||ABANDONED_OR_DISCARDED"
    )
    FAILURE_TO_CONTROL_HAZARDOUS_MATERIAL__IMPROPER_ENVIRONMENT_STOAGE = (
        "FAILURE_TO_CONTROL_HAZARDOUS_MATERIAL||IMPROPER_ENVIRONMENT_STOAGE"
    )
    FAILURE_TO_CONTROL_HAZARDOUS_MATERIAL__IMPROPER_TRANSFER = (
        "FAILURE_TO_CONTROL_HAZARDOUS_MATERIAL||IMPROPER_TRANSFER"
    )
    MECHANICAL_FAILURE_MALFUNCTION__AUTOMATIC_CONTROL_FAILURE = (
        "MECHANICAL_FAILURE_MALFUNCTION||AUTOMATIC_CONTROL_FAILURE"
    )
    MECHANICAL_FAILURE_MALFUNCTION__ELECTRICAL_FAILURE = (
        "MECHANICAL_FAILURE_MALFUNCTION||ELECTRICAL_FAILURE"
    )
    MECHANICAL_FAILURE_MALFUNCTION__LACK_OF_MAINTENANCE = (
        "MECHANICAL_FAILURE_MALFUNCTION||LACK_OF_MAINTENANCE"
    )
    MECHANICAL_FAILURE_MALFUNCTION__MANUAL_CONTROL_FAILURE = (
        "MECHANICAL_FAILURE_MALFUNCTION||MANUAL_CONTROL_FAILURE"
    )
    MISUSE_OF_HAZARDOUS_MATERIALS__IMPROPER_CONTAINER = (
        "MISUSE_OF_HAZARDOUS_MATERIALS||IMPROPER_CONTAINER"
    )
    MISUSE_OF_HAZARDOUS_MATERIALS__IMPROPER_MIXING = (
        "MISUSE_OF_HAZARDOUS_MATERIALS||IMPROPER_MIXING"
    )
    MISUSE_OF_HAZARDOUS_MATERIALS__IMPROPER_USE = "MISUSE_OF_HAZARDOUS_MATERIALS||IMPROPER_USE"
    NATURAL_CONDITION__EARTHQUAKE = "NATURAL_CONDITION||EARTHQUAKE"
    NATURAL_CONDITION__FLOOD = "NATURAL_CONDITION||FLOOD"
    NATURAL_CONDITION__HIGH_TEMPERATURE = "NATURAL_CONDITION||HIGH_TEMPERATURE"
    NATURAL_CONDITION__HIGH_WIND = "NATURAL_CONDITION||HIGH_WIND"
    NATURAL_CONDITION__LIGHTNING = "NATURAL_CONDITION||LIGHTNING"
    NATURAL_CONDITION__LOWER_TEMPERATURE = "NATURAL_CONDITION||LOWER_TEMPERATURE"
    OPERATIONAL_DEFICIENCY__ACCIDENTAL_IMPROPER_POWER_ON = (
        "OPERATIONAL_DEFICIENCY||ACCIDENTAL_IMPROPER_POWER_ON"
    )
    OPERATIONAL_DEFICIENCY__ACCIDENTAL_IMPROPER_SHUTDOWN = (
        "OPERATIONAL_DEFICIENCY||ACCIDENTAL_IMPROPER_SHUTDOWN"
    )
    OPERATIONAL_DEFICIENCY__COLLISION_OVERTURN_KNOCKDOWN = (
        "OPERATIONAL_DEFICIENCY||COLLISION_OVERTURN_KNOCKDOWN"
    )
    OPERATIONAL_DEFICIENCY__EQUIPMENT_UNATTENDED = "OPERATIONAL_DEFICIENCY||EQUIPMENT_UNATTENDED"


class TypeHumanFactorsValue(Enum):
    ALCOHOL_USE = "ALCOHOL_USE"
    ASLEEP = "ASLEEP"
    CULTURAL_RELIGIOUS_BEHAVIOR = "CULTURAL_RELIGIOUS_BEHAVIOR"
    ELDERLY_AGING = "ELDERLY_AGING"
    HOARDING_DISORDER = "HOARDING_DISORDER"
    HOMELESSNESS = "HOMELESSNESS"
    ILLICIT_DRUG_USE = "ILLICIT_DRUG_USE"
    INTELLECTUAL_DISABILITY = "INTELLECTUAL_DISABILITY"
    JUVENILE_BEHAVIOR = "JUVENILE_BEHAVIOR"
...
class TypeIncidentComplexityValue(Enum):
    ICS_TYPE_1 = "ICS_TYPE_1"
    ICS_TYPE_2 = "ICS_TYPE_2"
    ICS_TYPE_3 = "ICS_TYPE_3"
    ICS_TYPE_4 = "ICS_TYPE_4"
    ICS_TYPE_5 = "ICS_TYPE_5"


class TypeIncidentStatusPayloadValue(Enum):
    APPROVED = "APPROVED"
    REJECTED = "REJECTED"
...
class TypeIndoorCauseValue(Enum):
    ACT_OF_NATURE__GLASS_REFRACTION_MAGNIFYING_GLASS = (
        "ACT_OF_NATURE||GLASS_REFRACTION_MAGNIFYING_GLASS"
    )
    ACT_OF_NATURE__LIGHTNING = "ACT_OF_NATURE||LIGHTNING"
...
class TypeIndoorOutdoorValue(Enum):
    INDOOR = "INDOOR"
    OUTDOOR = "OUTDOOR"


class TypeInitialDetectionValue(Enum):
    ALERTED_BY_PERSON = "ALERTED_BY_PERSON"
    AUDIBLE_NOISE = "AUDIBLE_NOISE"
    AUTOMATIC_SUPPRESSION = "AUTOMATIC_SUPPRESSION"
    HEAT_ALARM = "HEAT_ALARM"
    MANUAL_ACTIVATION = "MANUAL_ACTIVATION"
    NO_INITIAL_DETECTION = "NO_INITIAL_DETECTION"
    ODOR = "ODOR"
    OTHER = "OTHER"
    PET = "PET"
    ...
    UNKNOWN = "UNKNOWN"
    VISUAL_SIGHTING = "VISUAL_SIGHTING"


class TypeIntegrationValue(Enum):
    CAD = "CAD"
    RMS = "RMS"
    RO = "RO"
    S123 = "S123"
...
class TypeIntersitialSpaceValue(Enum):
    ATTIC = "ATTIC"
    CEILING = "CEILING"
    CRAWL_SPACE = "CRAWL_SPACE"
    DUCT = "DUCT"
...
class TypeItemFirstIgnitedValue(Enum):
    ALARM_ESCAPE_PROTECTION_DEVICES = "ALARM_ESCAPE_PROTECTION_DEVICES"
    CHILD_NURSERY_EQUIPMENT = "CHILD_NURSERY_EQUIPMENT"
    CLOTHING_FABRIC = "CLOTHING_FABRIC"
    COOKING_MATERIALS = "COOKING_MATERIALS"
    FARM_SUPPLIES_EQUIPMENT = "FARM_SUPPLIES_EQUIPMENT"
    FLAMMABLE_CHEMICALS = "FLAMMABLE_CHEMICALS"
    FURNISHINGS_FIXTURES = "FURNISHINGS_FIXTURES"
    GENERAL_HOUSEHOLD_APPLIANCE = "GENERAL_HOUSEHOLD_APPLIANCE"
    HEATING_COOLING_VENT_APPLIANCE = "HEATING_COOLING_VENT_APPLIANCE"
    HOME_COMM_ENTERTAINMENT_HOBBY_EQUIPMENT = "HOME_COMM_ENTERTAINMENT_HOBBY_EQUIPMENT"
...
class TypeLocationCrossStreetValue(Enum):
    CLOSEST = "CLOSEST"
    INCIDENT_IN_INTERSECTION = "INCIDENT_IN_INTERSECTION"
...
class TypeLocationUseValue(Enum):
    ...
    COMMERCIAL__VETERINARY_PET = "COMMERCIAL||VETERINARY_PET"
    ...
    HEALTH_CARE__HOSPITAL_24_HOUR_MEDICAL_FACILITIES = (
...
class TypeOutdoorActivitiesValue(Enum):
    CONSTRUCTION = "CONSTRUCTION"
    ELECTRICAL_UTILITIES = "ELECTRICAL_UTILITIES"
    FARMING_RANCHING = "FARMING_RANCHING"
    GOVERNMENTAL_TRIBAL_ACTIVITIES = "GOVERNMENTAL_TRIBAL_ACTIVITIES"
    HUNTING_TRAPPING_FISHING = "HUNTING_TRAPPING_FISHING"
    LAW_ENFORCEMENT = "LAW_ENFORCEMENT"
    LOGGING_FORESTRY = "LOGGING_FORESTRY"
    MILITARY = "MILITARY"
    ...
    SUPPRESSION_ACTIVITY = "SUPPRESSION_ACTIVITY"
    TRANSIENT = "TRANSIENT"
    UNKNOWN = "UNKNOWN"
    WEATHER = "WEATHER"


class TypeOutdoorCauseValue(Enum):
    DEBRIS_OPEN_BURNING__BRANDING = "DEBRIS_OPEN_BURNING||BRANDING"
    DEBRIS_OPEN_BURNING__BURNING_PERSONAL_ITEMS = "DEBRIS_OPEN_BURNING||BURNING_PERSONAL_ITEMS"
    DEBRIS_OPEN_BURNING__BURN_BARREL = "DEBRIS_OPEN_BURNING||BURN_BARREL"
    DEBRIS_OPEN_BURNING__DISTRESS_SIGNAL_FIRE = "DEBRIS_OPEN_BURNING||DISTRESS_SIGNAL_FIRE"
...
class TypePowertrainValue(Enum):
    BATTERY_ELECTRIC_VEHICLE = "BATTERY_ELECTRIC_VEHICLE"
    FUEL_CELL_ELECTRIC_VEHICLE = "FUEL_CELL_ELECTRIC_VEHICLE"
    HYBRID_ELECTRIC_VEHICLE = "HYBRID_ELECTRIC_VEHICLE"
    INTERNAL_COMBUSTION_ENGINE = "INTERNAL_COMBUSTION_ENGINE"
    PLUG_IN_HYBRID_ELECTRIC_VEHICLE = "PLUG_IN_HYBRID_ELECTRIC_VEHICLE"


class TypeProductContributionValue(Enum):
    IGNITION = "IGNITION"
    RELEASE = "RELEASE"
    SPREAD = "SPREAD"
...
class TypeRateOfSpreadValue(Enum):
    CRITICAL = "CRITICAL"
    DANGEROUS = "DANGEROUS"
    MODERATE = "MODERATE"
    SLOW = "SLOW"
...
class TypeRelativePositionValue(Enum):
...
class TypeResourceValue(Enum):
    ...
    ENTITY_FEATURE_FLAGS = "ENTITY_FEATURE_FLAGS"
    ENTITY_RELATIONSHIP = "ENTITY_RELATIONSHIP"
    ENTITY_RELATIONSHIP_ACKNOWLEDGMENT = "ENTITY_RELATIONSHIP_ACKNOWLEDGMENT"
    ENTITY_ROLE_ENTITY_SET_ATTACHMENT = "ENTITY_ROLE_ENTITY_SET_ATTACHMENT"
    ...
    NO_ACTIVITY_REPORT = "NO_ACTIVITY_REPORT"
    ROLE = "ROLE"
    STATION = "STATION"
    USER = "USER"
...
class TypeRoofMaterialValue(Enum):
    ASPHALT_SHINGLES = "ASPHALT_SHINGLES"
    CLAY_TILES = "CLAY_TILES"
    COMPOSITE_SHINGLES = "COMPOSITE_SHINGLES"
    CONCRETE_TILES = "CONCRETE_TILES"
    MEMBRANE = "MEMBRANE"
    METAL = "METAL"
    OTHER = "OTHER"
    SLATE = "SLATE"
    SOLAR_TILES = "SOLAR_TILES"
...
class TypeVehicleDamageValue(Enum):
    DAMAGED_DRIVABLE = "DAMAGED_DRIVABLE"
    DAMAGED_NOT_DRIVABLE = "DAMAGED_NOT_DRIVABLE"
    NO_DAMAGE = "NO_DAMAGE"


class TypeVentsValue(Enum):
    MESH_SCREEN_GREATER_THAN_1_8_INCH = "MESH_SCREEN_GREATER_THAN_1_8_INCH"
    MESH_SCREEN_LESS_THAN_1_8_INCH = "MESH_SCREEN_LESS_THAN_1_8_INCH"
    NO_VENTS = "NO_VENTS"
...
class TypeWindowPanesValue(Enum):
...
class UnitResponseResponse(BaseModel):
    ...
    canceled_enroute: Optional[AwareDatetime] = Field(
        None,
        description="Timestamp that the unit was canceled prior to arrival.",
    ...
    point: Optional[Union[GeoPoint, GeoMultipolygon, str]] = Field(None, title="Point")
...
class UpdateIncidentStatusPayload(BaseModel):
    ...
    status: TypeIncidentStatusPayloadValue = Field(
        ...,
        description="Status of the incident in the administrativie approval process.",
    )
...
class UserEntityPermissionsResponse(BaseModel):
    ...
    resources: Dict[str, List[TypeActionValue]] = Field(..., title="Resources")
    active: Optional[bool] = Field(..., title="Active")
    member: Optional[bool] = Field(..., title="Member")
...
class VehicleAutomobilePayload(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    identification_num: Optional[str] = Field(
        None,
        description="The vehicle identification number (VIN) of the vehicle.",
        title="Identification Num",
    )
    manufacture_year: Optional[conint(lt=3000, gt=0)] = Field(
        None,
        description="The year the vehicle was manufactured.",
        title="Manufacture Year",
    )
    state: Optional[StatesTerrs] = Field(
        None, description="The state the vehicle was registered in."
    )
    model: Optional[str] = Field(None, description="The model of the vehicle.", title="Model")
    damage: TypeVehicleDamageValue = Field(..., description="The type of damage to the vehicle.")
    powertrain: Optional[TypePowertrainValue] = Field(
        None, description="The powertrain of the vehicle."
    )
    type: Literal["AUTOMOBILE"] = Field(
        ..., description="The type of vehicle (automobile).", title="Type"
    )
    auto_body_style: Optional[TypeAutoBodyStyleValue] = Field(
        None, description="The style of body of the vehicle."
    )
    make: Optional[TypeAutoMakeValue] = Field(None, description="The make of the vehicle.")


class VehicleAutomobileResponse(BaseModel):
    neris_uid: Optional[int] = Field(
        None, description="The NERIS unique identifier for the item.", title="Neris Uid"
    )
    last_modified: AwareDatetime = Field(
    ...
    model: Optional[str] = Field(None, description="The model of the vehicle.", title="Model")
    damage: str = Field(..., description="The type of damage to the vehicle.", title="Damage")
    powertrain: Optional[str] = Field(
        None, description="The powertrain of the vehicle.", title="Powertrain"
    )
    type: Literal["AUTOMOBILE"] = Field(..., description="The type of vehicle.", title="Type")
    vehicle_info: Optional[DecodeVinResultResponse] = None
    auto_body_style: Optional[str] = Field(
        None, description="The style of body of the vehicle.", title="Auto Body Style"
    )
    make: Optional[str] = Field(None, description="The make of the vehicle.", title="Make")


class Type17(Enum):
    AERIAL_LIFT_PLATFORM = "AERIAL_LIFT_PLATFORM"
    AERIAL_OTHER = "AERIAL_OTHER"
    AIRPLANE = "AIRPLANE"
    ATV = "ATV"
    BICYCLE = "BICYCLE"
    BOAT_SHIP = "BOAT_SHIP"
...
class VehicleOtherPayload(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    identification_num: Optional[str] = Field(
    ...
    type: Literal[
        ...
        ...,
        description="The type of vehicle (non-automobile, e.g. MOTORCYCLE, BUS).",
        title="Type",
    )


class VehicleOtherResponse(BaseModel):
    neris_uid: Optional[int] = Field(
        None, description="The NERIS unique identifier for the item.", title="Neris Uid"
    )
    last_modified: AwareDatetime = Field(
...
class WeatherResponse(BaseModel):
    ...
    main: Optional[str] = Field(None, description="Weather category", title="Main")
    description: Optional[str] = Field(
        None, description="Weather conditions within the category", title="Description"
    )
    temp: Optional[float] = Field(
        None, description="Temperature (degrees Fahrenheit)", title="Temp"
    )
    dew_point: Optional[float] = Field(
        None,
        description="Dew point temperature (degrees Fahrenheit)",
        title="Dew Point",
    )
    feels_like: Optional[float] = Field(
        None,
        description="Perceived temperature (degress Fahrenheit)",
        title="Feels Like",
    )
    pressure: Optional[float] = Field(
        None, description="Atmospheric pressure (millibars)", title="Pressure"
    )
    humidity: Optional[float] = Field(
        None, description="Relative humidity (percent)", title="Humidity"
    )
    temp_min: Optional[float] = Field(
        None,
        description="Minimum temperature within a large city or megalopolis (degrees Fahrenheit)",
        title="Temp Min",
    )
    temp_max: Optional[float] = Field(
        None,
        description="Maximum temperature within a large city or megalopolis (degrees Fahrenheit)",
        title="Temp Max",
    )
    heat_index: Optional[float] = Field(
        None, description="Heat index in degrees Fahrenheit", title="Heat Index"
    )
    windchill: Optional[float] = Field(
        None, description="Windchill in degrees Fahrenheit", title="Windchill"
    )
    visibility: Optional[float] = Field(
        None, description="Visibility distance (feet)", title="Visibility"
    )
    wind_speed: Optional[float] = Field(
        None, description="Wind speed (miles per hour)", title="Wind Speed"
    )
    ...
    cloud_percent: Optional[float] = Field(
        None, description="Amount of cloud cover (percent)", title="Cloud Percent"
    )
    rain_accum_1h: Optional[float] = Field(
        None,
        description="Rain accumulation over the previous hour (inches)",
        title="Rain Accum 1H",
    )
    snow_vol_1h: Optional[float] = Field(
        None,
        description="Snow accumulation over the previous hour (inches)",
        title="Snow Vol 1H",
    )
    day_part: Optional[DayPart] = Field(
        None,
        description="Whether it was day or night at the incident time and location",
        title="Day Part",
    )
    air_quality_co: Optional[float] = Field(
        None,
        description="Carbon monoxide (micrograms per cubic meter)",
        title="Air Quality Co",
    )
    air_quality_o3: Optional[float] = Field(
        None, description="Ozone (micrograms per cubic meter)", title="Air Quality O3"
    )
    air_quality_no2: Optional[float] = Field(
        None,
        description="Nitrogen dioxide (micrograms per cubic meter)",
        title="Air Quality No2",
    )
    air_quality_so2: Optional[float] = Field(
        None,
        description="Sulphur dioxide (micrograms per cubic meter)",
        title="Air Quality So2",
    )
    air_quality_pm2_5: Optional[float] = Field(
        None,
        description="PM2.5 (micrograms per cubic meter)",
        title="Air Quality Pm2 5",
    )
    air_quality_pm10: Optional[float] = Field(
        None, description="PM10 (micrograms per cubic meter)", title="Air Quality Pm10"
    )
    air_quality_us_epa_index: Optional[int] = Field(
        None, description="US EPA AQI category index", title="Air Quality Us Epa Index"
    )
    air_quality_gb_defra_index: Optional[int] = Field(
        None,
        description="UK DEFRA AQI category index",
        title="Air Quality Gb Defra Index",
    )
    pollen_hazel: Optional[float] = Field(
        None,
        description="Hazel pollen grains per cubic meter of air",
        title="Pollen Hazel",
    )
    pollen_alder: Optional[float] = Field(
        None,
        description="Alder pollen grains per cubic meter of air",
        title="Pollen Alder",
    )
    pollen_birch: Optional[float] = Field(
        None,
        description="Birch pollen grains per cubic meter of air",
        title="Pollen Birch",
    )
    pollen_oak: Optional[float] = Field(
        None, description="Oak pollen grains per cubic meter of air", title="Pollen Oak"
    )
    pollen_grass: Optional[float] = Field(
        None,
        description="Grass pollen grains per cubic meter of air",
        title="Pollen Grass",
    )
    pollen_mugwort: Optional[float] = Field(
        None,
        description="Mugwort pollen grains per cubic meter of air",
        title="Pollen Mugwort",
    )
    pollen_ragweed: Optional[float] = Field(
        None,
        description="Ragweed pollen grains per cubic meter of air",
        title="Pollen Ragweed",
    )
...
class FieldPatchInUseActionProperties(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    in_use: Optional[Union[SetBoolAction, UnsetAction]] = Field(None, title="In Use")
    intended: Optional[Union[SetBoolAction, UnsetAction]] = Field(None, title="Intended")
...
class FieldPatchMedicalOxygenHazardPresentActionProperties(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    type: Optional[SetPresentAction] = None
    contributed_to_flame_spread: Optional[bool] = Field(None, title="Contributed To Flame Spread")
...
class NerisApiIncidentModelsDepartmentTimeZoneResponse(BaseModel):
    time_zone: Optional[TimeZones] = Field(
        None, description="Time zone of the department that reported the incident"
    )


class NerisApiIncidentPatchModelsPatchMedicalOxygenHazardActionProperties2(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    type: Optional[SetNotpresentAction] = None
...
class NerisApiIncidentAnalysisModelsDepartmentTimeZoneResponse(BaseModel):
    time_zone: Optional[TimeZones] = Field(
        None,
        description="Time zone of the department that reported the incident analysis",
    )
...
class UnitPayload(BaseModel):
    ...
    type: TypeUnitValue = Field(
        ...,
        description="The type of unit housed at the station, and its associated capability.",
    )
    cad_designation_1: constr(pattern=r"^[\w\(\)\#\- ]{1,64}$") = Field(
        ...,
        description="A unit's designation in the computer-aided dispatch (CAD) system.",
        examples=["CAR15", "Quint-42", "HAZMAT #08"],
        title="Cad Designation 1",
    )
    cad_designation_2: Optional[constr(pattern=r"^[\w\(\)\#\- ]{1,64}$")] = Field(
        None, title="Cad Designation 2"
    )
    neris_id: str = Field(..., title="Neris Id")
...
class ActionPayload(BaseModel):
    ...
    actions: Optional[List[TypeActionTacticValue]] = Field(
        None,
        description="Actions taken by the fire department on the scene of the incident.",
        title="Actions",
    )
...
class AidAgreementPayload(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    neris_id_dept: constr(pattern=r"^FD\d{8}$") = Field(
...
class BatteryPayload(BaseModel):
    ...
    cell: Optional[TypeBatteryCellValue] = Field(None, description="The type of battery cell.")
    chemistry: Optional[TypeBatteryChemistryValue] = Field(
        None, description="The chemistry of the battery."
    )
    storage: Optional[TypeIndoorOutdoorValue] = Field(
        None,
        description="Whether the battery was primarily stored indoors or outdoors.",
    )
    indoor_or_outdoor: Optional[TypeIndoorOutdoorValue] = Field(
        None,
        description="Whether the battery was located indoors or outdoors at the time of the incident.",
    )
    suppression_efforts: Optional[List[TypeEmerghazSuppressionValue]] = Field(
        None,
        description="The suppression/mitigation efforts used to suppress the fire.",
        title="Suppression Efforts",
    )
...
class CasualtyResponse(BaseModel):
    ...
    injury_or_noninjury: Union[InjuryResponse, NoinjuryResponse] = Field(
...
class ChemicalWithReleaseFactorsResponse(BaseModel):
    neris_uid: Optional[int] = Field(
        None, description="The NERIS unique identifier for the item.", title="Neris Uid"
    )
    last_modified: AwareDatetime = Field(
    ...
    release: Optional[ReleaseWithReleaseFactorsResponse] = None
    dot_class: str = Field(
        ...,
        description="Department of Transportation Hazard Classification.",
        title="Dot Class",
    ...
    type: Optional[List[str]] = Field(
        None, description="Types of hazard(s) involved in the incident.", title="Type"
    )
...
class CreateIntegrationAccountPayload(BaseModel):
    ...
    type: Optional[TypeIntegrationValue] = Field("RMS", description="The type of integration")
...
class CrossStreetPayload(BaseModel):
    ...
    direction_of_travel: Optional[TypeLocSnDirectionValue] = Field(
        None,
        description="Word which follows all other street name elements and is used only as needed to indicate direction of travel on a divided roadway and associated frontage roads.",
        examples=['"northbound" in "Interstate Highway 5 North northbound"'],
    )
    cross_street_modifier: Optional[TypeLocationCrossStreetValue] = Field(
        None,
        description="Modifier of the cross street, such as 'nearest' or 'second nearest'",
    )
...
class CsstHazardPayload(BaseModel):
    ...
    lightning_suspected: Optional[TypeYesNoUnknownValue] = Field(
        None, description="Whether lightning was suspected as cause of ignition."
    )
    grounded: Optional[TypeYesNoUnknownValue] = Field(
        None,
        description="The determination of whether the corrugated stainless steel tubing (CSST) was grounded.",
    )


class DepartmentDispatchPayload(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    avl_usage: Optional[bool] = Field(None, title="Avl Usage")
...
class DepartmentMetricsResponse(BaseModel):
    incident_count: IncidentCountMetricsResponse
...
class DispatchUnitResponsePayload(BaseModel):
    ...
    response_mode: Optional[TypeResponseModeValue] = Field(
        None,
        description="Response mode of unit as part of the unit's response to an incident.",
    )
    transport_mode: Optional[TypeResponseModeValue] = Field(
        None,
        description="Transport mode of unit as part of the unit's response to a hospital.",
    )
...
class ElectricHazardFirePayload(BaseModel):
    ...
    suppression_types: Optional[List[TypeEmerghazSuppressionValue]] = Field(
        None, description="Suppression methods used.", title="Suppression Types"
    )
...
class FederalAgencyResponse(BaseModel):
    ...
    active: bool = Field(..., title="Active")
    website: Optional[str] = Field(None, title="Website")
    jurisdiction_type: str = Field(..., title="Jurisdiction Type")
    location: Optional[str] = Field(None, title="Location")
...
class FfInjuryDetailsPayload(BaseModel):
    ...
    job_classification: Optional[TypeJobClassificationValue] = Field(
        None, description="Job classification of firefighter."
    )
    duty_type: Optional[TypeDutyValue] = Field(
        None, description="Duty state of the firefighter at the time of the incident."
    )
    action_type: Optional[TypeCasualtyActionValue] = Field(
        None, description="Actions that occurred during the time of the incident."
    )
    incident_stage: Optional[TypeCasualtyTimelineValue] = Field(
        None, description="Stage of the incident when the injury occurred."
    )
    ppe_items: Optional[List[TypeCasualtyPpeValue]] = Field(
        None, description="PPE worn during time of incident.", title="Ppe Items"
    )


class FfRescueResponse(BaseModel):
    actions: Optional[List[TypeRescueActionValue]] = Field(
...
class FireMarshalResponse(BaseModel):
    mail_address_line_1: Optional[str] = Field(None, title="Mail Address Line 1")
    mail_address_line_2: Optional[str] = Field(None, title="Mail Address Line 2")
    mail_city: Optional[str] = Field(None, title="Mail City")
    mail_state: Optional[StatesTerrs] = None
...
class FirePayload(BaseModel):
    ...
    investigation_needed: InvestigationNeeded = Field(
        ...,
    ...
    investigation_types: List[TypeFireInvestValue] = Field(
        ...,
    ...
    suppression_appliances: Optional[List[TypeSuppressApplianceValue]] = Field(
        None,
...
class FireRemovalPayload(BaseModel):
    ...
    relative_suppression_time: Optional[TypeSuppressTimeValue] = Field(
        None,
        description="The time, relative to suppression, when the person was rescued.",
    )
...
class FireSuppressionFailedPayload(BaseModel):
    ...
    failure_reason: Optional[TypeSuppressNoOperationValue] = Field(
...
class FireSuppressionTypePayload(BaseModel):
    ...
    type: Type7 = Field(..., description="Type of fire suppression system.")
    full_partial: Optional[TypeFullPartialValue] = Field(
...
class GeocodedLocationResponse(BaseModel):
    ...
    score: float = Field(
        ..., description="Measure of confidence in the geocoded result", title="Score"
    )
    point: Union[GeoPoint, GeoMultipolygon, str] = Field(
        ..., description="The geometry data from pygeoapi.", title="Point"
    )
...
class HazsitWithReleaseFactorsResponse(BaseModel):
    neris_uid: Optional[int] = Field(
        None, description="The NERIS unique identifier for the item.", title="Neris Uid"
    )
    last_modified: AwareDatetime = Field(
    ...
    chemicals: Optional[List[ChemicalWithReleaseFactorsResponse]] = Field(None, title="Chemicals")
    disposition: str = Field(
        ..., description="Outcome of the hazmat incident.", title="Disposition"
    )


class IncidentAnalysisBasePayload(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    neris_id_incident: constr(pattern=r"^FD\d{8}\|[\w\-\:]+\|\d{10}$") = Field(
    ...
    human_factors: Optional[List[TypeHumanFactorsValue]] = Field(
        None,
        description="The human factors that contributed to the incident.",
        title="Human Factors",
    )
...
class IncidentAnalysisCreatedResponse(BaseModel):
    neris_id: constr(pattern=r"^IA\|FD\d{8}\|[\w\-\:]+\|\d{10}$") = Field(
        ...,
        description='NERIS ID of the incident analysis. This is comprised of "IA", the department NERIS ID, the incident\'s internal ID, and the epoch time of when the record was created.',
        examples=[
            "IA|FD12345678|abc123xyz|1729023498",
            "IA|FD24027334|incident42:f-tiw|1729023498",
            "IA|FD12345678|0457812893477|1729023498",
        ],
        title="Neris Id",
    )
    incident_analysis_status: IncidentAnalysisStatusResponse


class Vehicles(RootModel[Union[VehicleAutomobilePayload, VehicleOtherPayload]]):
    root: Union[VehicleAutomobilePayload, VehicleOtherPayload] = Field(..., discriminator="type")


class Vehicles1(RootModel[Union[VehicleAutomobileResponse, VehicleOtherResponse]]):
    root: Union[VehicleAutomobileResponse, VehicleOtherResponse] = Field(..., discriminator="type")


class IncidentCreatedResponse(BaseModel):
    neris_id: constr(pattern=r"^FD\d{8}\|[\w\-\:]+\|\d{10}$") = Field(
        ...,
        description="NERIS ID of the incident. This is comprised of the department NERIS ID concatenated with `dispatch.incident_number` and the epoch time of `dispatch.call_create` in the record as initially submitted. An incident's NERIS_ID is immutable, and so should not be relied upon for extraction of `incident_number` or `call_create`, as these attributes could have been updated.",
        examples=[
            "FD12345678|abc123xyz|1729023498",
            "FD24027334|incident42:f-tiw|1729023498",
            "FD12345678|0457812893477|1729023498",
    ...
    incident_status: IncidentStatusResponse
...
class InjuryPayload(BaseModel):
    ...
    cause: Optional[TypeCasualtyCauseValue] = Field(
...
class IntegrationListItem(BaseModel):
    ...
    client_id: UUID = Field(..., description="The integration's client id", title="Client Id")
    title: str = Field(..., title="Title")
    type: TypeIntegrationValue
    credential_ids: List[UUID] = Field(
        ...,
        description="List of credential ids for the integration",
...
class ListIntegrationEnrollmentsResponse(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    page_size: int = Field(..., title="Page Size")
    ...
    page_number: int = Field(..., title="Page Number")
    total_count: int = Field(..., title="Total Count")
    distinct_integration_types: List[TypeIntegrationValue] = Field(
        ..., title="Distinct Integration Types"
    )
    enrollments: List[IntegrationEnrollmentListItem] = Field(
        ...,
        description="List of integration enrollments for the entity.",
        title="Enrollments",
    )
...
class ListIntegrationResponse(BaseModel):
    ...
    integrations: List[IntegrationListItem] = Field(
        ...,
        description="List of integration accounts for this entity. Each integration account has one client id and one or more credentials",
        examples=[
            [
                {
                    "client_id": "0ec8c707-5b6c-45f0-b4fc-e1c609e06c30",
                    "credential_ids": [
                ...
                {
                    "client_id": "fa9a3ea3-f682-4ec0-ba92-9a9a8b0ccee3",
                    "credential_ids": [
...
class ListNoActivityReportResponse(BaseModel):
    reports: List[NoActivityReportResponse] = Field(..., title="Reports")
...
class LocationPayload(BaseModel):
    ...
    place_type: Optional[TypeLocPlaceValue] = Field(
        None,
        description="Type of feature identified by the address.",
        examples=["AIRPORT"],
    )
    ...
    country: Optional[TypeLocCspCountryValue] = Field(
        None,
        description="Name of a country represented by its two-letter ISO 3166-1[14] English country alpha-2 code elements in UPPER CASE letters.",
        examples=["US"],
    )
...
class LocationResponse(BaseModel):
    ...
    geocoded_location: Optional[GeocodedLocationResponse] = Field(
        None,
        description="A geocoded location derived from the information in the parent location.",
    )
...
class LocationUsePayload(BaseModel):
    ...
    use_type: Optional[TypeLocationUseValue] = Field(None, description="Location use type.")
    vacancy_cause: Optional[TypeVacancyValue] = Field(
        None, description="Apparent reason the location is vacant."
    )
    secondary_use: Optional[TypeLocationUseValue] = Field(
        None,
        description="Secondary location use type, if there was one that impacted the incident response.",
    )
...
class MaydayPayload(BaseModel):
    ...
    relative_suppression_time: Optional[TypeSuppressTimeValue] = Field(
        None, description="Relative to suppression, when the mayday was called."
    )


class MedicalOxygenHazardPayload(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    presence: Union[MedicalOxygenHazardPresentPayload, MedicalOxygenHazardNotPresentPayload] = (
...
class MedicalPayload(BaseModel):
    ...
    patient_care_evaluation: PatientCareEvaluation = Field(
        ..., description="Status of patient care needs based on evaluation."
    )
    patient_status: Optional[TypeMedicalPatientStatusValue] = Field(
        None, description="Status of the patient after FD arrival and intervention."
    )
    transport_disposition: Optional[TypeMedicalTransportValue] = Field(
...
class OutsideFirePayload(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    incident_name: Optional[str] = Field(
    ...
    incident_complexity: Optional[TypeIncidentComplexityValue] = Field(
        None, description="The complexity of the outdoor incident."
    )
    general_cause: GeneralCause = Field(..., description="The general cause of the outdoor fire.")
    heat_sources: Optional[List[TypeFireCauseOutValue]] = Field(
        None,
        description="The heat sources involved in the outdoor fire.",
        title="Heat Sources",
    )
    cause: Cause1 = Field(..., description="The primary cause of the outdoor fire.")
    contributing_activities: Optional[List[TypeOutdoorActivitiesValue]] = Field(
        None,
        description="The activities contributing to the outdoor fire.",
        title="Contributing Activities",
    )
    fuel_arrangement: Optional[List[TypeFuelArrangementValue]] = Field(
        None, description="The arrangement of fuels involved.", title="Fuel Arrangement"
    )
    fuel_size: Optional[List[TypeFuelSizeValue]] = Field(
        None,
        description="The diameter (in inches) of the fuels involved.",
        title="Fuel Size",
    )
    fuel_distribution: Optional[List[TypeFuelDistributionValue]] = Field(
        None,
        description="The distribution of fuels involved.",
        title="Fuel Distribution",
    )
    relative_position: Optional[TypeRelativePositionValue] = Field(
        None, description="The relative position of the fire."
    )
    fire_aspect: Optional[TypeAspectValue] = Field(None, description="The aspect of the fire.")
    rate_of_spread: Optional[TypeRateOfSpreadValue] = Field(
        None, description="The rate of spread of the fire."
    )
    polygons: Optional[HighPrecisionGeoMultipolygon] = Field(
        None, description="The polygon(s) of the area affected by the outdoor fire."
    )
    ignition_point: Optional[GeoPoint] = Field(
        None,
        description="The ignition point for the entire fire. Between this and structure.ignition_source, only one should be set.",
    )
...
class PatchInUseAction(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    neris_uid: Optional[int] = Field(
    ...
    properties: FieldPatchInUseActionProperties
...
class PatchMedicalOxygenHazardNotpresentAction(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    neris_uid: Optional[int] = Field(
    ...
    properties: NerisApiIncidentPatchModelsPatchMedicalOxygenHazardActionProperties2


class PatchMedicalOxygenHazardPresentAction(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    neris_uid: Optional[int] = Field(
    ...
    properties: FieldPatchMedicalOxygenHazardPresentActionProperties
...
class PatchStationPayload(BaseModel):
    ...
    address_line_1: Optional[constr(min_length=2, max_length=255)] = Field(
        None, title="Address Line 1"
    )
    address_line_2: Optional[constr(min_length=1, max_length=255)] = Field(
        None, title="Address Line 2"
    )
    city: Optional[constr(min_length=1, max_length=255)] = Field(None, title="City")
    state: Optional[StatesTerrs] = None
    zip_code: Optional[constr(min_length=5, max_length=10)] = Field(None, title="Zip Code")
...
class PatchUnitPayload(BaseModel):
    ...
    type: Optional[TypeUnitValue] = Field(
        None,
        description="The type of unit housed at the station, and its associated capability",
    )
    staffing: Optional[conint(ge=0)] = Field(
        None,
        description="The minimum staffing required for the unit to be dispatched to an incident.",
        title="Staffing",
    )
    ...
    cad_designation_1: Optional[constr(pattern=r"^[\w\(\)\#\- ]{1,64}$")] = Field(
        None,
        description="A unit's designation in the computer-aided dispatch (CAD) system.",
        examples=["CAR15", "Quint-42", "HAZMAT #08"],
        title="Cad Designation 1",
...
class ProductPayload(BaseModel):
    ...
    product_involved: ProductInvolved = Field(
        ..., description="The type of product involved in the fire."
    )
    contribution: Optional[TypeProductContributionValue] = Field(
        None, description="The product's contribution to the fire."
    )


class Vehicles2(RootModel[Union[VehicleAutomobilePayload, VehicleOtherPayload]]):
    root: Union[VehicleAutomobilePayload, VehicleOtherPayload] = Field(..., discriminator="type")
...
class PvPowergenHazardPayload(BaseModel):
    ...
    source_or_target: Optional[TypeEmerghazPvIgnValue] = Field(
        None,
        description="Whether photovoltaics were the source of ignition or target. Only applies to `PHOTOVOLTAICS` type.",
    )
    pv_type: Optional[TypeEmerghazPvValue] = Field(
        None,
        description="Type of photovoltaics were involved in the incident. Only applies to `PHOTOVOLTAICS` type.",
    )
...
class ReleasePayload(BaseModel):
    ...
    unit_of_measurement: Optional[TypeHazardUnitValue] = Field(
        None, description="Unit of measurement of the estimated amount released."
    )
    physical_state: Optional[TypeHazardPhysicalStateValue] = Field(
        None, description="Physical state of the chemical."
    )
    released_into: Optional[TypeHazardReleasedIntoValue] = Field(
...
class ReleaseWithReleaseFactorsPayload(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    estimated_amount: Optional[float] = Field(
    ...
    cause: Optional[TypeHazardCauseValue] = Field(None, description="Cause of the hazmat release.")
    release_factors: Optional[List[TypeHazsitReleaseFactorsValue]] = Field(
        None,
        description="The factors that contributed to the release of the hazardous material.",
        title="Release Factors",
    )
...
class RemovalPayload(BaseModel):
    ...
    room_type: Optional[TypeRoomValue] = Field(
        None, description="Type of room/space from which the occupant was rescued."
    )
    elevation_type: Optional[TypeRescueElevationValue] = Field(
        None, description="Elevation at which the occupant was found."
    )
    rescue_path_type: Optional[TypeRescuePathValue] = Field(
        None, description="The type of route or pathway utilized to remove the person."
    )
...
class SetMedicalOxygenHazardAction(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    action: Literal["set"] = Field(..., description="Set the value of an attribute", title="Action")
    value: MedicalOxygenHazardPayload
...
class SmokeAlarmAlertedPayload(BaseModel):
    ...
    occupant_action: Optional[TypeOccupantResponseValue] = Field(
        None,
        description="If the alarm operated, describes the occupant reaction or inaction that resulted from the alarm signal.",
    )
...
class SmokeAlarmFailedPayload(BaseModel):
    ...
    failure_reason: Optional[TypeAlarmFailureValue] = Field(
...
class StationResponse(BaseModel):
    ...
    location: Optional[AnyUrl] = Field(None, title="Location")
...
class StructureAnalysisResponse(BaseModel):
    ...
    ignition_source: Optional[bool] = Field(
        False,
        description="Whether the structure was the ignition source of the entire fire. Only one structure should be the ignition source.",
        title="Ignition Source",
    )
    accessory_dwelling: Optional[bool] = Field(
        None,
        description="Whether the structure is an accessory dwelling.",
        title="Accessory Dwelling",
    )
    estimated_property_value: Optional[int] = Field(
        None,
        description="The estimated property value.",
        title="Estimated Property Value",
    )
    estimated_contents_value: Optional[int] = Field(
        None,
        description="The estimated property's contents value.",
        title="Estimated Contents Value",
    )
    estimated_property_loss_value: Optional[int] = Field(
        None,
        description="The estimated loss of value of the property.",
        title="Estimated Property Loss Value",
    )
    estimated_contents_loss_value: Optional[int] = Field(
        None,
        description="The estimated lost value of the property's contents.",
        title="Estimated Contents Loss Value",
    )
    non_permitted_modifications: Optional[bool] = Field(
        None,
        description="Whether the structure has non-permitted modification(s).",
        title="Non Permitted Modifications",
    )
    structure_unstable: Optional[bool] = Field(
        None,
        description="Whether the structure was unstable before the incident.",
        title="Structure Unstable",
    )
    occupant_count: Optional[conint(ge=0)] = Field(
        None,
        description="Number of occupants (must be positive).",
        title="Occupant Count",
    )
    occupants_displaced: Optional[bool] = Field(
        None,
        description="Whether occupants were displaced.",
        title="Occupants Displaced",
    )
    unit_count: Optional[conint(ge=0)] = Field(
        None, description="The number of units in the structure.", title="Unit Count"
    )
    year_built: Optional[conint(lt=3000, gt=0)] = Field(
        None, description="The year the structure was built.", title="Year Built"
    )
    damage_assessment: str = Field(
        ...,
        description="The damage assessment of the structure.",
    ...
    displacement_causes: Optional[List[str]] = Field(
        None,
        description="The danger that caused people to be displaced.",
        title="Displacement Causes",
    )
    construction_type: Optional[str] = Field(
        None,
        description="The construction type of the structure.",
        title="Construction Type",
    )
    roof_material: Optional[str] = Field(
        None, description="The roof material of the structure.", title="Roof Material"
    )
    eaves: Optional[str] = Field(
        None, description="The type of eaves on the structure.", title="Eaves"
    )
    screen_vent_type: Optional[str] = Field(
        None,
        description="The type of screen vent on the structure.",
        title="Screen Vent Type",
    )
    exterior_finish: Optional[str] = Field(
        None,
        description="The exterior finish of the structure.",
        title="Exterior Finish",
    )
    foundation: Optional[str] = Field(
        None,
        description="The type of foundation the structure had.",
        title="Foundation",
    )
    window_panes: Optional[str] = Field(
        None,
        description="The type of window panes the structure had.",
        title="Window Panes",
    )
    nearest_structure_distance: Optional[DistanceResponse] = Field(
        None, description="The distance to the next nearest structure."
    )
    exterior_ignition_location: Optional[str] = Field(
        None,
        description="The first location of the structure that was affected in the incident if it was ignited from the exterior.",
        title="Exterior Ignition Location",
    )
    exterior_ignition_causes: Optional[List[str]] = Field(
        None,
        description="The causes that made the structure ignite from the exterior.",
        title="Exterior Ignition Causes",
    )
    attachments: Optional[List[StructureAttachmentResponse]] = Field(
        None, description="The attachments to the structure.", title="Attachments"
    )
    point: Optional[Union[GeoPoint, GeoMultipolygon, str]] = Field(None, title="Point")


class StructureAttachmentPayload(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    type: Type16 = Field(..., description="The type of the addition to the structure.")
    grade: Optional[TypeDeckPorchGradeValue] = Field(
        None, description="The grade of the addition to the structure."
    )
    impacted: Optional[bool] = Field(
        None,
        description="Whether the addition to the structure was impacted by the fire.",
    ...
    materials: Optional[List[TypeAttachedMaterialValue]] = Field(
        None, description="The materials the addition was made of.", title="Materials"
    )


class StructureFireOriginResponse(BaseModel):
    neris_uid: Optional[int] = Field(
        None, description="The NERIS unique identifier for the item.", title="Neris Uid"
    )
    last_modified: AwareDatetime = Field(
    ...
    level_of_origin: Optional[int] = Field(
        None,
        description="Level of the fire origin (positive for above ground, negative for below ground).",
        title="Level Of Origin",
    )
    minor_involved: Optional[bool] = Field(
        None,
        description="Whether the fire's ignition had a minor involved.",
    ...
    general_cause: Optional[str] = Field(
        None, description="The general cause of the indoor fire.", title="General Cause"
    )
    heat_sources: Optional[List[str]] = Field(
        None,
        description="The heat sources involved in the indoor fire.",
        title="Heat Sources",
    )
    cause: str = Field(..., description="The primary cause of the indoor fire.", title="Cause")
    item_first_ignited: Optional[str] = Field(None, title="Item First Ignited")
    room_of_origin: Optional[str] = Field(
        None, description="The room the fire originated in.", title="Room Of Origin"
    )
    intersitial_space: Optional[str] = Field(
        None,
        description="The interstitial space the fire originated in.",
        title="Intersitial Space",
    )
    fire_spread: Optional[str] = Field(
        None, description="The spread of the fire.", title="Fire Spread"
    )
    contributing_hazards: Optional[List[str]] = Field(
        None,
        description="The contributing hazards to the fire.",
        title="Contributing Hazards",
    )
    initial_detection: Optional[str] = Field(
        None,
        description="The initial detection of the fire.",
...
class MedResponses(
    RootModel[Union[AppendMedResponseAction, RemoveMedResponseAction, PatchMedResponseAction]]
):
    root: Union[AppendMedResponseAction, RemoveMedResponseAction, PatchMedResponseAction] = Field(
...
class FieldPatchDispatchUnitResponseActionProperties(BaseModel):
    ...
    med_responses: Optional[Union[List[MedResponses], UnsetAction]] = Field(
        None, title="Med Responses"
    )
...
class FieldPatchLocationUseActionProperties(BaseModel):
    ...
    in_use: Optional[Union[PatchInUseAction, UnsetAction]] = Field(None, title="In Use")
...
class NerisApiIncidentPatchModelsPatchMedicalOxygenHazardActionProperties1(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    presence: Optional[
        Union[
            PatchMedicalOxygenHazardPresentAction,
            PatchMedicalOxygenHazardNotpresentAction,
        ]
...
class StationPayload(BaseModel):
    ...
    address_line_1: constr(min_length=2, max_length=255) = Field(..., title="Address Line 1")
    address_line_2: Optional[constr(min_length=1, max_length=255)] = Field(
        None, title="Address Line 2"
    )
    city: constr(min_length=1, max_length=255) = Field(..., title="City")
    state: StatesTerrs
    zip_code: constr(min_length=5, max_length=10) = Field(..., title="Zip Code")
    station_id: str = Field(..., title="Station Id")
    internal_id: Optional[str] = Field(None, title="Internal Id")
    staffing: Optional[int] = Field(None, title="Staffing")
    neris_id: str = Field(..., title="Neris Id")
...
class FireMarshalPayload(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    mail_address_line_1: Optional[constr(min_length=2, max_length=255)] = Field(
        None, title="Mail Address Line 1"
    )
    mail_address_line_2: Optional[constr(min_length=1, max_length=255)] = Field(
        None, title="Mail Address Line 2"
    )
    mail_city: Optional[constr(min_length=1, max_length=255)] = Field(None, title="Mail City")
    mail_state: Optional[StatesTerrs] = None
    mail_zip_code: Optional[constr(min_length=5, max_length=10)] = Field(
        None, title="Mail Zip Code"
    )
    address_line_1: constr(min_length=2, max_length=255) = Field(..., title="Address Line 1")
    address_line_2: Optional[constr(min_length=1, max_length=255)] = Field(
        None, title="Address Line 2"
    ...
    jurisdiction_type: TypeFmJurisdictionValue
    location: Optional[GeoPoint] = None
...
class PatchDepartmentPayload(BaseModel):
    ...
    time_zone: Optional[TimeZones] = None
    population: Optional[PopulationPayload] = None
    dispatch: Optional[DepartmentDispatchPayload] = None
    ...
    aid_agreements: Optional[List[AidAgreementPayload]] = Field(None, title="Aid Agreements")
    onboarding_status: Optional[DeptOnboardingStatus] = None


class PatchFireMarshalPayload(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    mail_address_line_1: Optional[constr(min_length=2, max_length=255)] = Field(
    ...
    email: Optional[str] = Field(None, title="Email")
    website: Optional[AnyUrl] = Field(None, title="Website")
    jurisdiction_type: Optional[TypeFmJurisdictionValue] = None
    location: Optional[GeoPoint] = None
    population: Optional[PopulationPayload] = None


class AppendCrossStreetAction(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    action: Literal["append"] = Field(
...
class AppendLocationAction(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    action: Literal["append"] = Field(
...
class CasualtyRescueResponse(BaseModel):
    ...
    rank: Optional[constr(min_length=1, max_length=255)] = Field(
        None,
        description="Rank of firefighter. Only possible if `type` is `FF`",
        examples=["Captain"],
        title="Rank",
    )
    years_of_service: Optional[float] = Field(
        None,
        description="Years of service of firefighter. Only possible if `type` is `FF`",
        examples=["2"],
        title="Years Of Service",
    )
    casualty: Optional[CasualtyResponse] = None
    rescue: Optional[RescueResponse] = None
    birth_month_year: Optional[str] = Field(
        None,
        description="Age range",
        examples=["75-79", "10-14"],
...
class ChemicalPayload(BaseModel):
    ...
    dot_class: DotClass = Field(
        ..., description="Department of Transportation Hazard Classification."
    )


class ChemicalWithReleaseFactorsPayload(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    name: constr(min_length=1, max_length=255) = Field(
    ...
    release: Optional[ReleaseWithReleaseFactorsPayload] = Field(
        None,
        description="Details on a chemical release. Only possible if `chemical_release` is `True`.",
    )
    ...
    hazards: Optional[Union[Union[List[TypeHazardValue], Hazards], Hazards]] = Field(
        None,
        description="Types of hazard(s) involved in the incident.",
        title="Hazards",
    )
...
class CreateFederalAgencyPayload(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    mail_address_line_1: Optional[constr(min_length=2, max_length=255)] = Field(
    ...
    name: str = Field(..., title="Name")
    email: Optional[EmailStr] = Field(None, title="Email")
    jurisdiction_type: TypeFaJurisdictionValue
    website: Optional[AnyUrl] = Field(None, title="Website")
    location: Optional[GeoPoint] = None
    population: Optional[PopulationPayload] = None


class CreateFireMarshalPayload(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    mail_address_line_1: Optional[constr(min_length=2, max_length=255)] = Field(
...
class DepartmentWithFeatureFlagsResponse(BaseModel):
    feature_flags: Optional[EntityFeatureFlagsResponse] = None
    mail_address_line_1: Optional[str] = Field(None, title="Mail Address Line 1")
    mail_address_line_2: Optional[str] = Field(None, title="Mail Address Line 2")
    mail_city: Optional[str] = Field(None, title="Mail City")
    mail_state: Optional[StatesTerrs] = None
    ...
    population: Optional[PopulationResponse] = None
    dispatch: Optional[DepartmentDispatchResponse] = None
    ...
    location: Optional[str] = Field(None, title="Location")
    region_sets: Optional[List[RegionSetResponse]] = Field(None, title="Region Sets")
    aid_agreements: Optional[List[AidAgreementResponse]] = Field(None, title="Aid Agreements")
...
class DispatchPayload(BaseModel):
    ...
    center_id: Optional[constr(min_length=1, max_length=255)] = Field(
        None,
    ...
    call_answered: AwareDatetime = Field(
        ...,
...
class DispatchResponse(BaseModel):
    ...
    unit_responses: List[UnitResponseResponse] = Field(..., title="Unit Responses")
    point: Optional[Union[GeoPoint, GeoMultipolygon, str]] = Field(None, title="Point")
...
class ExposurePayload(BaseModel):
    ...
    displacement_count: Optional[int] = Field(
        None,
        description=" Number of people/businesses displaced.",
        title="Displacement Count",
    )
    ...
    point: Optional[GeoPoint] = None
    polygon: Optional[HighPrecisionGeoMultipolygon] = None
    damage_type: DamageType = Field(..., description="Rating of damage to the exposure.")
...
class ExposureResponse(BaseModel):
    ...
    location: LocationResponse
    location_use: Optional[LocationUseResponse] = None
    damage_type: str = Field(..., title="Damage Type")
    point: Optional[Union[GeoPoint, GeoMultipolygon, str]] = Field(None, title="Point")
    polygon: Optional[Union[GeoPoint, GeoMultipolygon, str]] = Field(None, title="Polygon")
    displacement_causes: Optional[List[str]] = Field(
        None, description="Causes of displacement.", title="Displacement Causes"
    )
...
class FfRescuePayload(BaseModel):
    ...
    impediments: Optional[List[TypeRescueImpedimentValue]] = Field(
        None,
        description="Whether conditions impacted the ability of rescue.",
        title="Impediments",
    )
...
class HazsitPayload(BaseModel):
    ...
    disposition: Disposition = Field(..., description="Outcome of the hazmat incident.")


class HazsitWithReleaseFactorsPayload(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    evacuated: int = Field(
    ...
    chemicals: Optional[List[ChemicalWithReleaseFactorsPayload]] = Field(None, title="Chemicals")
    disposition: Disposition = Field(..., description="Outcome of the hazmat incident.")
...
class IncidentBasePayload(BaseModel):
    ...
    department_neris_id: constr(pattern=r"^FD\d{8}$") = Field(
        ...,
        description="NERIS ID of the reporting Fire Department.",
        examples=["FD24027000"],
        title="Department Neris Id",
    )
    incident_number: constr(pattern=r"[\w\-\:]+") = Field(
...
class IncidentBaseResponse(BaseModel):
    ...
    impediment_narrative: Optional[constr(min_length=1, max_length=101000)] = Field(
        None,
        description="Description of any obstacles that impacted the incident.",
        title="Impediment Narrative",
    )
    outcome_narrative: Optional[constr(min_length=1, max_length=101000)] = Field(
        None,
        description="Description of the final disposition of the incident.",
        title="Outcome Narrative",
    )
...
class IncidentResponse(BaseModel):
    ...
    department: Optional[NerisApiIncidentModelsDepartmentTimeZoneResponse] = None
    submitter_account_type: TypeAccountValue
    ...
    csst_hazard: Optional[CsstHazardResponse] = None
    medical_oxygen_hazard: Optional[MedicalOxygenHazardResponse] = None
    weather: Optional[WeatherResponse] = Field(
        None,
        description="Weather conditions at the time of `dispatch.call_create`, if available",
    )
    census_tract: Optional[CensusTractResponse] = Field(
        None, description="Census tract information, if available"
    )
    incident_analysis_neris_id: Optional[constr(pattern=r"^IA\|FD\d{8}\|[\w\-\:]+\|\d{10}$")] = (
        Field(
            None,
            description="Unique identifier of incident analysis, if present.",
            title="Incident Analysis Neris Id",
        )
    )
...
class PatchMedicalOxygenHazardAction(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    neris_uid: Optional[int] = Field(
    ...
    properties: NerisApiIncidentPatchModelsPatchMedicalOxygenHazardActionProperties1
...
class PropertyAnalysisResponse(BaseModel):
    ...
    parcel_id: Optional[str] = Field(
        None, description="The ID of the parcel affected.", title="Parcel Id"
    )
    location: Optional[LocationResponse] = None
    structures: Optional[List[StructureAnalysisResponse]] = Field(
        None,
        description="The structures on the property that were affected.",
        title="Structures",
    )
    point: Optional[Union[GeoPoint, GeoMultipolygon, str]] = Field(None, title="Point")
...
class StructureAnalysisPayload(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    ignition_source: Optional[bool] = Field(
    ...
    location_use: LocationUsePayload
    inspection: Optional[InspectionPayload] = None
    displacement_causes: Optional[List[TypeDisplaceCauseValue]] = Field(
        None,
        description="The danger that caused people to be displaced.",
        title="Displacement Causes",
    )
    construction_type: Optional[TypeConstructionValue] = Field(
        None, description="The construction type of the structure."
    )
    roof_material: Optional[TypeRoofMaterialValue] = Field(
        None, description="The roof material of the structure."
    )
    eaves: Optional[TypeEavesValue] = Field(None, description="The type of eaves on the structure.")
    screen_vent_type: Optional[TypeVentsValue] = Field(
        None, description="The type of screen vent on the structure."
    )
    exterior_finish: Optional[TypeExteriorFinishValue] = Field(
        None, description="The exterior finish of the structure."
    )
    foundation: Optional[TypeFoundationValue] = Field(
        None, description="The type of foundation the structure had."
    )
    window_panes: Optional[TypeWindowPanesValue] = Field(
        None, description="The type of window panes the structure had."
    )
    window_damage_assessment: Optional[TypeFireBldgDamageValue] = Field(
        None, description="The damage assessment of the window panes."
    )
    nearest_structure_distance: Optional[DistancePayload] = Field(
        None, description="The distance to the next nearest structure."
    )
    exterior_ignition_location: Optional[TypeDinsOriginLocationValue] = Field(
        None,
        description="The first location of the structure that was affected in the incident if it was ignited from the exterior.",
    )
    exterior_ignition_causes: Optional[List[TypeDinsOriginCauseValue]] = Field(
        None,
        description="The causes that made the structure ignite from the exterior.",
        title="Exterior Ignition Causes",
    )
    attachments: Optional[List[StructureAttachmentPayload]] = Field(
        None, description="The attachments to the structure.", title="Attachments"
    )
    point: Optional[GeoPoint] = None
...
class IncidentTypes(
    RootModel[Union[AppendIncidentTypeAction, RemoveIncidentTypeAction, PatchIncidentTypeAction]]
):
    root: Union[AppendIncidentTypeAction, RemoveIncidentTypeAction, PatchIncidentTypeAction] = (
        Field(..., discriminator="action")
    )


class Aids(RootModel[Union[AppendAidAction, RemoveAidAction, PatchAidAction]]):
    root: Union[AppendAidAction, RemoveAidAction, PatchAidAction] = Field(
        ..., discriminator="action"
    )
...
class UnitResponses(
    RootModel[
        Union[
            ...
            RemoveIncidentUnitResponseAction,
...
class MedicalDetails(
    RootModel[Union[AppendMedicalAction, RemoveMedicalAction, PatchMedicalAction]]
):
    root: Union[AppendMedicalAction, RemoveMedicalAction, PatchMedicalAction] = Field(
        ..., discriminator="action"
    )
...
class FieldPatchLocationActionProperties(BaseModel):
    ...
    cross_streets: Optional[
        List[Union[PatchCrossStreetAction, AppendCrossStreetAction, RemoveCrossStreetAction]]
    ] = Field(None, description="List of actions to take", title="Cross Streets")
    location_aliases: Optional[List[Union[AppendLocationAction, RemoveLocationAction]]] = Field(
        None, description="List of actions to take", title="Location Aliases"
    )
...
class DepartmentPayload(BaseModel):
    ...
    fips_code: Optional[str] = Field(
        None, description="FIPS code for NERIS ID generation", title="Fips Code"
    )
...
class CasualtyRescuePayload(BaseModel):
    ...
    gender: Optional[TypeGenderValue] = Field(
        None, description="Gender of the person(s) injured or rescued."
    )
    race: Optional[TypeRaceValue] = Field(
...
class IncidentAnalysisResponse(BaseModel):
    ...
    department: Optional[NerisApiIncidentAnalysisModelsDepartmentTimeZoneResponse] = None
    base: IncidentAnalysisBaseResponse
    hazsit: Optional[HazsitWithReleaseFactorsResponse] = Field(
        None, description="The hazmat/hazsit analysis for the incident."
    )
    products: Optional[List[ProductResponse]] = Field(
        None, description="The products involved in the incident.", title="Products"
    )
    batteries: Optional[List[BatteryResponse]] = Field(
        None, description="The batteries involved in the incident.", title="Batteries"
    )
    outside_fire: Optional[OutsideFireResponse] = None
    structure_fire_origin: Optional[StructureFireOriginResponse] = None
    properties: Optional[List[PropertyAnalysisResponse]] = Field(
        None,
        description="Analysis for the property/structures that were affected by the incident.",
        title="Properties",
    )
    vehicles: Optional[List[Vehicles1]] = Field(
        None, description="The vehicles involved in the incident.", title="Vehicles"
    )
...
class IncidentPayload(BaseModel):
    ...
    incident_types: Union[List[IncidentTypePayload], List[IncidentTypeCadPayload]] = Field(
        ...,
        description="\n                - Incidents with a `FIRE||STRUCTURE_FIRE` type require all fire suppression and alarm modules: smoke_alarm, fire_alarm, other_alarm, fire_suppression, unless all aids are `SUPPORT_AID` that was `GIVEN` to another department.\n                - Incidents with a `FIRE||STRUCTURE_FIRE||CONFINED_COOKING_APPLIANCE_FIRE` type require the cooking_fire_suppression module, unless all aids are `SUPPORT_AID` that was `GIVEN` to another department.\n                - Incidents with a single `UNDETERMINED` type can only be submitted by CAD integrations.\n            ",
        title="Incident Types",
    )
    ...
    medical_oxygen_hazard: Optional[MedicalOxygenHazardPayload] = None
...
class PropertyAnalysisPayload(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    parcel_id: Optional[str] = Field(
    ...
    location: Optional[LocationPayload] = Field(
        None, description="The location of the property affected."
    )
    structures: Optional[List[StructureAnalysisPayload]] = Field(
        None,
        description="The structures on the property that were affected.",
        title="Structures",
    )
...
class PutIncidentPayload(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    base: IncidentBasePayload
...
class StructureFireOriginPayload(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    level_of_origin: Optional[int] = Field(
    ...
    general_cause: Optional[TypeGeneralFireCauseValue] = Field(
        None, description="The general cause of the indoor fire."
    )
    heat_sources: Optional[List[TypeFireCauseInValue]] = Field(
        None,
        description="The heat sources involved in the indoor fire.",
        title="Heat Sources",
    )
    cause: Cause3 = Field(..., description="The primary cause of the indoor fire.")
    item_first_ignited: Optional[TypeItemFirstIgnitedValue] = None
    room_of_origin: Optional[TypeRoomValue] = Field(
        None, description="The room the fire originated in."
    )
    intersitial_space: Optional[TypeIntersitialSpaceValue] = Field(
        None,
        description="The interstitial space the fire originated in. Only valid when room_of_origin is set to INTERSITIAL_SPACE.",
    )
    fire_spread: Optional[TypeFireSpreadValue] = Field(None, description="The spread of the fire.")
    contributing_hazards: Optional[List[TypeContributingHazardsValue]] = Field(
        None,
        description="The contributing hazards to the fire.",
        title="Contributing Hazards",
    )
    initial_detection: Optional[TypeInitialDetectionValue] = Field(
        None, description="The initial detection of the fire."
    )
    smoke_alarm: Optional[SmokeAlarmPayload] = None
    fire_alarm: Optional[FireAlarmPayload] = None
    other_alarm: Optional[OtherAlarmPayload] = None
...
class FieldPatchDispatchActionProperties(BaseModel):
    ...
    center_id: Optional[Union[SetSimpleStrAction, UnsetAction]] = Field(None, title="Center Id")
...
class Chemicals(RootModel[Union[AppendChemicalAction, RemoveChemicalAction, PatchChemicalAction]]):
    root: Union[AppendChemicalAction, RemoveChemicalAction, PatchChemicalAction] = Field(
        ..., discriminator="action"
    )
...
class IncidentAnalysisPayload(BaseModel):
    ...
    base: IncidentAnalysisBasePayload
    hazsit: Optional[HazsitWithReleaseFactorsPayload] = Field(
        None, description="The hazmat/hazsit analysis for the incident."
    )
    products: Optional[List[ProductPayload]] = Field(
        None, description="The products involved in the incident.", title="Products"
    )
    batteries: Optional[List[BatteryPayload]] = Field(
        None, description="The batteries involved in the incident.", title="Batteries"
    )
    outside_fire: Optional[OutsideFirePayload] = None
    structure_fire_origin: Optional[StructureFireOriginPayload] = None
    properties: Optional[List[PropertyAnalysisPayload]] = Field(
        None,
        description="Analysis for the property/structures that were affected by the incident. A property must have a `parcel_id`, `location`, or `point` so that the property can be placed on a map.",
        title="Properties",
    )
    vehicles: Optional[List[Vehicles]] = Field(
        None, description="The vehicles involved in the incident.", title="Vehicles"
    )
...
class PutIncidentAnalysisPayload(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    base: IncidentAnalysisBasePayload
    ...
    vehicles: Optional[List[Vehicles2]] = Field(
        None, description="The vehicles involved in the incident.", title="Vehicles"
    )
...
class Exposures(RootModel[Union[AppendExposureAction, RemoveExposureAction, PatchExposureAction]]):
    root: Union[AppendExposureAction, RemoveExposureAction, PatchExposureAction] = Field(
        ..., discriminator="action"
    )
...
class CasualtyRescues(
    RootModel[
        Union[
            AppendCasualtyRescueAction,
            RemoveCasualtyRescueAction,
...
class FieldPatchIncidentActionProperties(BaseModel):
    ...
    incident_types: Optional[List[IncidentTypes]] = Field(
        None, description="List of actions to take", title="Incident Types"
    )
    special_modifiers: Optional[Union[SetRelListTypeSpecialModifierValueAction, UnsetAction]] = (
        Field(None, title="Special Modifiers")
    )
    aids: Optional[List[Aids]] = Field(None, description="List of actions to take", title="Aids")
    ...
    unit_responses: Optional[Union[List[UnitResponses], UnsetAction]] = Field(
        None, description="List of actions to take", title="Unit Responses"
    )
    exposures: Optional[Union[List[Exposures], UnsetAction]] = Field(
        None, description="List of actions to take", title="Exposures"
    )
    casualty_rescues: Optional[Union[List[CasualtyRescues], UnsetAction]] = Field(
        None, description="List of actions to take", title="Casualty Rescues"
    )
    ...
    medical_details: Optional[Union[List[MedicalDetails], UnsetAction]] = Field(
        None, description="List of actions to perform", title="Medical Details"
    )
    ...
    electric_hazards: Optional[Union[List[ElectricHazards], UnsetAction]] = Field(
        None,
        description="List of actions to take, or remove electric hazards completely",
        title="Electric Hazards",
    )
    ...
    medical_oxygen_hazard: Optional[
        Union[PatchMedicalOxygenHazardAction, SetMedicalOxygenHazardAction, UnsetAction]
    ] = Field(None, title="Medical Oxygen Hazard")
