...
#   filename:  https://api.neris.fsri.org/openapi.json
#   timestamp: 2025-11-06T20:14:06+00:00
...
class CreateIntegrationCredentialResponse(BaseModel):
    ...
    client_id: UUID = Field(
        ..., description='The client id of the integration', title='Client Id'
    )
...
class CreateUserPayload(BaseModel):
    ...
    email: EmailStr = Field(
        ..., description="The new user's email address", title='Email'
    )
...
class EntityFeatureFlagsPayload(BaseModel):
    ...
    allow_ui_incident_creation: Optional[bool] = Field(
        None, title='Allow Ui Incident Creation'
    )
...
class EntitySetResponse(BaseModel):
    ...
    nuid: UUID = Field(
        ..., description='The unique identifier for the entity set', title='Nuid'
    )


class ErrorResponse(BaseModel):
    error: AuthError = Field(
        ..., description='The error code. Error messages respect rfc6749.'
    )
...
class FinalizeForgotPasswordPayload(BaseModel):
    ...
    code: str = Field(
        ..., description='Authorization code for the request', title='Code'
    )
...
class GeoJsonPoint(BaseModel):
    ...
    coordinates: List[float] = Field(
        ..., max_length=2, min_length=2, title='Coordinates'
    )
...
class IntegrationEnrollmentListItem(BaseModel):
    ...
    id: UUID = Field(
        ..., description='The unique identifier for the enrollment', title='Id'
    )
    client_id: UUID = Field(
        ...,
...
class IntegrationListItem(BaseModel):
    ...
    client_id: UUID = Field(
        ..., description="The integration's client id", title='Client Id'
    )
    title: str = Field(..., title='Title')
...
class InusePayload(BaseModel):
    ...
    in_use: bool = Field(
        ..., description='Whether the location is in use.', title='In Use'
    )
...
class LocationUseResponse(BaseModel):
    ...
    use_type: Optional[str] = Field(
        None, description='Location use type.', title='Use Type'
    )
...
class NoActivityReportResponse(BaseModel):
    ...
    neris_uid: UUID = Field(
        ..., description='Unique identifier of the report', title='Neris Uid'
    )
...
class ReleaseResponse(BaseModel):
    ...
    cause: Optional[str] = Field(
        None, description='Cause of the hazmat release.', title='Cause'
    )
...
class RoleResponse(BaseModel):
    ...
    description: Optional[str] = Field(None, title='Description')
    nuid: UUID = Field(
        ..., description='The unique identifier for the role', title='Nuid'
    )
...
class SetBoolAction(BaseModel):
    ...
    action: Literal['set'] = Field(
        ..., description='Set the value of an attribute', title='Action'
    )
...
class StaffingPayload(BaseModel):
    ...
    active_ems_only_career_ft: Optional[int] = Field(
        None, title='Active Ems Only Career Ft'
    )
    active_ems_only_career_pt: Optional[int] = Field(
        None, title='Active Ems Only Career Pt'
    )
    active_ems_only_volunteer: Optional[int] = Field(
        None, title='Active Ems Only Volunteer'
    )
    active_civilians_career_ft: Optional[int] = Field(
        None, title='Active Civilians Career Ft'
    )
    active_civilians_career_pt: Optional[int] = Field(
        None, title='Active Civilians Career Pt'
    )
    active_civilians_volunteer: Optional[int] = Field(
        None, title='Active Civilians Volunteer'
    )
...
class TypeActionTacticValue(Enum):
    ...
    EMERGENCY_MEDICAL_CARE__PROVIDE_TRANSPORT = (
        'EMERGENCY_MEDICAL_CARE||PROVIDE_TRANSPORT'
    )
    EMERGENCY_MEDICAL_CARE__PATIENT_REFERRAL = (
    ...
    EMERGENCY_MEDICAL_CARE__PATIENT_ASSESSMENT = (
    ...
    VENTILATION__VERTICAL__PRIOR_TO_SUPPRESSION = (
        'VENTILATION||VERTICAL||PRIOR_TO_SUPPRESSION'
    )
    VENTILATION__VERTICAL__DURING_SUPPRESSION = (
    ...
    VENTILATION__HORIZONTAL__PRIOR_TO_SUPPRESSION = (
        'VENTILATION||HORIZONTAL||PRIOR_TO_SUPPRESSION'
    )
    VENTILATION__HORIZONTAL__DURING_SUPPRESSION = (
        'VENTILATION||HORIZONTAL||DURING_SUPPRESSION'
    )
    VENTILATION__HORIZONTAL__POST_SUPPRESSION = (
    ...
    VENTILATION__HYDRAULIC__PRIOR_TO_SUPPRESSION = (
        'VENTILATION||HYDRAULIC||PRIOR_TO_SUPPRESSION'
    )
    VENTILATION__HYDRAULIC__DURING_SUPPRESSION = (
        'VENTILATION||HYDRAULIC||DURING_SUPPRESSION'
    )
    VENTILATION__HYDRAULIC__POST_SUPPRESSION = (
    ...
    SEARCH_STRUCTURE__WINDOW_INITIATED_SEARCH = (
    ...
    NON_STRUCTURE_SEARCH__SEARCH_AREA_OF_COLLAPSE = (
    ...
    PROVIDE_SERVICES__PROVIDE_APPARATUS_WATER = (
    ...
    INFORMATION_ENFORCEMENT__REFER_TO_PROPER_AHJ = (
        'INFORMATION_ENFORCEMENT||REFER_TO_PROPER_AHJ'
    )
    INFORMATION_ENFORCEMENT__ENFORCE_CODE_OR_LAW = (
    ...
    HAZARDOUS_SITUATION_MITIGATION__TAKE_SAMPLES = (
        'HAZARDOUS_SITUATION_MITIGATION||TAKE_SAMPLES'
    )
    HAZARDOUS_SITUATION_MITIGATION__SPILL_CONTROL = (
        'HAZARDOUS_SITUATION_MITIGATION||SPILL_CONTROL'
    )
    HAZARDOUS_SITUATION_MITIGATION__LEAK_STOP = (
        'HAZARDOUS_SITUATION_MITIGATION||LEAK_STOP'
    )
    HAZARDOUS_SITUATION_MITIGATION__REMOVE_HAZARD = (
    ...
    PROVIDE_SERVICES__ASSIST_UNINJURED_PERSON = (
...
class TypeEmerghazElecValue(Enum):
    ...
    ELECTRIC_VEHICLE__CAR_RR__PLUG_IN_HYBRID = (
    ...
    ELECTRIC_VEHICLE__TRUCK_PASSENGER_RR__HYBRID = (
    ...
    ELECTRIC_VEHICLE__TRUCK_COMMERCIAL_RR__HYBRID = (
    ...
    ELECTRIC_VEHICLE__BUS_RR__PLUG_IN_HYBRID = (
    ...
    ELECTRIC_VEHICLE__BOAT_RECREATIONAL__HYBRID = (
    ...
    ELECTRIC_VEHICLE__BOAT_COMMERCIAL__HYBRID = (
        'ELECTRIC_VEHICLE||BOAT_COMMERCIAL||HYBRID'
    )
    ELECTRIC_VEHICLE__BOAT_COMMERCIAL__FUEL_CELL = (
        'ELECTRIC_VEHICLE||BOAT_COMMERCIAL||FUEL_CELL'
    )
    ELECTRIC_VEHICLE__LIGHT_EV_NRR__FULL_ELECTRIC = (
    ...
    ELECTRIC_VEHICLE__LIGHT_EV_NRR__FUEL_CELL = (
...
class TypeIncidentValue(Enum):
    ...
    FIRE__TRANSPORTATION_FIRE__TRAIN_RAIL_FIRE = (
    ...
    HAZSIT__HAZARDOUS_MATERIALS__FUEL_SPILL_ODOR = (
        'HAZSIT||HAZARDOUS_MATERIALS||FUEL_SPILL_ODOR'
    )
    HAZSIT__INVESTIGATION__SMOKE_INVESTIGATION = (
    ...
    FIRE__STRUCTURE_FIRE__ROOM_AND_CONTENTS_FIRE = (
    ...
    FIRE__TRANSPORTATION_FIRE__AIRCRAFT_FIRE = (
    ...
    FIRE__TRANSPORTATION_FIRE__VEHICLE_FIRE_RV = (
    ...
    MEDICAL__ILLNESS__ALLERGIC_REACTION_STINGS = (
    ...
    MEDICAL__ILLNESS__PANDEMIC_EPIDEMIC_OUTBREAK = (
        'MEDICAL||ILLNESS||PANDEMIC_EPIDEMIC_OUTBREAK'
    )
    HAZSIT__HAZARDOUS_MATERIALS__GAS_LEAK_ODOR = (
    ...
    HAZSIT__OVERPRESSURE__RUPTURE_WITHOUT_FIRE = (
    ...
    MEDICAL__INJURY__STAB_PENETRATING_TRAUMA = (
    ...
    PUBSERV__CITIZEN_ASSIST__PERSON_IN_DISTRESS = (
    ...
    PUBSERV__DISASTER_WEATHER__DAMAGE_ASSESSMENT = (
    ...
    RESCUE__STRUCTURE__ELEVATOR_ESCALATOR_RESCUE = (
        'RESCUE||STRUCTURE||ELEVATOR_ESCALATOR_RESCUE'
    )
    RESCUE__STRUCTURE__EXTRICATION_ENTRAPPED = (
    ...
    RESCUE__TRANSPORTATION__AVIATION_STANDBY = (
    ...
    MEDICAL__INJURY__MOTOR_VEHICLE_COLLISION = (
...
class TypeLocationUseValue(Enum):
    ...
    AGRICULTURE_STRUCT__VETERINARY_LIVESTOCK = (
    ...
    ASSEMBLY__OUTDOOR_ARENA_AMPHITHEATER_PARK = (
    ...
    RESIDENTIAL__DETATCHED_SINGLE_FAMILY_DWELLING = (
        'RESIDENTIAL||DETATCHED_SINGLE_FAMILY_DWELLING'
    )
    RESIDENTIAL__ATTACHED_SINGLE_FAMILY_DWELLING = (
        'RESIDENTIAL||ATTACHED_SINGLE_FAMILY_DWELLING'
    )
    RESIDENTIAL__MULTI_FAMILY_LOWRISE_DWELLING = (
        'RESIDENTIAL||MULTI_FAMILY_LOWRISE_DWELLING'
    )
    RESIDENTIAL__MULTI_FAMILY_MIDRISE_DWELLING = (
        'RESIDENTIAL||MULTI_FAMILY_MIDRISE_DWELLING'
    )
    RESIDENTIAL__MULTI_FAMILY_HIGHRISE_DWELLING = (
    ...
    OUTDOOR__PLAYGROUND_PARK_RECREATIONAL_AREA = (
    ...
    COMMERCIAL__OFFICE_OTHER_TECHNICAL_SERVICES = (
    ...
    COMMERCIAL__VEHICLE_FUELING_CHARGING_STATION = (
...
class UnitResponseResponse(BaseModel):
    ...
    med_responses: Optional[List[MedResponseResponse]] = Field(
...
class FieldPatchCommentActionProperties(BaseModel):
    ...
    comment: Optional[Union[SetNarrativeStrAction, UnsetAction]] = Field(
        None, title='Comment'
    )
    timestamp: Optional[Union[SetDateTimeAction, UnsetAction]] = Field(
...
class FieldPatchInUseActionProperties(BaseModel):
    ...
    intended: Optional[Union[SetBoolAction, UnsetAction]] = Field(
        None, title='Intended'
    )
...
class FieldPatchMedResponseActionProperties(BaseModel):
    ...
    at_patient: Optional[Union[SetDateTimeAction, UnsetAction]] = Field(
        None, title='At Patient'
    )
...
class UnitPayload(BaseModel):
    ...
    cad_designation_1: constr(pattern=r'^[\w\d\(\)\#\- ]{1,64}$') = Field(
        ...,
    ...
    cad_designation_2: Optional[constr(pattern=r'^[\w\d\(\)\#\- ]{1,64}$')] = Field(
...
class AidPayload(BaseModel):
    ...
    aid_direction: TypeAidDirectionValue = Field(
        ..., description='The direction aid was provided'
    )
...
class DispatchUnitResponsePayload(BaseModel):
    ...
    med_responses: Optional[List[MedResponsePayload]] = Field(
        None, title='Med Responses'
    )
...
class FireSuppressionResponse(BaseModel):
    ...
    presence: Union[
        FireSuppressionPresentResponse, FireSuppressionNotPresentResponse
    ] = Field(..., title='Presence')
...
class FireSuppressionTypePayload(BaseModel):
    ...
    type: TypeSuppressFireValue = Field(
        ..., description='Type of fire suppression system.'
    )
...
class GeocodedLocationResponse(BaseModel):
    ...
    unincorporated_community: Optional[constr(min_length=1, max_length=255)] = Field(
        ...
        examples=[
            '14th Ward (a ward in the incorporated municipality of Pittsburgh, PA) '
        ],
    ...
    section: Optional[constr(min_length=1, max_length=255)] = Field(
        ...
        examples=[
            '"Customer Seating" in "Coastland Mall, Food Court, Customer Seating" '
        ],
        title='Section',
    )
    ...
    point: str = Field(
        ..., description='The URL of the geometry in pygeoapi.', title='Point'
    )
...
class LocationUsePayload(BaseModel):
    ...
    use_type: Optional[TypeLocationUseValue] = Field(
...
class PatchStationPayload(BaseModel):
    ...
    state: Optional[StatesTerrs] = None
    zip_code: Optional[constr(min_length=5, max_length=10)] = Field(
        None, title='Zip Code'
    )
...
class PatchUnitPayload(BaseModel):
    ...
    cad_designation_1: Optional[constr(pattern=r'^[\w\d\(\)\#\- ]{1,64}$')] = Field(
        None,
        description="A unit's designation in the computer-aided dispatch (CAD) system.",
        examples=['CAR15', 'Quint-42', 'HAZMAT #08'],
        title='Cad Designation 1',
...
class ReleasePayload(BaseModel):
    ...
    cause: Optional[TypeHazardCauseValue] = Field(
...
class FieldPatchActionActionProperties(BaseModel):
    ...
    actions: Optional[Union[SetRelListTypeActionTacticValueAction, UnsetAction]] = (
        Field(None, title='Actions')
    )
...
class FieldPatchCookingFireSuppressionPresentActionProperties(BaseModel):
    ...
    suppression_types: Optional[
        Union[SetRelListTypeSuppressCookingValue, UnsetAction]
    ] = Field(None, title='Suppression Types')
    operation_type: Optional[
        Union[FieldSetTypeSuppressOperationValueAction, UnsetAction]
    ] = Field(None, title='Operation Type')
...
class FieldPatchCrossStreetActionProperties(BaseModel):
    ...
    street_prefix: Optional[Union[FieldSetTypeLocSnPrePostValueAction, UnsetAction]] = (
        Field(None, title='Street Prefix')
    )
    ...
    street: Optional[Union[SetSimpleStrAction, UnsetAction]] = Field(
        None, title='Street'
    )
    street_postfix: Optional[
        Union[FieldSetTypeLocSnPrePostValueAction, UnsetAction]
    ] = Field(None, title='Street Postfix')
    ...
    direction_of_travel: Optional[
        Union[FieldSetTypeLocSnDirectionValueAction, UnsetAction]
...
class FieldPatchCsstHazardActionProperties(BaseModel):
    ...
    lightning_suspected: Optional[
        Union[FieldSetTypeYesNoUnknownValueAction, UnsetAction]
    ] = Field(None, title='Lightning Suspected')
...
class MedResponses(
    RootModel[
        Union[AppendMedResponseAction, RemoveElementAction, PatchMedResponseAction]
    ]
):
    root: Union[
        AppendMedResponseAction, RemoveElementAction, PatchMedResponseAction
...
class FieldPatchDispatchUnitResponseActionProperties(BaseModel):
    ...
    dispatch: Optional[Union[SetDateTimeAction, UnsetAction]] = Field(
        None, title='Dispatch'
    )
    enroute_to_scene: Optional[Union[SetDateTimeAction, UnsetAction]] = Field(
        None, title='Enroute To Scene'
    )
    on_scene: Optional[Union[SetDateTimeAction, UnsetAction]] = Field(
        None, title='On Scene'
    )
    canceled_enroute: Optional[Union[SetDateTimeAction, UnsetAction]] = Field(
        None, title='Canceled Enroute'
    )
    staging: Optional[Union[SetDateTimeAction, UnsetAction]] = Field(
        None, title='Staging'
    )
    unit_clear: Optional[Union[SetDateTimeAction, UnsetAction]] = Field(
        None, title='Unit Clear'
    )
    ...
    response_mode__transport: Optional[FieldSetTypeResponseModeTransportValueAction] = (
        None
    )
...
class FieldPatchElectricHazardFireActionProperties(BaseModel):
    ...
    reignition: Optional[Union[SetBoolAction, UnsetAction]] = Field(
        None, title='Reignition'
    )
...
class FieldPatchExternalExposureActionProperties(BaseModel):
    ...
    item_type: Optional[Union[FieldSetTypeExposureItemValueAction, UnsetAction]] = (
        Field(None, title='Item Type')
    )
...
class FieldPatchFfInjuryDetailsActionProperties(BaseModel):
    ...
    job_classification: Optional[
        Union[FieldSetTypeJobClassificationValueAction, UnsetAction]
    ...
    action_type: Optional[Union[FieldSetTypeCasualtyActionValueAction, UnsetAction]] = (
        Field(None, title='Action Type')
    )
    incident_command: Optional[Union[SetBoolAction, UnsetAction]] = Field(
        [None], title='Incident Command'
    )
    incident_stage: Optional[
        Union[FieldSetTypeCasualtyTimelineValueAction, UnsetAction]
    ] = Field(None, title='Incident Stage')
    injury_ff_ppe: Optional[
        Union[SetRelListTypeCasualtyPpeValueAction, UnsetAction]
    ] = Field(None, title='Injury Ff Ppe')
...
class FieldPatchFireAlarmPresentActionProperties(BaseModel):
    ...
    type: Optional[SetPresentAction] = None
    alarm_types: Optional[Union[SetRelListTypeAlarmFireValueAction, UnsetAction]] = (
        Field(None, title='Alarm Types')
    )
    operation_type: Optional[
        Union[FieldSetTypeAlarmOperationValueAction, UnsetAction]
    ] = Field(None, title='Operation Type')
...
class FieldPatchFireRemovalActionProperties(BaseModel):
    ...
    relative_suppression_time: Optional[
        Union[FieldSetTypeSuppressTimeValueAction, UnsetAction]
...
class FieldPatchFireSuppressionFailedActionProperties(BaseModel):
    ...
    failure_reason: Optional[
        Union[FieldSetTypeSuppressNoOperationValueAction, UnsetAction]
...
class FieldPatchFireSuppressionTypeActionProperties(BaseModel):
    ...
    full_partial: Optional[Union[FieldSetTypeFullPartialValueAction, UnsetAction]] = (
        Field(None, title='Full Partial')
    )
...
class FieldPatchIncidentTypeActionProperties(BaseModel):
    ...
    primary_type: Optional[Union[SetBoolAction, UnsetAction]] = Field(
        None, title='Primary Type'
    )
...
class FieldPatchLocationUseActionProperties(BaseModel):
    ...
    secondary_use: Optional[Union[FieldSetTypeLocationUseValueAction, UnsetAction]] = (
        Field(None, title='Secondary Use')
    )
...
class FieldPatchMedicalActionProperties(BaseModel):
    ...
    patient_status: Optional[
        Union[FieldSetTypeMedicalPatientStatusValueAction, UnsetAction]
    ] = Field(None, title='Patient Status')
    transport_disposition: Optional[
        Union[FieldSetTypeMedicalTransportValueAction, UnsetAction]
...
class FieldPatchNoactionActionProperties(BaseModel):
    ...
    noaction_type: Optional[Union[FieldSetTypeNoactionValueAction, UnsetAction]] = (
        Field(None, title='Noaction Type')
    )
...
class FieldPatchOtherAlarmPresentActionProperties(BaseModel):
    ...
    type: Optional[SetPresentAction] = None
    alarm_types: Optional[Union[SetRelListTypeAlarmOtherValueAction, UnsetAction]] = (
        Field(None, title='Alarm Types')
    )
...
class FieldPatchOutsideFireLocationDetailActionProperties(BaseModel):
    ...
    acres_burned: Optional[Union[SetFloatAction, UnsetAction]] = Field(
        None, title='Acres Burned'
    )
...
class FieldPatchPvPowergenHazardActionProperties(BaseModel):
    ...
    source_or_target: Optional[
        Union[FieldSetTypeEmerghazPvIgnValueAction, UnsetAction]
    ] = Field(None, title='Source Or Target')
...
class FieldPatchReleaseActionProperties(BaseModel):
    ...
    unit_of_measurement: Optional[
        Union[FieldSetTypeHazardUnitValueAction, UnsetAction]
    ] = Field(None, title='Unit Of Measurement')
    physical_state: Optional[
        Union[FieldSetTypeHazardPhysicalStateValueAction, UnsetAction]
    ] = Field(None, title='Physical State')
    released_into: Optional[
        Union[FieldSetTypeHazardReleasedIntoValueAction, UnsetAction]
    ] = Field(None, title='Released Into')
...
class FieldPatchRescueMaydayActionProperties(BaseModel):
    ...
    rit_activated: Optional[Union[SetBoolAction, UnsetAction]] = Field(
        None, title='Rit Activated'
    )
...
class FieldPatchSmokeAlarmOperationAlertedActionProperties(BaseModel):
    ...
    occupant_action: Optional[
        Union[FieldSetTypeOccupantResponseValueAction, UnsetAction]
    ] = Field(None, title='Occupant Action')
...
class FieldPatchSmokeAlarmOperationFailedActionProperties(BaseModel):
    ...
    failure_reason: Optional[
        Union[FieldSetTypeAlarmFailureValueAction, UnsetAction]
    ] = Field(None, title='Failure Reason')
...
class StationPayload(BaseModel):
    ...
    address_line_1: constr(min_length=2, max_length=255) = Field(
    ...
    neris_id: str = Field(..., title='Neris Id')
    location: Optional[GeoPoint] = None
    units: Optional[List[Union[UnitPayload, CreateUnitPayload]]] = Field(
        None, title='Units'
    )
...
class FireMarshalPayload(BaseModel):
    ...
    mail_city: Optional[constr(min_length=1, max_length=255)] = Field(
        None, title='Mail City'
    )
    mail_state: Optional[StatesTerrs] = None
...
class DepartmentCreatedModifiedResponse(BaseModel):
    ...
    version: int = Field(..., title='Version')
    valid_start: datetime = Field(..., title='Valid Start')
    stations: Optional[List[StationCreatedModifiedResponse]] = Field(
        None, title='Stations'
    )
...
class DepartmentWithFeatureFlagsResponse(BaseModel):
    ...
    investigation_services: Optional[List[str]] = Field(
        None, title='Investigation Services'
    )
...
class DispatchPayload(BaseModel):
    ...
    unit_responses: List[DispatchUnitResponsePayload] = Field(
...
class FirePayload(BaseModel):
    ...
    location_detail: Union[
        StructureFireLocationDetailPayload, OutsideFireLocationDetailPayload
...
class IncidentResponse(BaseModel):
    ...
    unit_responses: Optional[List[UnitResponseResponse]] = Field(
        None, title='Unit Responses'
    )
    exposures: Optional[List[ExposureResponse]] = Field(None, title='Exposures')
    casualty_rescues: Optional[List[CasualtyRescueResponse]] = Field(
        None, title='Casualty Rescues'
    )
    ...
    electric_hazards: Optional[List[ElectricHazardResponse]] = Field(
        None, title='Electric Hazards'
    )
    powergen_hazards: Optional[List[PowergenHazardResponse]] = Field(
        None, title='Powergen Hazards'
    )
...
class FieldPatchChemicalActionProperties(BaseModel):
    ...
    release: Optional[Union[PatchReleaseAction, UnsetAction]] = Field(
        None, title='Release'
    )
...
class FieldPatchElectricHazardActionProperties(BaseModel):
    ...
    source_or_target: Optional[
        Union[FieldSetTypeSourceTargetValueAction, UnsetAction]
    ] = Field(None, title='Source Or Target')
...
class FieldPatchFireActionProperties(BaseModel):
    ...
    location_detail: Optional[
        Union[
            PatchStructureFireLocationDetailAction, PatchOutsideFireLocationDetailAction
        ]
...
class FieldPatchFireAlarmActionProperties(BaseModel):
    ...
    presence: Optional[
        Union[PatchFireAlarmPresentAction, PatchFireAlarmNotpresentAction]
    ] = Field(None, title='Presence')
...
class IncidentTypes(
    RootModel[
        Union[
            AppendIncidentTypeAction, RemoveIncidentTypeAction, PatchIncidentTypeAction
        ]
    ]
):
    root: Union[
...
class FieldPatchLocationActionProperties(BaseModel):
    ...
    county: Optional[Union[SetSimpleStrAction, UnsetAction]] = Field(
        None, title='County'
    )
    state: Optional[Union[SetSimpleStrAction, UnsetAction]] = Field(None, title='State')
    postal_code: Optional[Union[SetSimpleStrAction, UnsetAction]] = Field(
        None, title='Postal Code'
    )
    ...
    structure: Optional[Union[SetSimpleStrAction, UnsetAction]] = Field(
        None, title='Structure'
    )
    subsite: Optional[Union[SetSimpleStrAction, UnsetAction]] = Field(
        None, title='Subsite'
    )
    ...
    unit_prefix: Optional[Union[SetSimpleStrAction, UnsetAction]] = Field(
        None, title='Unit Prefix'
    )
    unit_value: Optional[Union[SetSimpleStrAction, UnsetAction]] = Field(
        None, title='Unit Value'
    )
    room: Optional[Union[SetSimpleStrAction, UnsetAction]] = Field(None, title='Room')
    section: Optional[Union[SetSimpleStrAction, UnsetAction]] = Field(
        None, title='Section'
    )
    ...
    marker: Optional[Union[SetSimpleStrAction, UnsetAction]] = Field(
        None, title='Marker'
    )
    ...
    location_aliases: Optional[
        List[Union[AppendLocationElementAction, RemoveElementAction]]
...
class FieldPatchOtherAlarmActionProperties(BaseModel):
    ...
    presence: Optional[
        Union[PatchOtherAlarmPresentAction, PatchOtherAlarmNotpresentAction]
    ] = Field(None, title='Presence')
...
class FieldPatchRemovalActionProperties(BaseModel):
    ...
    elevation_type: Optional[
        Union[FieldSetTypeRescueElevationValueAction, UnsetAction]
    ] = Field(None, title='Elevation Type')
    gas_isolation: Optional[Union[SetBoolAction, UnsetAction]] = Field(
        None, title='Gas Isolation'
    )
    rescue_path_type: Optional[
        Union[FieldSetTypeRescuePathValueAction, UnsetAction]
    ] = Field(None, title='Rescue Path Type')
...
class FieldPatchSmokeAlarmOperationActionProperties(BaseModel):
    ...
    alerted_failed: Optional[
        Union[
            PatchSmokeAlarmOperationAlertedAction, PatchSmokeAlarmOperationFailedAction
        ]
...
class CreateDepartmentPayload(BaseModel):
    ...
    location: Optional[GeoPoint] = None
    region_sets: Optional[List[RegionSetPayload]] = Field(None, title='Region Sets')
    onboarding_status: Literal['UNCONFIRMED'] = Field(
        'UNCONFIRMED', title='Onboarding Status'
    )
    fips_code: Optional[str] = Field(
        None, description='FIPS code for NERIS ID generation', title='Fips Code'
    )
...
class FireSuppressionPayload(BaseModel):
    ...
    presence: Union[FireSuppressionPresentPayload, FireSuppressionNotPresentPayload] = (
        Field(..., title='Presence')
    )
...
class IncidentPayload(BaseModel):
    ...
    casualty_rescues: Optional[List[CasualtyRescuePayload]] = Field(
        None, title='Casualty Rescues'
    )
    ...
    electric_hazards: Optional[List[ElectricHazardPayload]] = Field(
        None, title='Electric Hazards'
    )
    powergen_hazards: Optional[List[PowergenHazardPayload]] = Field(
        None, title='Powergen Hazards'
    )
    csst_hazard: Optional[CsstHazardPayload] = None
...
class FieldPatchDispatchActionProperties(BaseModel):
    ...
    center_id: Optional[Union[SetSimpleStrAction, UnsetAction]] = Field(
        None, title='Center Id'
    )
    ...
    disposition: Optional[Union[SetSimpleStrAction, UnsetAction]] = Field(
        None, title='Disposition'
    )
...
class FieldPatchExposureActionProperties(BaseModel):
    ...
    location_detail: Optional[
        Union[PatchExternalExposureAction, PatchInternalExposureAction]
    ] = Field(None, title='Location Detail')
    location: Optional[PatchLocationAction] = None
    ...
    point: Optional[Union[SetGeoPointAction, UnsetAction]] = Field(None, title='Point')
    polygon: Optional[Union[SetGeoMultipolygonAction, UnsetAction]] = Field(
        None, title='Polygon'
    )
...
class FieldPatchFfRescueActionProperties(BaseModel):
    ...
    rescue_mode: Optional[Union[FieldSetTypeRescueModeValueAction, UnsetAction]] = (
        Field(None, title='Rescue Mode')
    )
    actions: Optional[Union[SetRelListTypeRescueActionValueAction, UnsetAction]] = (
        Field(None, title='Actions')
    )
    impediments: Optional[
        Union[SetRelListTypeRescueImpedimentValueAction, UnsetAction]
    ] = Field(None, title='Impediments')
...
class FieldPatchFireSuppressionPresentActionProperties(BaseModel):
    ...
    type: Optional[SetPresentAction] = None
    suppression_types: Optional[Union[PatchFireSuppressionTypeAction, UnsetAction]] = (
        Field(None, title='Suppression Types')
    )
    operation_type: Optional[
        Union[PatchFireSuppressionOperationAction, UnsetAction]
    ] = Field(None, title='Operation Type')


class Chemicals(
    RootModel[Union[AppendChemicalAction, RemoveElementAction, PatchChemicalAction]]
):
...
class FieldPatchHazsitActionProperties(BaseModel):
    ...
    chemicals: Optional[Union[List[Chemicals], UnsetAction]] = Field(
        None, title='Chemicals'
    )
...
class Exposures(
    RootModel[Union[AppendExposureAction, RemoveExposureAction, PatchExposureAction]]
):
    root: Union[AppendExposureAction, RemoveExposureAction, PatchExposureAction] = (
        Field(..., discriminator='action')
    )
...
class FieldPatchRescueActionProperties(BaseModel):
    ...
    ffrescue_or_nonffrescue: Optional[
        Union[PatchFfRescueAction, PatchNonFfRescueAction]
    ] = Field(None, title='Ffrescue Or Nonffrescue')
    presence_known: Optional[Union[PatchPresenceKnownAction, UnsetAction]] = Field(
        None, title='Presence Known'
    )
    mayday: Optional[Union[PatchRescueMaydayAction, UnsetAction]] = Field(
        None, title='Mayday'
    )
...
class FieldPatchSmokeAlarmActionProperties(BaseModel):
    ...
    presence: Optional[
        Union[PatchSmokeAlarmPresentAction, PatchSmokeAlarmNotpresentAction]
    ] = Field(None, title='Presence')
...
class FieldPatchCasualtyRescueActionProperties(BaseModel):
    ...
    casualty: Optional[Union[PatchCasualtyAction, UnsetAction]] = Field(
        None, title='Casualty'
    )
    rescue: Optional[Union[PatchRescueAction, UnsetAction]] = Field(
        None, title='Rescue'
    )
    ...
    race: Optional[Union[FieldSetTypeRaceValueAction, UnsetAction]] = Field(
        None, title='Race'
    )
...
class FieldPatchIncidentActionProperties(BaseModel):
    ...
    special_modifiers: Optional[
        Union[SetRelListTypeSpecialModifierValueAction, UnsetAction]
    ] = Field(None, title='Special Modifiers')
    aids: Optional[List[Aids]] = Field(
        None, description='List of actions to take', title='Aids'
    )
    ...
    hazsit_detail: Optional[Union[PatchHazsitAction, SetHazsitAction, UnsetAction]] = (
        Field(None, title='Hazsit Detail')
    )
    ...
    smoke_alarm: Optional[
        Union[PatchSmokeAlarmAction, SetSmokeAlarmAction, UnsetAction]
    ] = Field(None, title='Smoke Alarm')
    fire_alarm: Optional[
        Union[PatchFireAlarmAction, SetFireAlarmAction, UnsetAction]
    ] = Field(None, title='Fire Alarm')
    other_alarm: Optional[
        Union[PatchOtherAlarmAction, SetOtherAlarmAction, UnsetAction]
    ] = Field(None, title='Other Alarm')
    ...
    csst_hazard: Optional[
        Union[PatchCsstHazardAction, SetCsstHazardAction, UnsetAction]
    ] = Field(None, title='Csst Hazard')
