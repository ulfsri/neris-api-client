...
#   timestamp: 2025-08-12T17:02:57+00:00
...
class GeocodedLocationResponse(BaseModel):
    ...
    point: str = Field(..., description="The URL of the geometry in pygeoapi.", title="Point")
...
class IncidentPayload(BaseModel):
    ...
    incident_types: List[IncidentTypePayload] = Field(
        ...,
        description="\n                - Incidents with a `FIRE||STRUCTURE_FIRE` type require all fire suppression and alarm modules: smoke_alarm, fire_alarm, other_alarm, fire_suppression.\n                - Incidents with a `FIRE||STRUCTURE_FIRE||CONFINED_COOKING_APPLIANCE_FIRE` type require the cooking_fire_suppression module.\n            ",
        title="Incident Types",
    )
