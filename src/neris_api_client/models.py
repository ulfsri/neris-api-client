...
#   timestamp: 2024-12-06T18:36:10+00:00
...
class ActionResponse(BaseModel):
    type: Literal['ACTION'] = Field(
        ..., const=True, description='`ACTION` indicates action was taken', title='Type'
    )
...
class AidResponse(BaseModel):
    ...
    department_neris_id: constr(regex=r'^FD\d{8}$') = Field(
        ...,
...
class CookingFireSuppressionNotPresentResponse(BaseModel):
    ...
    type_present_notpresent: str = Field(
        'NOTPRESENT', const=True, title='Type Present Notpresent'
    )
...
class CookingFireSuppressionPresentResponse(BaseModel):
    ...
    type_present_notpresent: str = Field(
        'PRESENT', const=True, title='Type Present Notpresent'
    )
    type: str = Field(..., title='Type')
...
class CreateIntegrationResponse(BaseModel):
    id: UUID = Field(
        ..., description='The unique identifier for this integration', title='Id'
    )
    title: str = Field(..., description='The name of the integration', title='Title')
    client_id: str = Field(
        ..., description='The id of the integration', title='Client Id'
    )
...
class DispatchTacticTimestampsPayload(BaseModel):
    ...
    type: str = Field('DISPATCH', const=True, title='Type')
...
class ExternalExposureResponse(BaseModel):
    type_external_internal: str = Field(
        'EXTERNAL', const=True, title='Type External Internal'
    )
    type: str = Field(..., title='Type')
...
class FfInjuryDetailsResponse(BaseModel):
    ...
    unit_neris_id: Optional[constr(regex=r'^FD\d{8}S\d{3}U\d{3}$')] = Field(
        None,
...
class FireSuppressionEffectivePayload(BaseModel):
    ...
    type_operation_effective: str = Field(
        'EFFECTIVE', const=True, title='Type Operation Effective'
    )
    ...
    type: Literal['OPERATED_EFFECTIVE'] = Field(..., const=True, title='Type')
...
class FireSuppressionFailedResponse(BaseModel):
    ...
    type_operation_effective: str = Field(
        'FAILED', const=True, title='Type Operation Effective'
    )
    type: str = Field(..., title='Type')
...
class FireSuppressionIneffectiveResponse(BaseModel):
    ...
    type_operation_effective: str = Field(
        'INEFFECTIVE', const=True, title='Type Operation Effective'
    )
    sprinklers_activated: Optional[int] = Field(
        None,
        description='Number of sprinkler heads activated.',
...
class IncidentCreatedResponse(BaseModel):
    neris_id: constr(regex=r'^FD\d{8}\|[\w\d\-\:]+\|\d{10}$') = Field(
        ...,
...
class IncidentTacticTimestampsPayload(BaseModel):
    ...
    type: str = Field('INCIDENT', const=True, title='Type')
...
class InjuryResponse(BaseModel):
    type_injury_noinjury: str = Field(
        'INJURY', const=True, title='Type Injury Noinjury'
    )
...
class InternalExposurePayload(BaseModel):
    ...
    type_external_internal: str = Field(
        'INTERNAL', const=True, title='Type External Internal'
    )
    type: str = Field('INTERNAL_EXPOSURE', const=True, title='Type')
...
class NoactionResponse(BaseModel):
    type: Literal['NOACTION'] = Field(
        ...,
        const=True,
        description='`NOACTION` indicates no action was taken',
        title='Type',
    )
...
class NoinjuryPayload(BaseModel):
    ...
    type_injury_noinjury: str = Field(
        'NOINJURY', const=True, title='Type Injury Noinjury'
    )
    type: Literal['UNINJURED'] = Field(..., const=True, title='Type')
...
class NonFfRescuePayload(BaseModel):
    ...
    type_ffrescue: str = Field('NONFFRESCUE', const=True, title='Type Ffrescue')
    type: Literal[
...
class NonremovalPayload(BaseModel):
    ...
    type_removal_nonremoval: str = Field(
        'NONREMOVAL', const=True, title='Type Removal Nonremoval'
    )
    type: Literal['DISENTANGLEMENT', 'EXTRICATION', 'OTHER', 'RECOVERY'] = Field(
        ..., title='Type'
    )
...
class NonremovalResponse(BaseModel):
    ...
    incident_neris_id: constr(regex=r'^FD\d{8}\|[\w\d\-\:]+\|\d{10}$') = Field(
        ...,
        description="NERIS ID of the incident. This is comprised of the department NERIS ID concatenated with `dispatch.internal_id` and the epoch time of `dispatch.call_create` in the record as initially submitted. An incident's NERIS_ID is immutable, and so should not be relied upon for extraction of `internal_id` or `call_create`, as these attributes could have been updated.",
        examples=[
            'FD12345678|abc123xyz|1729023498',
...
class OtherPowergenHazardPayload(BaseModel):
    ...
    type_pv_other: str = Field('OTHER', const=True, title='Type Pv Other')
    type: Literal['NONE', 'NOT_APPLICABLE', 'OTHER', 'WIND_TURBINE'] = Field(
        ..., title='Type'
    )
...
class OutsideFireLocationDetailResponse(BaseModel):
    type: str = Field('OUTSIDE', const=True, title='Type')
...
class PvPowergenHazardResponse(BaseModel):
    ...
    type_pv_other: str = Field('PV', const=True, title='Type Pv Other')
    type: str = Field(..., title='Type')
...
class RemovalResponse(BaseModel):
    ...
    type_removal_nonremoval: str = Field(
        'REMOVAL', const=True, title='Type Removal Nonremoval'
    )
...
class RemoveElectricHazardAction(BaseModel):
    ...
    action: Literal['remove'] = Field(
        ..., const=True, description='Remove an element from the array', title='Action'
    )
    neris_uid: int = Field(
        ...,
...
class SetBoolAction(BaseModel):
    ...
    action: str = Field(
        'set', const=True, description='Set the value of an attribute', title='Action'
    )
...
class SetNerisIdDeptStrAction(BaseModel):
    ...
    value: constr(regex=r'^FD\d{8}$') = Field(
...
class SetNerisIdUnitStrAction(BaseModel):
    ...
    value: constr(regex=r'^FD\d{8}S\d{3}U\d{3}$') = Field(
...
class SetPresentAction(BaseModel):
    ...
    value: str = Field('PRESENT', const=True, title='Value')
...
class SmokeAlarmAlertedResponse(BaseModel):
    type_operation_alerted: str = Field(
        'ALERTED', const=True, title='Type Operation Alerted'
    )
    neris_uid: Optional[int] = Field(
        None, description='The NERIS unique identifier for the item.', title='Neris Uid'
    )
...
class SmokeAlarmFailedResponse(BaseModel):
    type_operation_alerted: str = Field(
        'FAILED', const=True, title='Type Operation Alerted'
    )
    neris_uid: Optional[int] = Field(
        None, description='The NERIS unique identifier for the item.', title='Neris Uid'
    )
...
class SmokeAlarmOtherPayload(BaseModel):
    ...
    type_operation_alerted: str = Field(
        'OTHER', const=True, title='Type Operation Alerted'
    )
    type: Literal[
        'INSUFFICENT_SOURCE',
        'INSUFFICIENT_SOURCE',
...
class StructureFireLocationDetailResponse(BaseModel):
    type: str = Field('STRUCTURE', const=True, title='Type')
...
class UnsetAction(BaseModel):
    ...
    action: str = Field(
        'unset',
        const=True,
        description='Remove (nullify) the value of an attribute',
        title='Action',
    )
...
class FieldSetTypeAlarmOperationFailedAction(BaseModel):
    ...
    value: str = Field('FAILED_TO_OPERATE', const=True, title='Value')
...
class FieldSetTypeCasualtyNoinjuryAction(BaseModel):
    ...
    value: str = Field('UNINJURED', const=True, title='Value')
...
class FieldSetTypeEmerghazPvPowergenAction(BaseModel):
    ...
    value: str = Field('PHOTOVOLTAICS', const=True, title='Value')
...
class FieldSetTypeExposureLocAction(BaseModel):
    ...
    value: str = Field('EXTERNAL_EXPOSURE', const=True, title='Value')
...
class FieldSetTypeInternalExposureLocAction(BaseModel):
    ...
    value: str = Field('INTERNAL_EXPOSURE', const=True, title='Value')
...
class FieldSetTypeSuppressOperationEffectiveAction(BaseModel):
    ...
    value: str = Field('OPERATED_EFFECTIVE', const=True, title='Value')
...
class FieldSetTypeSuppressOperationFailedAction(BaseModel):
    ...
    value: Value7 = Field(..., title='Value')
...
class FieldSetTypeSuppressOperationIneffectiveAction(BaseModel):
    ...
    value: str = Field('OPERATED_NOT_EFFECTIVE', const=True, title='Value')
...
class ActionPayload(BaseModel):
    ...
    actions: Optional[Union[Union[List[TypeActionTacticValue], Actions], Actions]] = (
        Field(
            None,
            description='Actions taken by the fire department on the scene of the incident.',
            title='Actions',
...
class AppendAidAction(BaseModel):
    ...
    action: str = Field(
        'append',
        const=True,
        description='Append an element to the array',
        title='Action',
    )
    value: AidPayload
...
class CasualtyResponse(BaseModel):
    ...
    injury_noinjury: Union[InjuryResponse, NoinjuryResponse] = Field(
        ..., title='Injury Noinjury'
    )
...
class CookingFireSuppressionPresentPayload(BaseModel):
    ...
    type: Literal['PRESENT'] = Field(..., const=True, title='Type')
...
class CrossStreetPayload(BaseModel):
    ...
    direction_of_travel: Optional[Union[TypeLocSnDirectionValue, DirectionOfTravel]] = (
        Field(
            None,
            description='Word which follows all other street name elements and is used only as needed to indicate direction of travel on a divided roadway and associated frontage roads.',
            examples=['"northbound" in "Interstate Highway 5 North northbound"'],
    ...
    cross_street_modifier: Union[TypeLocationCrossStreetValue, CrossStreetModifier] = (
        Field(
            ...,
            description="Modifier of the cross street, such as 'nearest' or 'second nearest'",
        )
...
class CsstHazardPayload(BaseModel):
    ...
    lightning_suspected: Optional[Union[TypeYesNoUnknownValue, LightningSuspected]] = (
        Field(None, description='Whether lightning was suspected as cause of ignition.')
    )
...
class ExternalExposurePayload(BaseModel):
    ...
    type: str = Field('EXTERNAL_EXPOSURE', const=True, title='Type')
...
class FfInjuryDetailsPayload(BaseModel):
    ...
    job_classification: Optional[
        Union[TypeJobClassificationValue, JobClassification]
    ] = Field(None, description='Job classification of firefighter.')
    ...
    ppe_items: Optional[
        Union[Union[List[TypeCasualtyPpeValue], PpeItems], PpeItems]
    ] = Field(None, description='PPE worn during time of incident.', title='Ppe Items')


class FfRescueResponse(BaseModel):
    type_ffrescue: str = Field('FFRESCUE', const=True, title='Type Ffrescue')
    actions: Optional[Union[Union[List[TypeRescueActionValue], Actions2], Actions2]] = (
        Field(None, description='Action taken to support the rescue.', title='Actions')
    )
...
class FireSuppressionFailedPayload(BaseModel):
    ...
    failure_reason: Optional[Union[TypeSuppressNoOperationValue, FailureReason]] = (
        Field(None, description='Reason for suppression system failure.')
    )
...
class FireSuppressionIneffectivePayload(BaseModel):
    ...
    type: Literal['OPERATED_NOT_EFFECTIVE'] = Field(..., const=True, title='Type')
    failure_reason: Optional[Union[TypeSuppressNoOperationValue, FailureReason]] = (
        Field(None, description='Reason for suppression system failure.')
    )
...
class IncidentBaseResponse(BaseModel):
    ...
    incident_number: constr(regex=r'[\w\d\-\:]+') = Field(
        ...,
...
class MedicalPayload(BaseModel):
    ...
    patient_status: Optional[Union[TypeMedicalPatientStatusValue, PatientStatus]] = (
        Field(
            None, description='Status of the patient after FD arrival and intervention.'
        )
    )
    transport_disposition: Optional[
        Union[TypeMedicalTransportValue, TransportDisposition]
    ] = Field(None, description='Transport outcome of the incident.')
...
class OutsideFireLocationDetailPayload(BaseModel):
    ...
    type: Literal['OUTSIDE'] = Field(..., const=True, title='Type')
    acres_burned: Optional[float] = Field(
        None,
        description='Estimated number of acres burned during the incident.',
        examples=['0.5'],
...
class PatchCommentAction(BaseModel):
    ...
    action: str = Field(
        'patch',
        const=True,
        description='Patch values of a nested attribute',
        title='Action',
    )
...
class PresenceKnownPayload(BaseModel):
    ...
    presence_known_type: Optional[
        Union[TypeRescuePresenceKnownValue, PresenceKnownType]
    ] = Field(
        None,
        description='Whether the presence of an occupant in need of rescue was known',
    )
...
class PvPowergenHazardPayload(BaseModel):
    ...
    type_pv_other: str = Field('PV', const=True, title='Type Pv Other')
    type: Literal['PHOTOVOLTAICS'] = Field(..., const=True, title='Type')
...
class ReleasePayload(BaseModel):
    ...
    unit_of_measurement: Optional[Union[TypeHazardUnitValue, UnitOfMeasurement]] = (
        Field(None, description='Unit of measurement of the estimated amount released.')
    )
    physical_state: Optional[Union[TypeHazardPhysicalStateValue, PhysicalState]] = (
        Field(None, description='Physical state of the chemical.')
    )
...
class RemovalPayload(BaseModel):
    ...
    type: Literal['REMOVAL_FROM_STRUCTURE'] = Field(..., const=True, title='Type')
...
class SetRelListTypeActionTacticValueAction(BaseModel):
    ...
    action: str = Field('set', const=True, title='Action')
...
class SmokeAlarmFailedPayload(BaseModel):
    ...
    type: Literal['FAILED_TO_OPERATE'] = Field(..., const=True, title='Type')
...
class StructureFireLocationDetailPayload(BaseModel):
    ...
    type: Literal['STRUCTURE'] = Field(..., const=True, title='Type')
    progression_evident: Optional[bool] = Field(
        None,
        description='Whether the fire extended beyond the conditions found upon arrival.',
        title='Progression Evident',
...
class FieldPatchRescueMaydayActionProperties(BaseModel):
    ...
    mayday: bool = Field(True, const=True, title='Mayday')
    relative_suppression_time: Optional[
        Union[FieldSetTypeSuppressTimeValueAction, UnsetAction]
    ] = Field(None, title='Relative Suppression Time')
...
class NerisApiIncidentModelsDispatchPayload(BaseModel):
    ...
    call_answered: Optional[datetime] = Field(
        None,
...
class NerisApiIncidentModelsDispatchResponse(BaseModel):
    ...
    tactic_timestamps: Optional[DispatchTacticTimestampsResponse]
    unit_responses: List[DispatchUnitResponseResponse] = Field(
        ..., title='Unit Responses'
    )
    point: Optional[str] = Field(None, title='Point')
...
class AppendElectricHazardAction(BaseModel):
    ...
    action: Literal['append'] = Field(
        ..., const=True, description='Append an element to the array', title='Action'
    )
...
class FieldPatchRemovalActionProperties(BaseModel):
    ...
    type: str = Field('REMOVAL', const=True, title='Type')
...
class Chemicals(BaseModel):
    __root__: Union[AppendChemicalAction, RemoveElementAction, PatchChemicalAction] = (
...
class ElectricHazards(BaseModel):
    __root__: Union[
...
LocationPayload.update_forward_refs()
